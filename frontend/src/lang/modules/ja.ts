...
const message = {
    ...
    aiTools: {
        ...
        aiProxy: {
            ...
            qpsLimit: 'QPS 制限',
            defaultTokenLimit: 'デフォルト Token 制限',
            tokenLimit: 'Token 制限',
        ...
        skillsHub: {
            ...
            containerNameRequired: 'コンテナ化された対象にはコンテナ名が必要です。',
            deleteTargetConfirm:
    ...
    setting: {
        ...
        offlineEnv: 'オフライン環境',
        offlineEnvHelper:
            '有効にすると、アプリストアなどのリソースはデフォルトでサーバーのローカルディレクトリから読み込まれます。\nシステムアップグレードとエージェントアップグレードには、手動でダウンロードしたオフラインパッケージが必要です。',
        offlineEnvOpenHelper: 'オフライン環境を有効にしてもよろしいですか？',
        offlineEnvCloseHelper: 'オフライン環境を無効にしてもよろしいですか？',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scorePasswordExpired: 'パネルパスワードの有効期限が切れています',
                scorePasswordExpiring: 'パネルパスワードの残り {0} 日',
                ...
                assetResourceDesc: '{0} 個のアプリが異常、{1} 個のアプリが停止、{2} 個のコンテナが異常',
                ...
                passwordExpiration: 'パスワード有効期限',
                passwordExpirationNormalDesc: 'パスワードの有効期限は安全な範囲内です',
                passwordExpirationUnsetDesc: 'パスワードの有効期限が未設定です。早めの設定をお勧めします',
