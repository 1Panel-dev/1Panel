...
const message = {
    ...
    xpack: {
        ...
        opsReport: '運用レポート',
        opsReportOverview: '概要',
        opsReportSystem: 'ホスト稼働',
        opsReportLogin: 'ログインとセキュリティ',
        opsReportWebsite: 'Web サイト保護',
        opsReportResource: '実行リソース',
        opsReportCronjob: 'スケジュールタスク',
        opsReportHistory: 'エクスポート履歴',
        opsReportSetting: '設定',
        opsReportPage: {
            enterprise: 'Enterprise',
        ...
        user: {
            ...
            app_view: 'アプリ表示',
            app_manage: 'アプリ管理',
            ai_agent_view: 'AI アシスタント表示',
            ai_agent_manage: 'AI アシスタント管理',
            ai_model_view: 'AI モデル表示',
            ai_model_manage: 'AI モデル管理',
            ai_mcp_view: 'MCP 表示',
            ...
            website_cert_manage: '証明書管理',
            website_runtime_view: '実行環境表示',
            website_runtime_manage: '実行環境管理',
            database_view: 'データベース表示',
            database_manage: 'データベース管理',
            container_view: 'コンテナ表示',
            container_manage: 'コンテナ管理',
            cronjob_view: '予定タスク表示',
            toolbox_view: 'ツールボックス表示',
            host_file_view: 'ファイル表示',
            host_firewall_view: 'ファイアウォール表示',
            host_monitor_view: '監視表示',
            ...
            xpack_ops_report_view: '運用レポート表示',
            xpack_ops_report_manage: '運用レポート管理',
            xpack_monitor_view: '監視表示',
            xpack_monitor_manage: '監視管理',
            xpack_cluster_view: 'クラスター表示',
            xpack_cluster_manage: 'クラスター管理',
            xpack_tamper_view: '改ざん防止表示',
            xpack_tamper_manage: '改ざん防止管理',
            log_view: 'ログ表示',
        },
        app: {
            app: 'APP',
