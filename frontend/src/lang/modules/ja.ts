...
const message = {
    ...
    xpack: {
        ...
        alert: {
            ...
            alertTriggerMode: '通知条件',
            alertTriggerFailed: '失敗時のみ',
            alertTriggerSuccess: '成功時のみ',
            alertTriggerBoth: '成功時または失敗時',
            alertNotificationHelper:
                '再試行中ではなく、最終的な実行結果に基づいて通知します。成功と失敗の通知は、1日の上限と送信時間帯を共有します。',
            notificationTitle: '定期タスク - {0}「{1}」実行通知',
            notificationSuccessTitle: '定期タスク - {0}「{1}」が正常に完了しました',
            notificationRule: '{0}：{1}、1日最大 {2} 回通知',
