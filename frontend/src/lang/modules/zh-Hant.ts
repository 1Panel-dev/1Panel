...
const message = {
    ...
    firewall: {
        ...
        plan_partially_overlapping_rule_with_different_action:
            '與相反動作的規則部分重疊，實際效果取決於規則順序，確認後可繼續。',
        ...
        resetDirectRulesHelper: '刪除 {0} 中全部 1Panel 系統防火牆鏈、規則、持久化檔案及對應資料庫記錄',
        resetWhitelistRulesHelper:
            '刪除 {0} 中全部自訂防火牆設定及對應資料庫記錄，恢復安裝預設狀態並停用 {0}。\n清理後將不再提供防火牆防護，此操作無法復原。',
        ...
        cleanupAction: '清理',
        backendSwitchNotice:
            '系統防火牆切換不會自動移轉或清理規則；連接埠轉送和 Docker 防護必須先清理目前後端才能切換，面板中儲存的規則和策略不會被刪除，切換後可重新初始化或同步。',
