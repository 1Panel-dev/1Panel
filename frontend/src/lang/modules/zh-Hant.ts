...
const message = {
    ...
    xpack: {
        ...
        opsReport: '運維報表',
        opsReportOverview: '概覽',
        opsReportSystem: '主機運行',
        opsReportLogin: '登入與安全配置',
        opsReportWebsite: '網站防護',
        opsReportResource: '運行資源',
        opsReportCronjob: '計劃任務',
        opsReportHistory: '匯出歷史',
        opsReportSetting: '設置',
        opsReportPage: {
            enterprise: '企業版',
            scoreMeta: '扣分 {0} 分 · 風險 {1} 項',
            hostAddress: '主機地址',
            panelVersion: '1Panel 版本',
            cpuCores: '實體核心',
            coreUnit: '{0} 核',
            memoryTotal: '記憶體總量',
            reportDate: '報表日期',
            ...
            scorePanelLoginFailedHigh: '1Panel 登入失敗 {0} 次',
            scorePanelLoginFailedMedium: '1Panel 登入失敗 {0} 次',
            scoreSSHLoginFailedHigh: 'SSH 登入失敗 {0} 次',
            scoreSSHLoginFailedMedium: 'SSH 登入失敗 {0} 次',
            scoreMFADisabled: 'MFA 未開啟',
            scoreAllowIPsOpen: '授權 IP 未配置或範圍過大',
            scorePasswordExpired: '面板密碼已過期',
            scorePasswordExpiring: '面板密碼剩餘 {0} 天到期',
            ...
            assetResourceDesc: '{0} 個應用異常，{1} 個應用已停止，{2} 個容器異常',
            ...
            panelLoginSecurity: '1Panel 登入安全配置',
            sshSecurity: 'Linux 伺服器 SSH 安全配置',
            panelFailedRecords: '1Panel 登入失敗記錄',
        ...
        user: {
            ...
            ai_agent_manage: 'AI 助理管理',
            ai_model_view: 'AI 模型檢視',
            ai_model_manage: 'AI 模型管理',
            ai_mcp_view: 'MCP 檢視',
            ...
            website_cert_manage: '憑證管理',
            website_runtime_view: '執行環境檢視',
            website_runtime_manage: '執行環境管理',
            database_view: '資料庫檢視',
            database_manage: '資料庫管理',
            container_view: '容器檢視',
            container_manage: '容器管理',
            cronjob_view: '計劃任務檢視',
            toolbox_view: '工具箱檢視',
            host_file_view: '檔案檢視',
            host_firewall_view: '防火牆檢視',
            host_monitor_view: '網站監控檢視',
            ...
            xpack_ops_report_view: '運維報表檢視',
            xpack_ops_report_manage: '運維報表管理',
            xpack_monitor_view: '監控檢視',
            xpack_monitor_manage: '監控管理',
            xpack_cluster_view: '叢集檢視',
            xpack_cluster_manage: '叢集管理',
            xpack_tamper_view: '防竄改檢視',
            xpack_tamper_manage: '防竄改管理',
            log_view: '日誌檢視',
        },
        waf: {
            name: 'WAF',
        ...
        node: {
            ...
            nodeUpgradePackageManage: '更新包管理',
