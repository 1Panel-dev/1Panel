...
const message = {
    ...
    firewall: {
        ...
        resolution_create: '建立規則',
        resolution_create_anyway: '仍然建立',
        resolution_adopt: '納管',
        resolution_select_adopt: '選擇並納入管理',
        ...
        plan_requested_rule_is_covered: '現有規則已覆蓋本次設定，繼續建立會產生重疊規則。',
        ...
        ruleCheckSummary: '共檢查 {0} 條規則：可建立 {1} 條、已存在 {2} 條、警告 {3} 條、錯誤 {4} 條。',
        ruleCheckBlockedHelper: '存在錯誤規則，無法提交。請返回修改後重新檢查。',
        ruleCheckWarningHelper: '檢查完成。警告不會阻止提交，可以直接繼續。',
        ruleCheckPassedHelper: '檢查通過，可以提交。',
        ...
        plan_overlapping_rule_with_different_action: '有範圍重疊但動作相反的規則，本次操作已停止。',
        ...
        changeStrategyHelper: '即將把 [{1}] 的 {0} 策略修改為 [{2}]，設定後 {0} 將依 [{2}] 策略對外存取，是否繼續？',
        strategy: '策略',
        accept: '允許',
        drop: '拒絕',
        anyWhere: '任何位置',
        ...
        forwardRule: '埠轉發',
        dockerGuard: '容器連接埠防護',
        systemFirewall: '系統防火牆',
        forwardBackend: '連接埠轉發',
        dockerBackend: 'Docker 防火牆',
        firewallSettingHelper: '系統防火牆、連接埠轉發和 Docker 防火牆可分別選擇；規則需透過匯出和匯入手動移轉。',
        systemFirewallHelper: '用於管理主機連接埠存取和入站規則。',
        forwardingHelper: '用於處理連接埠轉發規則，可與系統防火牆分別選擇。',
        dockerFirewallHelper: '用於管理 Docker 網路規則，切換時會重新啟動 Docker。',
        iptablesSuggestionTag: '相容性優先',
        nftablesSuggestionTag: '新環境建議',
        iptablesSuggestion: '適合已有 iptables 規則、Docker 工作負載或優先考慮相容性的環境。',
        nftablesSuggestion: '適合較新的 Linux 系統和新部署環境；切換前請確認現有工具支援 nftables。',
        configuredRules: '已設定 {0} 條規則',
        addressFamily: 'IP 版本',
        portOrRange: '連接埠 / 範圍',
        dockerNftGuardUnsupported: 'Docker 原生 nftables 暫不支援容器連接埠防護。',
        backendIndependentHelper: '系統防火牆、連接埠轉發和 Docker 防火牆分別選擇後端，互不跟隨。',
        currentBackend: '目前後端',
        applyBackend: '套用選擇',
        cleanupManagedRules: '清理 1Panel 規則',
        ...
        cleanupManagedRulesHelper: '即將清理 {0} 中由 1Panel 建立的規則，是否繼續？',
        switchBackendHelper: '即將切換為 {0}，現有規則不會移轉或清理，是否繼續？',
        ...
        filterHelper: 'Filter 規則允許您在 INPUT 層級控制入站網路流量。請謹慎設定，避免鎖定系統。',
        chain: '鏈',
        targetChain: '目標鏈',
        sourceIP: '來源 IP',
        destIP: '目標 IP',
        accessSource: '存取來源',
        accessDestination: '存取目的',
        direction: '方向',
        destPort: '目標埠',
        action: '動作',
        priority: '優先級',
        ...
        reorderTip: '拖曳以調整本組託管規則順序',
        ufwReorderUnsupported: 'UFW 規則依 IPv4/IPv6 的實際編號顯示，目前不支援手動調整順序。',
        reorderBlocked: '只能在同一組內移動，且不能跨越外部、受保護或無法辨識的規則。',
        destination: '目的地',
    },
    runtime: {
        runtime: '執行環境',
