...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            dashboardUsername: 'Dashboard 使用者名稱',
            dashboardPassword: 'Dashboard 密碼',
            allowedOrigins: '訪問地址',
            ...
            dashboardAuthAutoRebuildHelper: '保存 Dashboard 使用者名稱或密碼後將自動重建容器以使設定生效。',
    ...
    xpack: {
        ...
        vm: {
            ...
            forceDeleteConfirm: '虛擬機正在執行，刪除前將強制停止，是否繼續？',
            createResource: '建立 {0}',
            isoSource: 'ISO 來源',
