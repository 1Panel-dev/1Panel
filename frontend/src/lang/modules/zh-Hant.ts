...
const message = {
    ...
    xpack: {
        ...
        node: {
            ...
            healthCheck: '健康檢查',
            healthCheckFrequency: '檢查頻率',
            healthCheckFrequencyHelper: '定期檢查後端節點健康狀態，輸入 0 可停用檢查。',
            healthCheckFrequencyLimit: '檢查頻率不能超過一天，且必須為非負整數。',
            loadFailedNodeResources: '載入失敗節點資源',
            loadFailedNodeResourcesHelper: '開啟節點列表時，同時載入失敗節點的資源資訊。',
