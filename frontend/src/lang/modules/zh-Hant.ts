        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    authorizationEndpointInvalid: '請輸入有效的 Authorization Endpoint。',
                    ...
                    callbackURL: '回呼位址',
                    callbackURLHelper: '請將該完整位址加入 Provider 的允許回呼清單。',
                    cancelClearSecret: '取消清除',
                    clearSecret: '清除金鑰',
                    clearSecretConfirm: 'Client Secret 只會在儲存後刪除，是否繼續？',
                    clientAuthMethod: '客戶端認證方式',
                    clientAuthMethodHelper: '必須與 Provider Token Endpoint 支援的方式一致。',
                    clientAuthMethodRequired: '請選擇客戶端認證方式。',
                    clientID: 'Client ID',
                    clientIDRequired: '請輸入 Client ID。',
                    clientSecret: 'Client Secret',
                    clockSkew: '時鐘偏差容忍',
                    clockSkewRequired: '請輸入時脈偏差容忍時間。',
                    compatibilityMode: '相容模式（手動端點與安全引數）',
                    compatibilityModeHelper: '僅用於 Discovery 不完整或端點被改寫的 Provider，核心 OIDC 驗證不會關閉。',
                    compatibilityModeShort: '相容模式',
                    ...
                    configurationStaleHelper: '影響認證的設定已經修改，請重新測試目前草稿。',
                    ...
                    configurationTestResultDesc:
                        '此處只檢查 Discovery 與 Provider 能力，不交換授權碼，也無法證明 Client Secret 正確；請使用「瀏覽器測試登入」完成端對端驗證。',
                    ...
                    connectionTestCompatibilityDesc: '驗證手動端點和協定安全性策略。',
                    connectionTestStandardDesc: '從 Issuer 自動發現端點和能力。',
                    connectionTestTab: '連線測試',
                    customCA: '自訂 CA',
                    customCAHelper: '僅作用於目前認證來源，且不會寫入日誌。',
                    customCARequired: '請提供自訂 CA 憑證。',
                    defaultRole: '預設角色',
                    defaultRoleHelper: '僅在首次建立使用者時指派，不覆寫已有角色和權限。',
                    ...
                    disableDiscardConfirm:
                        '停用 OIDC 屬於故障兜底操作：只關閉登入入口，並立即使此認證來源使用者的存取失效。本頁其他未儲存修改（包括 Client Secret 修改）將被丟棄。是否繼續？',
                    ...
                    endSessionEndpointHelper: '首期只儲存，不執行 Provider 發起的單點登出。',
                    endSessionEndpointInvalid: '請輸入有效的 End Session Endpoint。',
                    firstLogin: '首次登入',
                    ...
                    hs256KeyHelper: 'HS256 固定使用目前認證來源的 Client Secret，不接受另一份簽章 Key。',
                    ...
                    issuer: 'Issuer URL',
                    issuerHelper: 'ID Token 的 iss 與 Discovery issuer 必須與該值完全一致。',
                    issuerInvalid: '請輸入不含查詢串和 fragment 的有效 HTTP 或 HTTPS Issuer URL。',
                    issuerRequired: '請輸入 Issuer URL。',
                    jwksRotation: 'JWKS 自動輪替',
                    jwksURI: 'JWKS URI',
                    jwksURIHelper: '使用非對稱簽章且金鑰來源為 JWKS 時必填。',
                    jwksURIInvalid: '請為目前簽章金鑰來源填寫有效的 JWKS URI。',
                    ...
                    manualEndpoints: '手動端點',
                    manualEndpointsDesc: '僅用於 Discovery 不完整或上游閘道改寫端點的 Provider。',
                    manualEndpointsSecurity: '手動端點不會關閉 Issuer、Audience、簽章、state、nonce 和時效驗證。',
                    mappingResult: '對映結果',
                    mode: '接入模式',
                    modeRequired: '請選擇接入模式。',
                    nameClaim: '使用者名稱 Claim',
                    nameClaimHelper: '優先讀取已驗證 ID Token 的頂層 Claim，UserInfo 只補充缺失值。',
                    nameClaimRequired: '請輸入使用者名稱 Claim。',
                    nameConflict: '同名衝突策略',
                    panelURL: '1Panel 對外位址',
                    panelURLHTTPWarning: 'HTTP 不保護授權回應，僅用於 Provider 接受的隔離私有環境。',
                    panelURLHelper: '只填寫瀏覽器可見的協定、網域名稱和選用埠，反向代理場景尤其需要確認。',
                    panelURLInvalid: '請輸入只包含協定、主機和選用連線埠的對外位址。',
                    panelURLRequired: '請輸入 1Panel 對外位址。',
                    ...
                    providerAndClient: 'Provider 與客戶端',
                    providerAndClientDesc: 'Client Secret 只允許替換或清除，頁面永不回顯。',
                    ...
                    requestAndClaimsDesc: '設定 Scopes、UserInfo 補充和有邊界的後端請求容錯。',
                    requestTimeout: '請求逾時',
                    ...
                    roleHandling: '角色處理',
                    scenario: '場景',
                    scopesHelper: 'openid 為必需項，預設不申請 email 和 offline_access。',
                    scopesRequired: 'Scopes 必須包含 openid。',
                    seconds: '秒',
                    secretClearHelper: '清除後，重新啟用 OIDC 前必須設定新的 Client Secret。',
                    secretConfigured: '已設定',
                    secretNotConfigured: '未設定',
                    secretPlaceholder: '輸入新 Client Secret',
                    secretReplaceHelper: '新金鑰會在儲存時取代原值，請同步更新 OIDC Provider 中的 Client Secret。',
                    secretRequiredHelper: '啟用 OIDC 前需要設定 Client Secret。',
                    secretRequiredToEnable: '請先設定 Client Secret，再啟用 OIDC。',
                    secretSavedHelper: '金鑰已加密儲存且不會回顯，且保持不變會保留原值。',
                    secretWaiting: '等待輸入',
                    ...
                    signingKey: '簽章金鑰',
                    signingKeyClientSecret: 'Client Secret（僅 HS256）',
                    ...
                    standardDiscoveryDesc: '1Panel 自動發現端點和能力，不儲存 Discovery 原文。',
                    standardMode: '標準 OIDC Discovery（建議）',
                    ...
                    testBeforeEnable: '啟用或儲存敏感變更前，請先測試目前設定。',
                    ...
                    tlsSkipVerify: '忽略 SSL 憑證驗證',
                    tlsSkipVerifyWarning: '憑證驗證只對目前認證來源關閉，並會記錄高風險稽核。',
                    tlsSystem: 'HTTPS · 系統憑證驗證（建議）',
                    tokenEndpoint: 'Token Endpoint',
                    tokenEndpointInvalid: '請輸入有效的 Token Endpoint。',
                    transportSecurity: '傳輸安全',
                    transportSecurityHelper: '優先使用 HTTPS；私有 HTTP 還需要明確允許私有網路。',
                    unsavedChanges: 'OIDC 設定有尚未儲存的變更。',
                    usedClaim: '使用 Claim',
                    userInfoDisabledHelper: '僅使用已驗證 ID Token 中的 Claim。',
                    userInfoEnabledHelper: '只補充缺少的使用者名稱 Claim，且 subject 必須一致。',
                    userInfoEndpoint: 'UserInfo Endpoint',
                    userInfoEndpointHelper: '僅在啟用 UserInfo 補充時使用。',
                    userInfoEndpointInvalid: '啟用 UserInfo 時請輸入有效的 UserInfo Endpoint。',
                    userMapping: '使用者對應',
                    userMappingDesc: 'subject 繫結身分，設定的 Claim 只對應到 1Panel User.Name。',
                },
                ldap: {
                    enable: '是否啟用',
                    enabled: '已啟用',
