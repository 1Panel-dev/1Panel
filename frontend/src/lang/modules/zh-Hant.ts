    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                passwordExpiration: '密碼逾期時間',
                passwordExpirationNormalDesc: '密碼逾期時間處於較安全範圍',
                passwordExpirationUnsetDesc: '密碼逾期時間未設定，建議盡快配置',
                passwordExpirationRiskDesc: '密碼將於 {0} 天內到期，建議提前處理',
                passwordExpirationExpiredDesc: '密碼已過期 {0} 天，請盡快處理',
