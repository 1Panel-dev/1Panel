...
const message = {
    apiKeyManagement: {
        ...
        identifier: '金鑰識別',
        details: 'API Key 詳情',
        quota: '新 Key {0} / {1}（停用、到期的仍計數，舊版 Key 不計入）',
        statusEnable: '已啟用',
        statusDisable: '已停用',
        statusRevoked: '已撤銷',
        statusExpired: '已到期',
        ...
        bindingException: '允許在目前帳號的面板登入工作階段中產生一次性 QR Code，再次向手機交付這把金鑰。',
        bindingDisableHelp: '關閉掃碼綁定後，已綁定裝置仍可使用，直到金鑰停用、撤銷或到期。',
        ...
        legacyHelp: '舊版 Key 用於相容已有連線，其開關與重設只影響這把 Key。',
        showLegacy: '檢視舊版金鑰',
        revoke: '撤銷',
        revokeConfirm:
