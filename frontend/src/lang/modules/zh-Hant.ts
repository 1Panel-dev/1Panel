...
const message = {
    ...
    firewall: {
        ...
        unUsed: '未使用',
        managed: '面板建立',
        managedHelper: '由 1Panel 建立並維護，可以編輯或刪除。',
        adopted: '外部納管',
        adoptedHelper: '原本是系統已有規則，目前已交由 1Panel 維護。',
        legacy: '舊版託管',
        external: '外部規則',
        drifted: '已漂移',
        protected: '系統保護',
        protectedHelper: '系統關鍵規則，為避免影響存取，不允許編輯或刪除。',
        stateShort: { managed: '面板', adopted: '已納管', external: '未納管', protected: '受保護', drifted: '已漂移' },
        ...
        plan_managed_rule_drifted: '相同的託管規則與系統實際狀態不一致，請先處理漂移。',
