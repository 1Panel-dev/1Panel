...
const message = {
    apiKeyManagement: {
        title: 'API Key',
        manage: '管理 API Key',
        personalEntry: '前往設定管理自己的金鑰、存取條件與 APP 掃碼綁定。',
        create: '建立 API Key',
        legacy: '舊版 Key',
        identifier: '金鑰識別',
        details: 'API Key 詳情',
        ...
        specifiedIPs: '指定 IP',
        anyIP: '所有 IP',
        ipHelp: '每行填寫一個 IP 或 CIDR。允許所有來源時，請明確選擇「所有 IP」。',
        signatureWindow: '請求簽章有效期間',
        expiresAt: '金鑰到期時間',
        never: '永不到期',
        futureExpiry: '請選擇晚於目前時間的到期時間。',
        allowAppBinding: '允許 APP 掃碼綁定',
        bindingDisableHelp: '關閉掃碼綁定後，將停止接受新的綁定；已綁定裝置可繼續使用，直至金鑰被停用、撤銷或到期。',
        saveSecret: '請立即複製並儲存金鑰。關閉後，一般金鑰管理無法再次顯示完整金鑰。',
        saved: '我已儲存金鑰',
        alreadyCreated:
            '這把金鑰已建立，無法再次顯示明文。若原回應遺失，請撤銷後重新建立；允許掃碼綁定時，也可透過掃碼交付。',
        uncertain: '請求結果尚不確定。請保持原設定重試，避免重複建立；或關閉並檢查清單後再建立其他金鑰。',
        legacyHelp: '舊版 Key 用於相容歷史 API 連線，啟用、停用及重設操作僅對該 Key 生效。',
        showLegacy: '檢視舊版金鑰',
        revoke: '撤銷',
        revokeConfirm:
        ...
        appSecurityHelp: '行動 App 使用所選 API Key 存取面板，權限與該 Key 所屬帳號一致。請妥善保管已綁定的裝置。',
        mobileIPHelp: '手機出口 IP 必須符合白名單。切換 Wi-Fi 或行動網路可能導致存取被拒絕，系統不會自動擴大白名單。',
        qrUnavailable: 'QR Code 已無法使用，請重新整理後再掃描。',
        showQR: '顯示 QR Code',
        hideQR: '隱藏 QR Code',
    ...
    commons: {
        ...
        rule: {
            ...
            vmName: '支援英文字母、數字、「.」、「-」和「_」；長度為 1-64；必須以字母或數字開頭。',
            vmNetwork: '支援英文字母、數字、「.」、「:」、「-」和「_」；長度為 1-64；必須以字母或數字開頭。',
            duplicate: '不能重複',
    ...
    aiTools: {
        agents: {
            ...
            operationType: '操作類型',
            batchAction: '批次{0}',
            installSkillAction: '部署 Skill',
            batchAgentTask: '批次{0} Agent',
            dispatchAgentTask: '分派 Agent {0}任務',
            dispatchTask: '分派 {0}任務',
            taskSubmitted: '已提交{0}任務',
            allNodes: '所有節點',
            targetVersion: '目標版本',
            skillSource: 'Skill 來源',
            skillKeyword: 'Skill 關鍵字',
            clawHubSkillPlaceholder: '請先搜尋並選擇 Skill',
            noAccountHint: '選擇現有模型帳號，或新增帳號。',
            accountCount: '{0} 個模型帳號',
            syncAgents: '同步相關 Agent',
            syncAgentsHelper: '更新所有使用此模型帳號的 Agent 設定檔 openclaw.json',
            appVersion: '應用程式版本',
            webuiPort: 'WebUI 埠',
            tokenOrAuth: 'Token/Auth',
            allowedOrigins: '存取位址',
            allowedOriginsRequired: '請至少填寫一個存取位址',
            allowedOriginsInvalid: '存取位址格式錯誤，請輸入 http(s)://網域或 IP[:埠]',
            provider: '模型供應商',
            accountModelsHelper: '設定此帳號可供 OpenClaw 選取及使用的模型清單',
            accountModelsRequired: '請至少設定一個模型',
            verifyModel: '驗證模型',
            verifyModelHelper: '請選擇該帳號有權存取的模型，儲存時將使用它傳送最小請求以驗證連線。',
            verifyModelRequired: '請選擇驗證模型',
            discoverModels: '取得模型',
            automaticModelDiscovery: '自動取得',
            manualModelConfiguration: '手動設定',
            discoverModelsHelper: '從供應商的 /v1/models API 取得模型，並將全部加入模型池',
            discoverModelsFailedFallback: '無法取得模型，請手動設定模型',
            discoverModelsFailedUseDefaults: '無法取得模型，已改用預設模型',
            accountModelsDuplicate: '模型清單中有重複項目，請檢查後再試一次',
            modelPool: '模型池',
            fallbackModels: '備用模型',
            addFallbackModel: '新增備用模型',
            fallbackModelsEmpty: '尚未設定備用模型',
            modelInputTypes: '輸入類型',
            modelMetadata: '模型能力設定',
            modelMetadataHelper: '設定僅套用於目前的 OpenClaw。留空時使用 OpenClaw 或模型供應商的預設值。',
            inputModeAuto: '自動識別',
            inputModeText: '僅文字',
            inputModeImage: '文字和圖片',
            contextWindow: '上下文視窗',
            useModelDefault: '使用模型預設值',
            reasoning: '推理模型',
            verified: '驗證狀態',
            verifySkipped: '略過驗證',
            skillsTab: 'Skill',
            ...
            pluginsMarket: '外掛市集',
            pluginsMarketHint: '請輸入關鍵字搜尋外掛',
            pluginSearchPlaceholder: '搜尋外掛...',
            pluginOrigin: '來源',
            ...
            pluginEnable: '啟用',
            pluginDisable: '停用',
            pluginListEmpty: '沒有外掛',
            pluginSearchEmpty: '找不到符合的外掛',
            pluginInstallConfirm: '確定要安裝外掛 {0} 嗎？',
            pluginDisableConfirm: '確定要停用外掛 {0} 嗎？',
            pluginUninstallConfirm: '確定要解除安裝外掛 {0} 嗎？',
            securityTab: '安全',
            otherTab: '其他',
            timeZone: '時區',
            browserEnabled: '啟用瀏覽器',
            npmRegistry: 'NPM Registry',
            npmRegistryHelper: 'OpenClaw 安裝外掛時使用，可選擇預設 Registry 或輸入自訂位址',
            npmRegistryInvalid: '請輸入以 http:// 或 https:// 開頭的有效 NPM Registry URL',
            pluginInstallNPMRegistryHelper: '可前往「設定 → 其他」設定 NPM Registry，以加快外掛安裝速度',
            skillsSearchPlaceholder: '搜尋 Skill...',
            skillsEmpty: '沒有 Skill',
            skillsMarket: 'Skill 市集',
            skillsMarketHint: '請選擇來源並搜尋 Skill',
            skillsMarketEmpty: '找不到符合的 Skill',
            ...
            skillsMarketSourceLocalHub: '本機 Skill 商店',
            skillsScore: '評分',
            skillsMarketSourceOfficial: '官方',
            versionUnsupportedTitle: '目前版本不支援此功能',
            versionUnsupportedHelper: '請將 OpenClaw 升級至 {0} 以上版本。',
            skillsGroupBuiltIn: '內建',
            ...
            roleMarkdownDescriptions: {
                ...
                'SOUL.md': ['人格、語氣和界線。', '每個工作階段都會載入。'],
                'USER.md': ['使用者是誰，以及應如何稱呼和回應使用者。', '每個工作階段都會載入。'],
                'IDENTITY.md': ['Agent 的名稱、風格和 emoji。', '會在初始設定流程中建立或更新。'],
                'TOOLS.md': ['本機工具和慣例的相關說明。', '不會控制工具是否可用，僅供使用指引。'],
                'HEARTBEAT.md': ['選用的 Heartbeat 執行檢查清單。', '請保持簡短，以免消耗過多 token。'],
                'BOOT.md': [
                    '選用的啟動檢查清單，會在 Gateway 重新啟動且已啟用內部 Hook 時執行。',
                    '請保持簡短；如需向外傳送訊息，請使用 message 工具。',
                ],
                'BOOTSTRAP.md': ['僅執行一次的初始設定流程。', '只會在全新的工作區中建立。', '完成初始設定後請刪除。'],
            },
            duplicateBinding: '頻道和帳號 ID 不能重複',
            accountIdOptional: '帳號 ID（選填）',
            saveAllMd: '全部儲存',
            roleMarkdownRestartHelper: '儲存目前所有 MD 檔案後，必須重新啟動容器才能生效。請選擇立即或稍後重新啟動。',
            configFileRestartHelper: '儲存設定檔後，必須立即重新啟動容器才能生效。',
            overviewSnapshot: '狀態快照',
            primaryModel: '主模型',
            defaultModel: '預設模型',
            channelCount: '已設定頻道數',
            skillCount: 'Skill 數',
            ...
            hermesChatNoSessions: '沒有工作階段',
            hermesChatMessageCount: '{0} 則',
            hermesChatEmptyHint: '請選擇左側的工作階段，或點擊「新對話」',
            hermesChatTitlePlaceholder: '請輸入工作階段標題',
            hermesChatRenameSuccess: '工作階段標題已更新',
            hermesChatDeleteConfirm: '確定要刪除工作階段 {0} 嗎？',
            hermesChatDeleteSuccess: '工作階段已刪除',
            weixin: 'Weixin',
            wecom: 'WeCom',
            dingtalk: 'DingTalk',
            feishu: 'Feishu',
            pluginNotInstalled: '尚未安裝外掛，請先安裝。',
            dmPolicy: '私訊策略',
            threadSession: '討論串工作階段',
            replyMode: '回覆模式',
            requireMention: '需要提及',
            requireMentionTrue: "需要 {'@'}",
            requireMentionFalse: "不需要 {'@'}",
            ...
            addBot: '新增 Bot',
            accountId: '帳號 ID',
            accountIdPlaceholder: '用來區分 Bot 的唯一 ID，儲存後會用於設定與路由',
            setDefaultBot: '設為預設 Bot',
            botDuplicateField: '{field} 不能重複',
            botRequired: '請至少新增一個 Bot',
            botId: 'Bot ID',
            allowFrom: '私訊允許清單',
            allowFromPlaceholder: '一行一個傳送者 ID',
            allowlistPolicyHelper: '{0}；僅在「{1}」設為「允許清單」時生效',
            systemPrompt: '系統提示詞',
            groupAllowFrom: '群組允許清單',
            groupAllowFromPlaceholder: '一行一個群組識別碼',
            separateSessionByConversation: '依對話建立個別工作階段',
            groupSessionScope: '群組工作階段範圍',
            groupSessionScopeGroup: '群組共用',
            groupSessionScopeGroupSender: '依傳送者分開',
            sharedMemoryAcrossConversations: '跨對話共用記憶',
            asyncMode: '非同步模式',
            ackText: '確認訊息',
            ...
            allowFromRequired: '請至少填寫一筆允許清單項目',
            pairingCode: '配對碼',
            pairingCodePlaceholder: '請輸入配對碼',
            approvePairing: '核准配對',
            saveSuccess: '儲存成功',
            successAndRestart: '{0}，容器正在自動重新啟動。',
            pairingApproveSuccess: '已核准配對',
            scanConnect: '掃描 QR Code 以連線',
            scanConnectHelper: '按一下後，QR Code 會顯示於任務日誌中；掃描成功後，容器將自動重新啟動。',
            channelAutoRestartHelper: '儲存後將自動重新啟動容器，使設定生效。',
            dashboardAuthAutoRebuildHelper: '儲存使用者名稱或密碼後，將自動重建容器，使設定生效。',
            dashboardAuthImmediateHelper: '儲存後將立即更新 QwenPaw 登入資訊，無須重新啟動容器。',
            channelDeleteConfirm: '確定要刪除 {0} 頻道設定嗎？',
            apiTypeBaseURLHelper: '此類型會將請求傳送至 {0}。建議的 Base URL：{1}',
            customImageURLHelper: '自訂圖片帳號請填寫完整的圖片產生 API URL，系統不會自動補上路徑，例如：{0}',
            apiTypeBaseURLMismatch: '目前 Base URL 看起來是 {0} 路徑，和已選擇的 {1} 不一致，建議改為 {2}',
            validateAvailability: '驗證帳號可用性',
            validateAvailabilityHelper: '儲存前傳送最小訊息，以驗證 API 是否可用',
        ...
        model: {
            ...
            ascendVisibleDevices: 'Ascend 可見裝置（ASCEND_RT_VISIBLE_DEVICES）',
        ...
        aiProxy: {
            ...
            lastUsedAt: '最近使用時間',
            validityPeriod: '有效期',
            keepCurrentValidity: '保留目前有效期',
            neverExpires: '永不過期',
            validForDays: '有效 {0} 天',
            customDays: '自訂天數',
            enterValidityDays: '請輸入有效天數',
            currentExpiresAt: '目前到期時間：{0}',
            currentNeverExpires: '目前為永不過期',
            expiresAt: '到期時間',
            expired: '已過期',
            reactivate: '重新啟用',
            ...
            currentLimit: '目前 / 上限',
            utilization: '使用率',
            autoRefreshSeconds: '每 {0} 秒自動重新整理',
            zeroMeansUnlimited: '設為 0 表示不限制。',
            groupMaxConcurrencyDesc: '限制此使用者群組所有 API Key 的活躍請求總數，設為 0 表示不限制。',
            apiKeyMaxConcurrencyDesc: '限制此使用者群組內每個 API Key 的活躍請求數，設為 0 表示不限制。',
            schedulingReason: '調度原因',
            schedulingAffinity: '親和命中',
            schedulingLeastUtilized: '最低利用率',
            schedulingPriorityFallback: '優先級降級',
            schedulingRetry: '故障重試',
            queueSize: '等待佇列大小',
        ...
        skillsHub: {
            ...
            publish: '上架',
            disable: '下架',
            customTarget: '智能體 Skill 目錄',
            installToTarget: '安裝到智能體 Skill 目錄',
            ...
            deleteTargetConfirm: '確認刪除該智能體 Skill 目錄設定？刪除後使用者不能繼續選擇該安裝目錄。',
            noInstallTarget: '暫無可用的智能體 Skill 目錄，請先新增。',
    ...
    container: {
        ...
        composePathHelper:
            '編排檔案儲存路徑：{0}；若 Docker Compose 中指定了專案名稱，則優先使用該名稱，否則使用 {1}。',
        ...
        finishTime: '上一次停止時間',
        exportHelper: '將選取的映像匯出為一個 tar 檔案。',
    },
    cronjob: {
        importHelper:
    ...
    terminal: {
        ...
        sessionRuleDisableShortcut: '可在「終端 - 設定」中關閉終端捷徑。',
        minimize: '最小化',
        closeAllSessions: '關閉所有會話',
        closeAllConfirm: '將斷開全部終端會話且無法恢復，是否繼續？',
        disableShortcutConfirm: '關閉終端捷徑將同時斷開其中的全部會話，是否繼續？',
        lineHeight: '字體行高',
        letterSpacing: '字體間距',
        fontSize: '字體大小',
        fontFamily: '字體集',
    ...
    setting: {
        ...
        apiKeyValidityTimeHelper: '請求簽章的有效時長，單位為分鐘，自請求時間戳記起計算。設為 0 時不驗證時間戳記。',
        apiKeyReset: '介面金鑰重設',
        ...
        syncTime: '伺服器時間',
        timeZone: '時區',
        timeZoneChangeHelper: '修改時區需要重新啟動服務，是否繼續？',
        timeZoneHelper: '時區修改依賴系統 timedatectl 服務，重新啟動 1Panel 服務後生效。',
        timeZoneCN: '北京',
        timeZoneAM: '洛杉磯',
        timeZoneNY: '紐約',
        ntpALi: '阿里雲',
        ntpGoogle: 'Google',
        syncSite: 'NTP 伺服器',
        syncSiteHelper: '該操作將使用 {0} 作為來源同步系統時間，是否繼續？',
        changePassword: '密碼修改',
        oldPassword: '原密碼',
        newPassword: '新密碼',
        retryPassword: '確認密碼',
        ...
        allowIPsPrivateHelper: '內網地址也受限制；本機直連請加入 127.0.0.1 或 ::1，反向代理請設定可信代理。',
    ...
    license: {
        ...
        vm: '升級商業版，即可在 1Panel 中統一管理虛擬機、映像與範本、虛擬網路和儲存資源。',
    ...
    app: {
        ...
        startOperatorHelper: '即將啟動應用，是否繼續？',
        stopOperatorHelper: '即將停止應用，是否繼續？',
        restartOperatorHelper: '即將重新啟動應用，是否繼續？',
        reloadOperatorHelper: '即將重新載入應用，是否繼續？',
    ...
    website: {
        ...
        proxyCache: '反向代理快取',
        cacheLimit: '快取空間限制',
        shareCache: '快取計數記憶體大小',
        cacheExpire: '快取過期時間',
        shareCacheHelper: '每1M記憶體可以儲存約8000個快取物件',
    ...
    nginx: {
        ...
        brotliMinLengthHelper: 'brotli 壓縮的最小回應大小',
        brotliSaveFailed: 'brotli 設定儲存失敗，上方的 gzip 設定已套用',
    ...
    firewall: {
        ...
        backendRecommendation: '建議使用 iptables 或 nftables 管理。',
        ...
        clearDockerGuardPoliciesConfirm: '清空後，所選發佈端點將恢復 Docker 預設存取行為。是否繼續？',
        protection: '防護',
        portDetails: '連接埠詳情',
        ...
        dockerGuardStatusReason: {
            ...
            docker_chain_missing:
                'Docker 目前未啟用 {0} 容器網路，因此無需設定對應的連接埠防護；如需使用，請先在 Docker 中啟用 {0}',
            guard_chain_missing: '{0} 容器連接埠防護尚未完成初始化，請重新初始化',
            jump_missing: '{0} 容器連接埠防護尚未綁定，因此目前不生效，請重新綁定',
            jump_not_first: '{0} 容器連接埠防護設定異常，可能無法完整生效，建議解除綁定後重新綁定',
            jump_duplicate: '{0} 容器連接埠防護存在重複設定，建議解除綁定後重新綁定',
            inspect_failed: '暫時無法取得 {0} 容器連接埠防護狀態，請重新整理或檢查系統防火牆',
        },
        dockerGuardUnprotected: '未防護',
        sourcePort: '來源埠',
        targetIP: '目標 IP',
        targetPort: '目標埠',
        ...
        directBackendConflictWarning:
            '{0} 與 {1} 目前同時綁定，兩套規則會疊加生效。請確認規則不會互相阻擋，並手動解除綁定不再使用的防火牆。',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scoreWebsiteMonitorAvailability: '網站監控請求可用率 {0}% 低於閾值',
        ...
        user: {
            ...
            auth: {
                ...
                defaultNode: '預設節點',
                defaultNodePlaceholder: '請選擇節點',
                defaultNodeHelper: '僅用於新使用者。',
                defaultNodeRequired: '請選擇有效的預設節點。',
                nodesLoadFailed: '節點清單載入失敗，請重試後再選擇預設節點。',
                nodeHandling: '節點處理',
                assignDefaultNode: '分配預設節點：{node}',
                keepExistingNode: '保留已有節點權限',
                providers: {
                    ldap: 'AD/LDAP',
                    passkey: 'Passkey',
                    radius: 'Radius',
                ...
                oidc: {
                    accessMode: '存取方式',
                    accessModeDesc: '身分提供者支援 Discovery 時優先使用標準模式。',
                    actionCreate: '建立使用者',
                    actionKeepName: '保留目前名稱',
                    actionPending: '等待結果',
                    actionReject: '拒絕登入',
                    actionUpdate: '更新身分資訊',
                    advanced: '進階設定',
                    advancedDesc: '預設值適用於標準 Provider；只有不相容時才調整。',
                    assignDefaultRole: '指派預設角色：{role}',
                    authorizationEndpoint: '授權端點',
                    authorizationEndpointInvalid: '請輸入有效的授權端點位址。',
                    authorizationFlow: '授權流程',
                    automatic: '自動',
                    automaticPolicy: '自動處理策略',
                    automaticPolicyDesc: '以下規則由後端固定執行，不作為管理員開關。',
                    basic: '基礎設定',
                    basicDesc: '先選擇 Provider 模式，再設定客戶端和回呼位址。',
                    browserTest: '瀏覽器測試登入',
                    browserTestConflict: '身分驗證成功，但使用者名稱衝突',
                    browserTestConflictHelper: '對映名稱屬於其他身分，不會自動認領。',
                    browserTestExpired: '瀏覽器測試已過期',
                    browserTestExpiredHelper: '請重新開始測試，並在有效期限內完成授權。',
                    browserTestFailed: '瀏覽器測試失敗',
                    browserTestFailedHelper: '無法完成身分預覽，請檢視後端傳回的在地化錯誤。',
                    browserTestIsolation: '執行真實授權往返，但不會建立或更新使用者、指派角色或產生正式 Session。',
                    browserTestPopupBlocked: '請允許目前站點開啟彈跳窗，然後重新測試。',
                    browserTestPopupClosed: '授權視窗在測試完成前被關閉。',
                    browserTestSuccess: 'Provider 驗證成功',
                    browserTestSuccessHelper: '已完成身分對映預覽，沒有修改使用者或 Session。',
                    browserTestTitle: 'OIDC 瀏覽器測試登入',
                    browserTestWaiting: '等待 Provider 授權',
                    browserTestWaitingHelper: '請在新視窗完成登入，本頁面會自動更新。',
                    callbackCopied: 'OIDC 回呼位址已複製。',
                    callbackURL: '回呼位址',
                    callbackURLHelper: '請將此位址加入身分提供方客戶端的允許回呼清單。',
                    cancelClearSecret: '取消清除',
                    clearSecret: '清除金鑰',
                    clearSecretConfirm: '客戶端金鑰只會在儲存後刪除，是否繼續？',
                    clientAuthMethod: '客戶端認證方式',
                    clientAuthMethodHelper: '請選擇身分提供方為該客戶端設定的認證方式。',
                    clientAuthMethodRequired: '請選擇客戶端認證方式。',
                    clientID: '客戶端 ID',
                    clientIDRequired: '請輸入客戶端 ID。',
                    clientSecret: '客戶端金鑰',
                    clockSkew: '權杖時間偏差',
                    clockSkewHelper: '允許身分提供者與面板存在少量時間偏差，建議保持 60 秒。',
                    clockSkewRequired: '請輸入權杖時間偏差。',
                    compatibilityMode: '相容模式',
                    compatibilityModeHelper: '僅用於 Discovery 不完整或端點被改寫的 Provider，核心 OIDC 驗證不會關閉。',
                    configurationFailedHelper: '測試失敗，頁面只顯示後端在地化錯誤。',
                    configurationFailedTag: '測試失敗',
                    configurationHighRiskPassed: '設定測試通過，但包含高風險相容項。',
                    configurationHighRiskTag: '高風險設定通過',
                    configurationNotTested: '目前設定尚未測試。',
                    configurationNotTestedTag: '尚未測試',
                    configurationPassed: '目前設定已通過安全性和能力檢查。',
                    configurationPassedTag: '測試通過',
                    configurationStaleHelper: '設定已修改，請重新測試後儲存。',
                    configurationStaleTag: '結果已過期',
                    configurationTestMeta: '測試時間 {time}，耗時 {duration} ms；不儲存 Provider 原始回應。',
                    configurationTestResult: '設定測試結果',
                    configurationTestResultDesc:
                        '此處只檢查自動發現結果與身分提供方能力，不交換授權碼，也無法證明客戶端金鑰正確；請使用「瀏覽器測試登入」完成端對端驗證。',
                    configurationTestSuccess: 'OIDC 設定測試成功。',
                    configurationTesting: '正在測試目前 OIDC 設定…',
                    configurationTestingTag: '正在測試',
                    configureSecret: '設定金鑰',
                    conflictExistingRename: '已有 subject 回傳的新 name 已被佔用',
                    conflictExistingRenameResult: '保留原 User.Name，並允許已繫結使用者繼續登入',
                    conflictLDAP: 'LDAP 使用者',
                    conflictLocal: '本機使用者',
                    conflictNewAvailable: '新 subject，對映後的 name 未佔用',
                    conflictNewAvailableResult: '建立本機企業使用者並指派預設角色',
                    conflictNone: '無衝突',
                    conflictOIDC: '其他 OIDC 身分',
                    conflictOccupied: '對映 name 已被本機、LDAP 或其他 OIDC 身分佔用',
                    conflictOccupiedResult: '拒絕新身分，不自動繫結或合併',
                    conflictType: '衝突型別',
                    connectionSecurity: '連線安全',
                    connectionSecurityDesc: '預設驗證憑證，私有 IdP 位址由系統自動識別。',
                    connectionTest: '連線與設定測試',
                    connectionTestCompatibilityDesc: '驗證自訂端點和協定安全性策略。',
                    connectionTestStandardDesc: '根據簽發者位址自動發現端點和能力。',
                    connectionTestTab: '連線測試',
                    customCA: '自訂 CA',
                    customCAHelper: '僅作用於目前認證來源，且不會寫入日誌。',
                    customCARequired: '請提供自訂 CA 憑證。',
                    defaultRole: '預設角色',
                    defaultRoleHelper: '僅首次建立使用者時指派，後續登入不修改角色。',
                    defaultRolePlaceholder: '請選擇角色',
                    defaultRoleRequired: '請選擇有效的預設角色。',
                    disableAfterSave: '儲存後將停用 OIDC。',
                    disableConfirm: '停用 OIDC 會立即使該認證來源使用者的存取失效，是否繼續？',
                    disableDiscardConfirm:
                        '停用 OIDC 屬於故障兜底操作：只關閉登入入口，並立即使此認證來源使用者的存取失效。本頁其他未儲存修改（包括客戶端金鑰修改）將被丟棄。是否繼續？',
                    disableTitle: '停用 OIDC',
                    disabled: '未啟用',
                    discoveryAllowlist: 'Discovery ∩ 安全白名單',
                    enable: '是否啟用',
                    enableAfterSave: '儲存成功後啟用 OIDC。',
                    enabled: '已啟用',
                    endSessionEndpoint: '會話登出端點',
                    endSessionEndpointHelper: '首期只儲存，不執行身分提供方發起的單點登出。',
                    endSessionEndpointInvalid: '請輸入有效的會話登出端點位址。',
                    endpointDiscoveryPlaceholder: '測試連線後顯示',
                    firstLogin: '首次登入',
                    firstLoginPolicy: '建立本機企業使用者，並指派設定的預設角色。',
                    fixedAuthorizationCode: 'Authorization Code Flow',
                    fixedNoTokenPersistence: '不持久化 Token、Claims 和 verifier',
                    fixedSecurityPolicy: '系統固定執行，無需設定',
                    fixedStateNonce: '一次性 state 與 nonce',
                    fixedTokenValidation: 'ID Token 簽章與 Claims 驗證',
                    highRiskSaveConfirm: '目前啟用設定包含高風險相容項，請確認隔離環境確實需要這些設定。',
                    highRiskTitle: '高風險 OIDC 設定',
                    hs256Compatibility: 'HS256（相容模式）',
                    hs256KeyHelper: 'HS256 固定使用目前認證來源的客戶端金鑰，不接受另一份簽章金鑰。',
                    hs256Warning: 'HS256 使用共享對稱金鑰驗證 ID Token；僅在 Provider 無法使用非對稱演算法時啟用。',
                    identityBindingPolicy: '身分主鍵固定為 AuthSourceID + issuer + subject，同名不會認領其他帳號。',
                    identityMissing: '身分已失效',
                    issuer: '簽發者位址',
                    issuerHelper: '用於 OIDC 自動發現，回傳的 issuer 必須與該位址一致。',
                    issuerInvalid: '請輸入不含查詢參數和片段的有效 HTTP 或 HTTPS 簽發者位址。',
                    issuerRequired: '請輸入簽發者位址。',
                    jwksRotation: 'JWKS 自動輪替',
                    jwksURI: 'JWKS 位址',
                    jwksURIHelper: '使用非對稱簽章且金鑰來源為 JWKS 時必填。',
                    jwksURIInvalid: '請為目前簽章金鑰來源填寫有效的 JWKS 位址。',
                    keepExistingRole: '保留已有角色和本機權限',
                    localSecurityData: '本機安全資料',
                    localSecurityDataPolicy: '不覆寫角色、MFA、API Key、Passkey 和本機權限。',
                    localCredentialsManaged:
                        '使用者名稱和本機密碼由 OIDC 身分管理，無法在此修改；角色、權限、MFA、API Key 與 Passkey 仍由本機管理。',
                    localUserFields: '本機使用者欄位',
                    localUserFieldsDesc: '首期只對映 User.Name，不使用 JSON 對映表示式。',
                    loginWith: '使用 {provider} 登入',
                    manualEndpoints: '自訂端點',
                    manualEndpointsDesc: '僅用於自動發現不完整或上游閘道改寫端點的身分提供方。',
                    mappingResult: '對映結果',
                    mode: '接入模式',
                    modeRequired: '請選擇接入模式。',
                    nameClaim: '使用者名稱 Claim',
                    nameClaimHelper: '填寫身分提供方傳回使用者名稱的欄位，如 preferred_username。',
                    nameClaimRequired: '請輸入使用者名稱 Claim。',
                    nameConflict: '同名衝突策略',
                    panelURL: '面板對外位址',
                    panelURLHTTPWarning: 'HTTP 不保護授權回應，僅用於 Provider 接受的隔離私有環境。',
                    panelURLHelper: '填寫使用者實際存取面板的位址，用於產生回呼位址。',
                    panelURLInvalid: '請輸入只包含協定、主機和選用連線埠的對外位址。',
                    panelURLRequired: '請輸入面板對外位址。',
                    pkceDisabled: '不使用 PKCE（僅相容模式）',
                    pkceDisabledWarning: '關閉 PKCE 會降低授權碼流程的抗截獲能力。',
                    pkceHelper: '優先使用 S256，永不提供 plain。',
                    pkceS256: 'S256（建議）',
                    plannedHandling: '預計處理',
                    privateNetworkIdP: '私有網路 IdP',
                    privateNetworkIdPHelper:
                        '明確允許私有位址；元資料、迴路、連結本機、異常重新導向和 DNS 重新繫結仍會阻止。',
                    privateNetworkWarning: '目前認證來源已允許存取私有網路。',
                    protocolCompatibility: '協定相容',
                    protocolCompatibilityDesc: 'ID Token 簽章驗證始終無法關閉。',
                    providerAndClient: '身分提供方與客戶端',
                    providerAndClientDesc: '客戶端金鑰只允許替換或清除，頁面不會回顯。',
                    providerCapabilities: 'Provider 能力',
                    recentTestSuccess: '最近測試成功：{0}',
                    recommended: '推薦',
                    rejectPlain: '拒絕 plain',
                    replaceSecret: '更換金鑰',
                    requestAndClaims: '請求與屬性',
                    requestAndClaimsDesc: '設定授權範圍、使用者資訊補充和請求參數。',
                    requestTimeout: '請求逾時',
                    requestTimeoutRequired: '請輸入請求逾時時間。',
                    restore: '還原',
                    restored: '已還原到上次儲存的 OIDC 設定。',
                    result: '處理結果',
                    rolesLoadFailed: '角色清單載入失敗，請重試後再選擇預設角色。',
                    roleHandling: '角色處理',
                    scenario: '場景',
                    scopes: '授權範圍',
                    scopesHelper: '必須包含 openid，多個範圍請使用空格分隔。',
                    scopesRequired: 'Scopes 必須包含 openid。',
                    seconds: '秒',
                    secretClearHelper: '清除後，重新啟用 OIDC 前必須設定新的客戶端金鑰。',
                    secretConfigured: '已設定',
                    secretNotConfigured: '未設定',
                    secretPlaceholder: '輸入新的客戶端金鑰',
                    secretReplaceHelper: '新金鑰會在儲存時取代原值，請同步更新身分提供方中的客戶端金鑰。',
                    secretRequiredHelper: '啟用 OIDC 前需要設定客戶端金鑰。',
                    secretRequiredToEnable: '請先設定客戶端金鑰，再啟用 OIDC。',
                    secretSavedHelper: '已加密儲存，留空則繼續使用目前金鑰。',
                    secretWaiting: '等待輸入',
                    secretWillClear: '儲存後清除',
                    secretWillReplace: '待替換',
                    signingAlgorithm: 'ID Token 簽章演算法',
                    signingAlgorithmHelper: '只能選擇後端安全白名單中的演算法。',
                    signingKey: '簽章金鑰',
                    signingKeyClientSecret: '客戶端金鑰（僅 HS256）',
                    signingKeyJWKS: 'JWKS URI 自動取得與輪替',
                    signingKeySource: '簽章金鑰來源',
                    signingKeySourceHelper: '優先使用 JWKS；靜態公鑰無法自動輪替。',
                    signingKeyStatic: '靜態 JWK 或 PEM 公鑰',
                    standardDiscovery: '標準模式（自動發現）',
                    standardDiscoveryDesc: '面板自動發現端點和能力，不儲存自動發現原文。',
                    standardMode: '標準模式',
                    standardModeHelper: '根據 Issuer 自動發現端點、簽章能力和 PKCE 支援。',
                    standardProtocolPolicy: '標準協定策略',
                    standardProtocolPolicyDesc: '自動協商簽章能力，不需要填寫簽章演算法和金鑰。',
                    staticSigningKey: '靜態簽章公鑰',
                    staticSigningKeyHelper: '只接受公鑰材料；Provider 換 Key 後需要手動更新。',
                    staticSigningKeyPlaceholder: '貼上 JWK、JWKS JSON 或 PEM 公鑰',
                    staticSigningKeyRequired: '請提供靜態簽章公鑰。',
                    staticSigningKeyWarning: '靜態簽章公鑰無法自動輪替；Provider 換 Key 前必須手動更新。',
                    settingLoadFailed: 'OIDC 設定載入失敗',
                    settingLoadFailedHelper: '為避免以空白預設值覆寫已有設定，目前表單已鎖定。請在連線恢復後重試。',
                    subsequentLogin: '後續登入',
                    subsequentLoginPolicy: '按 subject 找到繫結，僅在新名稱可用時更新 User.Name。',
                    testBeforeBrowserTest: '請先測試目前設定，再進行瀏覽器測試登入。',
                    testBeforeEnable: '儲存設定變更前，請先測試目前設定。',
                    testConfiguration: '測試設定',
                    testDiscovery: '測試連線',
                    tlsCustomCA: 'HTTPS · 自訂 CA 憑證',
                    tlsPrivateHTTP: 'HTTP · 僅私人網路（危險）',
                    tlsPrivateHTTPWarning: 'HTTP 不提供傳輸加密，只允許明確放行的私有目標。',
                    tlsSkipVerify: '略過 TLS 憑證驗證',
                    tlsSystem: 'HTTPS · 系統憑證驗證（建議）',
                    tokenEndpoint: '權杖端點',
                    tokenEndpointInvalid: '請輸入有效的權杖端點位址。',
                    transportSecurity: '傳輸安全',
                    transportSecurityHelper: '優先使用 HTTPS；私有 HTTP 還需要明確允許私有網路。',
                    unsavedChanges: 'OIDC 設定有尚未儲存的變更。',
                    usedClaim: '使用 Claim',
                    userInfoEndpoint: '使用者資訊端點',
                    userInfoEndpointHelper: '使用者名稱欄位缺少時，系統將從此端點補充；留空則不補充。',
                    userInfoEndpointInvalid: '請輸入有效的使用者資訊端點位址。',
                    userMapping: '使用者設定',
                    userMappingDesc: '設定 OIDC 使用者名稱映射，以及首次登入建立使用者時使用的預設節點和角色。',
                },
                saml2: {
                    actionCreate: '建立使用者',
                    actionPending: '等待結果',
                    actionReject: '拒絕登入',
                    actionReuse: '使用已綁定使用者',
                    assignDefaultRole: '分配新使用者角色：{role}',
                    basic: '基礎設定',
                    basicDesc: '設定大多數標準 SAML2 身分提供者所需的常用選項。',
                    browserTest: '測試登入',
                    browserTestConflict: '身分驗證成功，但使用者名稱衝突',
                    browserTestConflictHelper: '映射後的使用者名稱屬於其他身分，不會自動關聯。',
                    browserTestExpired: '瀏覽器測試已過期',
                    browserTestExpiredHelper: '請重新開始測試，並在有效期內完成登入。',
                    browserTestFailed: '瀏覽器測試失敗',
                    browserTestFailedHelper: '無法完成身分預覽，請查看後端傳回的本地化錯誤。',
                    browserTestIsolation: '執行真實 SAML2 往返，但不會建立使用者、分配角色或產生正式工作階段。',
                    browserTestPopupBlocked: '請允許目前網站開啟彈出視窗，然後重新測試。',
                    browserTestPopupClosed: '登入視窗在測試完成前已關閉。',
                    browserTestSuccess: 'SAML2 身分驗證成功',
                    browserTestSuccessHelper: '身分映射預覽已完成，沒有修改使用者或工作階段。',
                    browserTestTitle: 'SAML2 測試登入',
                    browserTestWaiting: '等待 IdP 登入',
                    browserTestWaitingHelper: '請在新視窗完成登入，本頁會自動更新。',
                    certificateFileInvalid: '請選擇有效的 PEM、CRT 或 CER 憑證檔案。',
                    configured: '已設定',
                    configurationFailedHelper: '測試失敗，頁面只顯示後端本地化錯誤。',
                    configurationNotTested: '目前設定尚未測試。',
                    configurationPassed: '目前設定已通過驗證。',
                    configurationStaleHelper: '影響驗證的設定已修改，請重新測試目前草稿。',
                    configurationTestSuccess: 'SAML2 設定測試成功。',
                    configurationTesting: '正在測試目前 SAML2 設定…',
                    conflictLDAP: 'LDAP 使用者',
                    conflictLocal: '本機使用者',
                    conflictNone: '無衝突',
                    conflictOIDC: 'OIDC 身分',
                    conflictSAML2: '其他 SAML2 身分',
                    conflictType: '衝突類型',
                    credentialFileReadFailed: '無法讀取憑證檔案。',
                    credentialFileTooLarge: '憑證檔案不能超過 256 KiB。',
                    credentialsRequired: '請同時設定 SP 私鑰和 SP 憑證。',
                    defaultRole: '新使用者角色',
                    defaultRoleHelper: '僅在首次建立時設定；後續登入保留本機角色、MFA 和權限。',
                    defaultRolePlaceholder: '請選擇角色',
                    defaultRoleRequired: '請選擇有效的新使用者角色。',
                    disableConfirm: '停用 SAML2 會立即拒絕新登入並使其使用者工作階段失效，是否繼續？',
                    disableDiscardConfirm:
                        '停用 SAML2 會捨棄本頁其他未儲存修改，並立即使其使用者工作階段失效，是否繼續？',
                    disableTitle: '停用 SAML2',
                    disabled: '未啟用',
                    enable: '是否啟用',
                    enabled: '已啟用',
                    idpMetadata: 'IdP 元資料',
                    idpMetadataDesc: '填寫 URL 或貼上 XML，擇一即可；同時填寫時優先讀取 URL。',
                    keepExistingRole: '保留現有角色和本機權限',
                    loginWith: '使用 {provider} 登入',
                    mappingResult: '映射結果',
                    metadataRequired: '請填寫 IdP 元資料 URL 或 XML。',
                    metadataURLHelper: '測試和儲存時由後端讀取並驗證元資料。',
                    metadataURLInvalid: '請輸入不含憑證和片段的有效 HTTPS 元資料 URL。',
                    metadataURLRecommended: '元資料 URL（建議）',
                    metadataXML: '元資料 XML',
                    metadataXMLHelper: '適用於身分提供者（IdP）沒有可存取的元資料 URL 的情況。',
                    metadataXMLInvalid: '請輸入包含有效 EntityDescriptor 的元資料 XML。',
                    metadataXMLPlaceholder: '貼上 <EntityDescriptor>...</EntityDescriptor>',
                    nameAttribute: '使用者名稱屬性',
                    nameAttributeHelper: '從已驗證的 SAML 斷言中讀取該屬性，並映射為面板使用者名稱。',
                    nameAttributePlaceholder: '例如 uid、username 或 account',
                    nameAttributeRequired: '請填寫使用者名稱屬性。',
                    notConfigured: '未設定',
                    or: '或',
                    pageDesc: '透過 IdP 元資料接入企業單一登入，常用設定可在一頁完成。',
                    plannedHandling: '預計處理',
                    privateKeyFileInvalid: '請選擇有效的 PEM 私鑰檔案。',
                    recentTestSuccess: '最近測試成功：{0}',
                    restore: '還原',
                    restored: '已還原至上次儲存的 SAML2 設定。',
                    roleHandling: '角色處理',
                    rolesLoadFailed: '角色清單載入失敗，請重試後再選擇新使用者角色。',
                    selectFile: '選擇檔案',
                    serviceStatus: '服務狀態',
                    serviceStatusDesc: '首次啟用前需要先通過目前設定測試。',
                    settingLoadFailed: 'SAML2 設定載入失敗',
                    settingLoadFailedHelper: '為避免以空白預設值覆寫現有設定，目前表單已鎖定。請在連線恢復後重試。',
                    spCertificate: 'SP 憑證',
                    ...
                    syncLogout: '同步登出',
                    syncLogoutHelper: '從面板或身分提供者任一方登出時，也會同步登出另一方。',
                    testBeforeBrowserTest: '請先測試目前設定，再執行瀏覽器測試登入。',
                    testBeforeEnable: '啟用 SAML2 或儲存驗證敏感變更前，請先測試目前設定。',
                    testConfiguration: '測試設定',
                    unsavedChanges: 'SAML2 設定有未儲存的變更。',
                    usedAttribute: '使用者名稱映射',
                    usersAndRoles: '使用者與角色',
                    usersAndRolesDesc: '設定面板使用者名稱映射，以及首次登入建立使用者時使用的預設節點和角色。',
                },
                ldap: {
                    basic: '基礎設定',
                    loginTitle: 'LDAP 登入',
                    loginWith: '使用 LDAP 登入',
                    backToLocalLogin: '返回面板登入',
                    enable: '是否啟用',
                    enabled: '已啟用',
                    disabled: '未啟用',
                    connection: '基礎連線',
                    ...
                    userSearch: '使用者搜尋',
                    userSearchDesc: '設定使用者搜尋基準與過濾器，並映射到面板使用者名稱欄位。',
                    userFilter: '使用者篩選器',
                    userFilterTooltip: '按使用者名稱查詢時替換 %(user)s，全量讀取時替換為 *。',
                    userFilterHelper: '搜尋和認證時會對使用者名稱執行 LDAP filter escaping。',
                    attributeMap: '映射屬性',
                    attributeMapTooltip: '面板使用者名稱欄位（name）到 LDAP 屬性的 JSON 映射。',
                    attributeMapHelper: '填寫映射到面板使用者名稱欄位（name）的 LDAP 屬性。',
                    advanced: '進階設定',
                    ...
                    sync: {
                        title: '定時同步',
                        description: '定期讀取 LDAP 全量使用者，並維護面板中的 LDAP 使用者。',
                        enable: '是否啟用',
                    ...
                    testLoginDesc: '使用 AD/LDAP 使用者憑證執行 bind 驗證，僅測試認證能力，不建立面板登入工作階段。',
        ...
        helper: {
            ...
            vmTitle1: '虛擬機管理',
            vmContent1: '建立和管理虛擬機，查看執行狀態並調整資源配置。',
            vmTitle2: '映像與範本',
            vmContent2: '統一管理 ISO 映像和虛擬機範本，便捷建立虛擬機。',
            vmTitle3: '虛擬網路',
            vmContent3: '集中管理虛擬網路，設定虛擬機網路連線。',
            vmTitle4: '儲存池',
            vmContent4: '統一管理儲存池，為虛擬機分配儲存資源。',
            nodeTitle1: '一鍵新增節點',
        ...
        node: {
            ...
            healthCheck: '健康檢查',
            healthCheckFrequency: '自動檢查頻率',
            healthCheckFrequencyHelper: '依設定的頻率自動檢查節點健康狀態。輸入 0 可停用自動檢查。',
            healthCheckFrequencyLimit: '檢查頻率不能超過一天，且必須為非負整數。',
            autoCheckFailedNodes: '自動檢查失敗節點',
            autoCheckFailedNodesHelper: '自動檢查時，同時檢查狀態為失敗或異常的節點。僅在檢查頻率不為 0 時生效。',
            loadFailedNodeResources: '重新整理失敗節點資源',
            loadFailedNodeResourcesHelper: '重新整理節點列表時，同時查詢狀態為失敗或異常的節點資源資訊。',
            ...
            dashboardSetting: '概覽設定',
            keepOneDashboardComponent: '至少保留一個概覽區塊',
        },
        customApp: {
            name: '自訂應用倉庫',
        ...
        alert: {
            ...
            alertTriggerMode: '通知條件',
            alertTriggerFailed: '僅失敗',
            alertTriggerSuccess: '僅成功',
            alertTriggerBoth: '成功或失敗',
            alertNotificationHelper:
                '任務最終執行完成後按結果通知，重試過程中不發送；成功與失敗共用每日次數及發送時段。',
            notificationTitle: '計劃任務-{0}「{1}」執行告警',
            notificationSuccessTitle: '計劃任務-{0}「{1}」執行成功通知',
            notificationRule: '{0}：{1}，每天最多發送 {2} 次',
            ...
            goBuy: '去購買',
            phone: '手機號碼',
            phoneHelper: '請填寫真實的手機號碼，以免不能正常接收告警資訊',
            ...
            customPreset: '自訂',
            webhookUrlSecretHelper: 'Webhook 位址會加密儲存，可在此檢視與編輯',
            webhookPublicAddressHelper: '僅支援可由公網存取的 HTTP/HTTPS 位址；本機、內網和保留位址會被攔截',
            customWebhookRecoveryRequired:
                '目前設定已失效或來自舊版本，請重新填寫 Webhook 位址及所需的敏感 Header 後儲存',
            clearSecret: '清除',
            keepSecret: '保持不變',
            ...
            templateVariablesHelper:
                'title=告警標題，message=告警內容，type=告警類型，nodeName=節點名稱，timestamp=發生時間；點選變數可插入 Body。',
            testResultStale: '設定已變更，先前的測試結果已失效',
            alertConfigChanged: '設定已更新，請重新整理後再試',
            presetOverwriteHelper: '切換預設將覆寫目前的 Body 設定，是否繼續？',
            customWebhookValidation: {
                displayNameRequired: '請輸入顯示名稱',
                urlRequired: '請輸入 Webhook 位址',
                urlInvalid: 'Webhook 位址必須是有效的 HTTP 或 HTTPS 位址',
        ...
        vm: {
            ...
            snapshotOperationHelper: '目前快照無法刪除；僅能在虛擬機關機時還原快照。',
