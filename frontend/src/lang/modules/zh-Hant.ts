...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            dhcpEnd: 'DHCP 結束位址',
            bootOrder: '啟動項',
            bootOrderHelper: 'HD 表示優先從磁碟啟動，磁碟不可啟動時再嘗試鏡像；CD-ROM 表示優先從鏡像啟動。',
            ...
            isoSource: '鏡像來源',
            downloadFromServer: '從伺服器下載',
            isoTargetDir: '鏡像目標路徑',
            isoTargetDirHelper: '本機上傳或從伺服器下載的鏡像會儲存到該目錄。',
            isoTargetDirOptional: '未填寫鏡像目標路徑，將直接使用鏡像來源檔案路徑。',
            isoTargetDirAvailable: '鏡像目標路徑可用。',
            isoTargetDirUnavailable: '鏡像目標路徑必須位於可用的虛擬機儲存池內。',
            isoTargetDirCheckRequired: '請先檢查鏡像目標路徑，檢查通過後再儲存。',
            checkPath: '檢查',
            isoSize: '鏡像大小',
