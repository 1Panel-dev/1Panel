...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            isoTargetDirHelper:
                'Jika diisi, ISO akan disimpan ke direktori ini. Boleh dibiarkan kosong untuk ISO yang dipilih daripada pelayan.',
            isoTargetDirOptional: 'Tiada laluan sasaran ISO ditetapkan. Laluan fail sumber ISO asal akan digunakan.',
            isoTargetDirAvailable: 'Laluan sasaran ISO tersedia.',
            isoTargetDirUnavailable: 'Laluan sasaran ISO mesti berada dalam storan pool VM yang tersedia.',
            isoTargetDirCheckRequired: 'Semak laluan sasaran ISO sebelum menyimpan.',
            checkPath: 'Semak',
            isoSize: 'Saiz ISO',
