...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            isoTargetDirCheckRequired: 'Semak laluan simpan ISO sebelum menyimpan.',
            checkPath: 'Semak',
            isoSize: 'Saiz ISO',
            deleteIsoConfirm: 'Operasi pemadaman ini tidak boleh dibuat asal. Teruskan?',
            deleteSourceFile: 'Padam fail sumber',
            deleteSourceFileHelper: 'Jika ditanda, fail sumber yang dirujuk oleh rekod ISO ini juga akan dipadam dan tidak boleh dipulihkan.',
