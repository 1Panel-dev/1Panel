...
const message = {
    ...
    commons: {
        ...
        rule: {
            ...
            vmName: 'Menyokong huruf Inggeris, nombor, ".", "-" dan "_"; panjang: 1-64; mesti bermula dengan huruf atau nombor.',
            vmNetwork:
                'Menyokong huruf Inggeris, nombor, ".", ":", "-" dan "_"; panjang: 1-64; mesti bermula dengan huruf atau nombor.',
        },
        res: {
    ...
    menu: {
        ...
        processManage: 'Pengurusan Proses',
        process: 'Proses',
        network: 'Rangkaian',
    ...
    home: {
        ...
        loadAverage: 'Purata beban dalam {0} minit terakhir',
        load: 'Beban',
    ...
    database: {
        ...
        deleteUserHelper: '" untuk memadam pengguna ini',
    ...
    aiTools: {
        agents: {
            ...
            modelMetadata: 'Keupayaan model',
            modelMetadataHelper:
                'Tetapan ini hanya digunakan pada tika OpenClaw semasa. Biarkan kosong untuk menggunakan nilai lalai OpenClaw atau penyedia.',
            inputModeAuto: 'Kesan secara automatik',
            inputModeText: 'Teks sahaja',
            inputModeImage: 'Teks dan imej',
            contextWindow: 'Tetingkap konteks',
            useModelDefault: 'Gunakan lalai model',
        ...
        aiProxy: {
            ...
            keepCurrentValidity: 'Kekalkan tempoh sah semasa',
            neverExpires: 'Tidak luput',
            validForDays: 'Sah selama {0} hari',
            customDays: 'Hari tersuai',
            enterValidityDays: 'Masukkan tempoh sah dalam hari',
            currentExpiresAt: 'Tarikh luput semasa: {0}',
            currentNeverExpires: 'Pada masa ini tidak luput',
            ...
            autoRefreshSeconds: 'Muat semula automatik setiap {0} saat',
            zeroMeansUnlimited: 'Tetapkan kepada 0 untuk tanpa had.',
            groupMaxConcurrencyDesc: 'Hadkan permintaan aktif semua API Key dalam kumpulan. 0 bermaksud tanpa had.',
            apiKeyMaxConcurrencyDesc: 'Hadkan permintaan aktif setiap API Key dalam kumpulan. 0 bermaksud tanpa had.',
            schedulingReason: 'Sebab penjadualan',
            schedulingAffinity: 'Afiniti',
            schedulingLeastUtilized: 'Penggunaan terendah',
            schedulingPriorityFallback: 'Sandaran keutamaan',
            schedulingRetry: 'Cuba semula',
            ...
            upstreamDuration: 'Masa upstream',
            ...
            actionBlock: 'Sekat',
            actionAuditOnly: 'Audit sahaja',
            actionDropHistory: 'Buang sejarah',
            severity: 'Tahap',
            severityHigh: 'Tinggi',
            severityMedium: 'Sederhana',
            severityLow: 'Rendah',
            sensitiveWord: 'Perkataan sensitif',
            sensitiveGroup: 'Kumpulan perkataan sensitif',
            sensitiveWordCount: 'Perkataan',
            normalizedWord: 'Perkataan dinormalkan',
            matchedWords: 'Perkataan sepadan',
            matchedGroups: 'Kumpulan sepadan',
        ...
        mcp: {
            ...
            protocolVersion: 'Versi Protokol',
    ...
    container: {
        ...
        cleanLogscope: 'Jenis pembersihan',
        downLogHelper1: 'Ini akan memuat turun semua log dari kontena {0}. Adakah anda mahu meneruskan?',
        downLogHelper2: 'Ini akan memuat turun {1} log terkini daripada kontena {0}. Adakah anda mahu meneruskan?',
        ...
        mirrorsHelper:
            'Gunakan URL cermin registri terlebih dahulu untuk operasi imej. Biarkan kosong untuk melumpuhkan cermin registri.',
    ...
    file: {
        ...
        shareExpire: 'Tempoh sah',
        shareExpire1h: '1 jam',
        shareExpire6h: '6 jam',
        shareExpire24h: '24 jam',
        shareExpire3d: '3 hari',
        shareExpire7d: '7 hari',
        sharePassword: 'Kata laluan',
        sharePasswordPlaceholder: 'Biarkan kosong jika tanpa kata laluan',
        shareMaxDownloads: 'Muat turun maksimum',
        shareMaxDownloadsHint: '0 bermakna tanpa had',
        shareGenerate: 'Cipta pautan',
        shareRegenerate: 'Kongsi semula',
        shareClose: 'Tutup',
        ...
        shareLinkLabel: 'Pautan perkongsian',
        shareQrCode: 'Kod QR',
        shareQrDialogTitle: 'Kod QR pautan perkongsian',
        shareQrDialogHelper: 'Imbas kod QR ini dengan peranti mudah alih anda',
        shareSaveImage: 'Simpan imej',
        shareOpenImage: 'Buka imej',
        shareExtractFile: 'Dapatkan fail',
        shareDownloadingHint: 'Fail sedang disediakan. Muat turun akan bermula sebentar lagi.',
        shareInvalid: 'Pautan perkongsian tidak sah atau telah tamat tempoh',
        shareDownloadFailed: 'Muat turun gagal. Cuba lagi kemudian',
        sharePasswordRequired: 'Kata laluan akses',
        sharePasswordRequiredInput: 'Masukkan kata laluan perkongsian',
        sharePasswordLengthHint: 'Panjang kata laluan perkongsian mestilah 4-256 aksara',
        shareDownloadPasswordTip: 'Pautan ini dilindungi kata laluan. Masukkan kata laluan sebelum memuat turun.',
        shareRiskAlert:
            'Pautan perkongsian mungkin membawa risiko keselamatan. Kongsi hanya dengan orang yang dipercayai dan elakkan pendedahan maklumat sensitif.',
        sharePasswordSeparate:
            'Kata laluan telah ditetapkan. Kongsikannya dengan selamat. Penerima mesti menambah &password=... pada URL atau menggunakan klien yang boleh menghantar parameter pertanyaan kata laluan.',
        shareExpiresAt: 'Tamat tempoh pada',
        paste: 'Tampal',
    ...
    ssh: {
        ...
        sshAlert:
            'Data senarai disusun berdasarkan tarikh log masuk. Menukar zon waktu atau melakukan operasi lain boleh menyebabkan penyimpangan dalam tarikh log masuk.',
        sshAlert2:
    ...
    setting: {
        ...
        code: 'Kod Auth',
        codeHelper:
            'Klik butang "Peroleh", kemudian log masuk ke {0} dan salin kandungan selepas "code" dalam pautan ubah hala. Tampalkannya ke dalam kotak input ini. Untuk arahan khusus, rujuk dokumentasi rasmi.',
        googleHelper:
    ...
    nginx: {
        ...
        defaultHttps: 'Anti-usikan HTTPS',
        defaultHttpsHelper1: 'Mengaktifkan pilihan ini boleh menyelesaikan masalah usikan HTTPS.',
    ...
    firewall: {
        ...
        clearDockerGuardPoliciesConfirm: 'Titik akhir yang dipilih akan kembali kepada akses lalai Docker. Teruskan?',
        ...
        dockerGuardStatusReason: {
            ...
            docker_chain_missing:
                'Rangkaian bekas Docker untuk {0} tidak didayakan, jadi perlindungan berkaitan tidak diperlukan. Jika perlu, dayakan {0} dalam Docker dahulu',
            guard_chain_missing: 'Perlindungan port {0} belum dimulakan sepenuhnya. Mulakan sekali lagi',
            jump_missing: 'Perlindungan port {0} tidak terikat dan tidak aktif. Ikat sekali lagi',
            jump_not_first:
                'Perlindungan port {0} tidak dikonfigurasi dengan betul dan mungkin tidak berfungsi sepenuhnya. Nyahikat dan ikat semula',
            jump_duplicate: 'Perlindungan port {0} mempunyai konfigurasi pendua. Nyahikat dan ikat semula',
            inspect_failed:
                'Tidak dapat mendapatkan status perlindungan port {0}. Segar semula atau semak firewall sistem',
        },
        dockerGuardUnprotected: 'Tidak dilindungi',
    ...
    runtime: {
        ...
        edit: 'Sunting persekitaran masa jalan',
        extendHelper:
    ...
    process: {
        ...
        numThreads: 'Thread',
        memory: 'Memori',
        diskRead: 'Bacaan cakera',
        diskWrite: 'Tulisan cakera',
        netSent: 'Muat naik',
        netRecv: 'Muat turun',
        numConnections: 'Sambungan',
        startTime: 'Masa mula',
        running: 'Berjalan',
        sleep: 'Tidur',
        stop: 'Berhenti',
        ...
        lock: 'Dikunci',
        blocked: 'Disekat',
        cmdLine: 'Perintah mula',
        basic: 'Asas',
        mem: 'Memori',
        openFiles: 'Fail terbuka',
        env: 'Pemboleh ubah persekitaran',
        noenv: 'Tiada',
        net: 'Sambungan rangkaian',
        laddr: 'Alamat/port sumber',
        raddr: 'Alamat/port destinasi',
        stopProcess: 'Tamatkan',
        viewDetails: 'Butiran',
        stopProcessWarn: 'Adakah anda pasti mahu menamatkan proses ini (PID:{0})?',
    ...
    tool: {
        supervisor: {
            ...
            manage: 'Pengurusan',
            autoRestart: 'Mulakan Semula Automatik',
            EXITED: 'Telah keluar',
            autoRestartHelper:
    ...
    disk: {
        ...
        partition: 'Sekatan',
        unmount: 'Nyahlekap',
        unmountHelper: 'Nyahlekap partition {0}?',
        mount: 'Lekap',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                serviceEnabledButAbnormal: 'Didayakan tetapi berada dalam keadaan tidak normal',
                ...
                disabledCronjobTasks: 'Tugas berjadual yang dilumpuhkan',
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    accessMode: 'Mod sambungan',
                    accessModeDesc: 'Gunakan Discovery standard setiap kali pembekal identiti menyokongnya.',
                    actionCreate: 'Buat pengguna',
                    actionKeepName: 'Kekalkan nama pengguna semasa',
                    actionPending: 'Menunggu keputusan',
                    actionReject: 'Tolak log masuk',
                    actionUpdate: 'Kemas kini maklumat identiti',
                    advanced: 'Tetapan lanjutan',
                    advancedDesc: 'Kekalkan lalai selamat melainkan pembekal memerlukan pilihan keserasian.',
                    assignDefaultRole: 'Berikan peranan lalai: {role}',
                    authorizationEndpoint: 'Authorization Endpoint',
                    authorizationEndpointInvalid: 'Masukkan Authorization Endpoint yang sah.',
                    authorizationFlow: 'Aliran kebenaran',
                    automatic: 'Automatik',
                    automaticPolicy: 'Dasar pengendalian automatik',
                    automaticPolicyDesc: 'Peraturan ini dikuatkuasakan oleh backend, bukan melalui suis pentadbir.',
                    basic: 'Tetapan asas',
                    basicDesc: 'Pilih mod pembekal, kemudian konfigurasikan klien dan panggil balik.',
                    browserTest: 'Ujian log masuk pelayar',
                    browserTestConflict: 'Identiti disahkan, tetapi nama pengguna bercanggah',
                    browserTestConflictHelper:
                        'Nama pengguna yang dipetakan adalah milik identiti lain dan tidak akan dituntut.',
                    browserTestExpired: 'Ujian penyemak imbas tamat tempoh',
                    browserTestExpiredHelper:
                        'Mulakan ujian penyemak imbas baharu dan lengkapkan kebenaran sebelum tamat tempoh.',
                    browserTestFailed: 'Ujian penyemak imbas gagal',
                    browserTestFailedHelper:
                        'Pratonton identiti tidak dapat diselesaikan. Semak ralat backend yang telah diterjemahkan.',
                    browserTestIsolation:
                        'Ini melakukan perjalanan pergi balik kebenaran sebenar tetapi tidak mencipta atau mengemas kini pengguna, menetapkan peranan atau mencipta sesi panel yang telah disahkan.',
                    browserTestPopupBlocked:
                        'Benarkan pop timbul untuk tapak ini, kemudian mulakan ujian penyemak imbas semula.',
                    browserTestPopupClosed: 'Tetingkap kebenaran ditutup sebelum ujian selesai.',
                    browserTestSuccess: 'Pengesahan Provider berjaya',
                    browserTestSuccessHelper: 'Pemetaan identiti telah dipratonton tanpa menukar pengguna atau sesi.',
                    browserTestTitle: 'Log masuk ujian pelayar OIDC',
                    browserTestWaiting: 'Menunggu kebenaran Provider',
                    ...
                    configurationHighRiskPassed:
                        'Konfigurasi diluluskan, tetapi mengandungi pilihan keserasian berisiko tinggi.',
                    configurationHighRiskTag: 'Konfigurasi berisiko tinggi diluluskan',
                    configurationNotTested: 'Konfigurasi semasa belum diuji.',
                    ...
                    configurationTestResult: 'Keputusan ujian konfigurasi',
                    configurationTestResultDesc:
                        'Ini menyemak Discovery dan keupayaan sahaja; ia tidak menukar kod kebenaran atau membuktikan Client Secret. Gunakan log masuk ujian penyemak imbas untuk pengesahan hujung ke hujung.',
                    configurationTestSuccess: 'Ujian konfigurasi OIDC berjaya.',
                    configurationTesting: 'Menguji konfigurasi OIDC semasa…',
                    configurationTestingTag: 'Menguji',
                    configureSecret: 'Konfigurasikan rahsia',
                    conflictExistingRename: 'subject terikat mengembalikan name baharu yang telah diduduki',
                    conflictExistingRenameResult:
                        'Simpan User.Name sedia ada dan benarkan pengguna terikat untuk log masuk',
                    conflictLDAP: 'Pengguna LDAP',
                    conflictLocal: 'Pengguna tempatan',
                    conflictNewAvailable: 'subject baharu dan name yang dipetakan tersedia',
                    conflictNewAvailableResult: 'Buat pengguna perusahaan dan tetapkan peranan lalai',
                    conflictNone: 'Tiada konflik',
                    conflictOIDC: 'Satu lagi identiti OIDC',
                    conflictOccupied: 'name yang dipetakan adalah milik tempatan, LDAP atau identiti OIDC yang lain',
                    conflictOccupiedResult:
                        'Tolak identiti baharu; jangan sekali-kali mengikat atau bergabung secara automatik',
                    ...
                    customCA: 'CA tersuai',
                    customCAHelper: 'Terpakai hanya pada sumber pengesahan ini dan tidak pernah ditulis pada log.',
                    ...
                    disableConfirm:
                        'Melumpuhkan OIDC serta-merta membatalkan akses untuk pengguna sumber ini. teruskan?',
                    disableDiscardConfirm:
                        'Melumpuhkan OIDC ialah tindakan kecemasan: ia hanya menutup entri log masuk dan serta-merta membatalkan akses untuk pengguna sumber ini. Perubahan lain yang belum disimpan pada halaman ini, termasuk perubahan Client Secret, akan dibuang. teruskan?',
                    disableTitle: 'Lumpuhkan OIDC',
                    disabled: 'Dilumpuhkan',
                    discoveryAllowlist: 'Discovery ∩ senarai kebenaran keselamatan',
                    enable: 'Dayakan',
                    enableAfterSave: 'OIDC akan didayakan selepas simpanan berjaya.',
                    enabled: 'Didayakan',
                    ...
                    fixedNoTokenPersistence: 'Tokens, Claims dan verifier tidak pernah berterusan',
                    fixedSecurityPolicy: 'Sentiasa dikuatkuasakan; tiada konfigurasi diperlukan',
                    fixedStateNonce: 'state dan nonce sekali',
                    fixedTokenValidation: 'Tandatangan ID Token dan pengesahan Claims',
                    highRiskSaveConfirm:
                        'Konfigurasi yang didayakan ini mengandungi pilihan keserasian berisiko tinggi. Sahkan bahawa persekitaran terpencil memerlukannya.',
                    highRiskTitle: 'Konfigurasi OIDC berisiko tinggi',
                    hs256Compatibility: 'HS256 (keserasian)',
                    hs256KeyHelper:
                        'HS256 sentiasa menggunakan Client Secret sumber ini dan tidak menerima kunci tandatangan yang berasingan.',
                    hs256Warning:
                        'HS256 menggunakan rahsia simetri yang dikongsi untuk tandatangan ID Token. Gunakannya hanya apabila Provider tidak boleh menggunakan algoritma asimetri.',
                    identityBindingPolicy:
                        'Identiti ditetapkan kepada AuthSourceID + issuer + subject. Nama pengguna yang sepadan tidak pernah menuntut akaun lain.',
                    identityMissing: 'Identiti tidak aktif',
                    issuer: 'Issuer URL',
                    issuerHelper:
                        'Nilai iss ID Token dan Discovery issuer mesti sepadan dengan nilai ini dengan tepat.',
                    issuerInvalid: 'Masukkan HTTP atau HTTPS Issuer URL yang sah tanpa pertanyaan atau serpihan.',
                    issuerRequired: 'Masukkan Issuer URL.',
                    jwksRotation: 'Putaran JWKS automatik',
                    jwksURI: 'JWKS URI',
                    jwksURIHelper: 'Diperlukan untuk tandatangan asimetri apabila sumber utama ialah JWKS.',
                    jwksURIInvalid: 'Masukkan JWKS URI yang sah untuk sumber kunci tandatangan yang dipilih.',
                    keepExistingRole: 'Kekalkan peranan sedia ada dan kebenaran setempat',
                    localSecurityData: 'Data keselamatan tempatan',
                    localSecurityDataPolicy:
                        'Jangan sekali-kali menulis ganti peranan, MFA, API Keys, Passkeys atau kebenaran setempat.',
                    localCredentialsManaged:
                        'Nama pengguna dan kata laluan tempatan diuruskan oleh OIDC dan tidak boleh diedit di sini. Peranan, kebenaran, MFA, API Keys dan Passkeys kekal setempat.',
                    localUserFields: 'Medan pengguna tempatan',
                    localUserFieldsDesc:
                    ...
                    pkceHelper: 'Lebih suka S256. Kaedah cabaran plain tidak pernah ditawarkan.',
                    pkceS256: 'S256 (disyorkan)',
                    plannedHandling: 'Pengendalian terancang',
                    privateNetworkIdP: 'IdP rangkaian persendirian',
                    privateNetworkIdPHelper:
                        'Membenarkan alamat peribadi secara eksplisit; metadata, gelung balik, pautan setempat, ubah hala dan penjilidan semula DNS kekal disekat.',
                    privateNetworkWarning: 'Akses rangkaian peribadi didayakan untuk sumber pengesahan ini.',
                    protocolCompatibility: 'Keserasian protokol',
                    protocolCompatibilityDesc: 'Pengesahan tandatangan ID Token tidak boleh dilumpuhkan.',
                    providerAndClient: 'Provider dan pelanggan',
                    providerAndClientDesc:
                        'Client Secret hanya boleh diganti atau dibersihkan dan tidak pernah dikembalikan oleh halaman.',
                    providerCapabilities: 'Keupayaan Provider',
                    recentTestSuccess: 'Ujian terakhir berjaya: {0}',
                    recommended: 'Disyorkan',
                    rejectPlain: 'plain ditolak',
                    ...
                    restore: 'Pulihkan',
                    restored: 'Tetapan OIDC yang terakhir disimpan telah dipulihkan.',
                    result: 'Hasilnya',
                    ...
                    seconds: 'detik',
                    secretClearHelper:
                        'Selepas mengosongkan, Client Secret baharu diperlukan sebelum OIDC boleh didayakan semula.',
                    secretConfigured: 'Dikonfigurasikan',
                    secretNotConfigured: 'Tidak dikonfigurasikan',
                    secretPlaceholder: 'Masukkan Client Secret baharu',
                    secretReplaceHelper:
                        'Rahsia baharu akan menggantikan nilai yang disimpan apabila anda menyimpan. Kemas kini juga Client Secret pada Provider OIDC.',
                    ...
                    signingAlgorithm: 'Algoritma tandatangan ID Token',
                    signingAlgorithmHelper: 'Hanya algoritma dalam senarai dibenarkan keselamatan backend tersedia.',
                    signingKey: 'Kunci tandatangan',
                    signingKeyClientSecret: 'Client Secret (HS256 sahaja)',
                    signingKeyJWKS: 'JWKS URI dengan putaran automatik',
                    signingKeySource: 'Sumber kunci tandatangan',
                    signingKeySourceHelper: 'Lebih suka JWKS. Kunci awam statik tidak boleh berputar secara automatik.',
                    ...
                    standardProtocolPolicyDesc:
                        'Keupayaan menandatangani dirundingkan secara automatik; tiada kunci tandatangan dimasukkan di sini.',
                    staticSigningKey: 'Kunci awam tandatangan statik',
                    staticSigningKeyHelper:
                        'Hanya bahan kunci awam diterima. Putar secara manual apabila kunci Provider berubah.',
                    staticSigningKeyPlaceholder: 'Tampal kunci awam JWK, JWKS JSON atau PEM',
                    staticSigningKeyRequired: 'Sediakan kunci awam tandatangan statik.',
                    staticSigningKeyWarning:
                        'Kunci tandatangan statik tidak boleh berputar secara automatik; kemas kini sebelum Provider memutar kunci.',
                    settingLoadFailed: 'Tetapan OIDC tidak dapat dimuatkan',
                    settingLoadFailedHelper:
                        'Borang dikunci untuk mengelakkan menyimpan konfigurasi lalai kosong pada tetapan semasa. Cuba semula selepas sambungan pulih.',
                    subsequentLogin: 'Log masuk seterusnya',
                    ...
                    tlsPrivateHTTP: 'HTTP · Rangkaian peribadi sahaja (berbahaya)',
                    ...
                    transportSecurity: 'Keselamatan pengangkutan',
                ...
                saml2: {
                    ...
                    actionPending: 'Menunggu keputusan',
                    actionReject: 'Tolak log masuk',
                    actionReuse: 'Gunakan pengguna terikat',
                    assignDefaultRole: 'Berikan peranan lalai: {role}',
                    basic: 'Tetapan asas',
                    basicDesc: 'Konfigurasikan pilihan umum yang diperlukan oleh kebanyakan penyedia SAML2 standard.',
                    browserTest: 'Uji log masuk',
                    browserTestConflict: 'Identiti disahkan, tetapi nama pengguna bercanggah',
                    browserTestConflictHelper:
                        'Nama pengguna yang dipetakan adalah milik identiti lain dan tidak akan dituntut.',
                    browserTestExpired: 'Ujian penyemak imbas tamat tempoh',
                    ...
                    browserTestSuccess: 'Pengesahan Provider berjaya',
                    browserTestSuccessHelper: 'Pemetaan identiti telah dipratonton tanpa menukar pengguna atau sesi.',
                    browserTestTitle: 'Log masuk ujian pelayar SAML2',
                    browserTestWaiting: 'Menunggu kebenaran Provider',
                    browserTestWaitingHelper:
                        'Lengkapkan log masuk dalam tetingkap penyemak imbas baharu. Halaman ini akan dikemas kini secara automatik.',
                    certificateFileInvalid: 'Pilih fail sijil PEM, CRT atau CER yang sah.',
                    configured: 'Dikonfigurasi',
                    configurationFailedHelper:
                        'Ujian itu gagal. Halaman hanya memaparkan ralat backend yang telah diterjemahkan.',
                    configurationNotTested: 'Konfigurasi semasa belum diuji.',
                    ...
                    configurationTestSuccess: 'Ujian konfigurasi SAML2 berjaya.',
                    configurationTesting: 'Menguji konfigurasi SAML2 semasa…',
                    conflictLDAP: 'Pengguna LDAP',
                    conflictLocal: 'Pengguna tempatan',
                    conflictNone: 'Tiada konflik',
                    conflictOIDC: 'Satu lagi identiti OIDC',
                    conflictSAML2: 'Identiti SAML2 lain',
                    conflictType: 'Jenis konflik',
                    credentialFileReadFailed: 'Fail kelayakan tidak dapat dibaca.',
                    credentialFileTooLarge: 'Fail kelayakan tidak boleh melebihi 256 KiB.',
                    credentialsRequired: 'Konfigurasikan kunci peribadi dan sijil SP.',
                    defaultRole: 'Peranan pengguna baharu',
                    defaultRoleHelper:
                        'Ditetapkan pada penciptaan pertama sahaja; log masuk seterusnya mengekalkan peranan, MFA dan kebenaran setempat.',
                    defaultRolePlaceholder: 'Pilih peranan',
                    defaultRoleRequired: 'Pilih peranan lalai yang sah.',
                    disableConfirm:
                        'Melumpuhkan SAML2 serta-merta menolak log masuk baharu dan membatalkan sesi penggunanya. Teruskan?',
                    disableDiscardConfirm:
                        'Melumpuhkan SAML2 membuang perubahan lain yang belum disimpan pada halaman ini dan serta-merta membatalkan sesi penggunanya. Teruskan?',
                    disableTitle: 'Lumpuhkan SAML2',
                    disabled: 'Dilumpuhkan',
                    enable: 'Dayakan',
                    enabled: 'Didayakan',
                    idpMetadata: 'Metadata IdP',
                    idpMetadataDesc: 'Masukkan URL atau tampal XML. Jika kedua-duanya ada, URL diutamakan.',
                    keepExistingRole: 'Kekalkan peranan sedia ada dan kebenaran setempat',
                    loginWith: 'Log masuk dengan {provider}',
                    mappingResult: 'Hasil pemetaan',
                    metadataRequired: 'Masukkan URL atau XML Metadata IdP.',
                    metadataURLHelper:
                        'Bahagian belakang memuat turun dan mengesahkan metadata semasa ujian dan simpanan.',
                    metadataURLInvalid: 'Masukkan URL metadata HTTPS yang sah tanpa kelayakan atau fragmen.',
                    metadataURLRecommended: 'URL metadata (disyorkan)',
                    metadataXML: 'XML metadata',
                    metadataXMLHelper: 'Gunakan apabila IdP tidak menyediakan URL metadata yang boleh dicapai.',
                    metadataXMLInvalid: 'Masukkan XML metadata EntityDescriptor yang sah.',
                    ...
                    notConfigured: 'Belum dikonfigurasi',
                    or: 'atau',
                    pageDesc: 'Sambungkan SSO perusahaan melalui Metadata IdP dengan tetapan umum pada satu halaman.',
                    plannedHandling: 'Pengendalian terancang',
                    privateKeyFileInvalid: 'Pilih fail kunci peribadi PEM yang sah.',
                    recentTestSuccess: 'Ujian terakhir berjaya: {0}',
                    restore: 'Pulihkan',
                    restored: 'Tetapan SAML2 yang terakhir disimpan telah dipulihkan.',
                    roleHandling: 'Pengendalian peranan',
                    rolesLoadFailed: 'Peranan tidak dapat dimuatkan. Cuba semula sebelum memilih peranan lalai.',
                    selectFile: 'Pilih fail',
                    serviceStatus: 'Status perkhidmatan',
                    serviceStatusDesc: 'Konfigurasi semasa mesti lulus ujian sebelum SAML2 boleh didayakan.',
                    settingLoadFailed: 'Tetapan SAML2 tidak dapat dimuatkan',
                    settingLoadFailedHelper:
                        'Borang dikunci untuk mengelakkan menyimpan konfigurasi lalai kosong pada tetapan semasa. Cuba semula selepas sambungan pulih.',
                    spCertificate: 'Sijil SP',
                    spCertificateHelper:
                        'Diterbitkan dalam metadata SP supaya IdP boleh mengesahkan permintaan log masuk dan log keluar.',
        ...
        node: {
            ...
            dashboardSetting: 'Tetapan Gambaran Keseluruhan',
            keepOneDashboardComponent: 'Kekalkan sekurang-kurangnya satu bahagian gambaran keseluruhan',
        },
        customApp: {
        ...
        alert: {
            ...
            alertTriggerMode: 'Syarat pemberitahuan',
            alertTriggerFailed: 'Gagal sahaja',
            alertTriggerSuccess: 'Berjaya sahaja',
            alertTriggerBoth: 'Berjaya atau gagal',
            alertNotificationHelper:
                'Maklumkan selepas keputusan akhir pelaksanaan, bukan semasa percubaan semula. Pemberitahuan berjaya dan gagal berkongsi had harian dan waktu penghantaran.',
            notificationTitle: 'Tugas berjadual - {0} 「{1}」 pemberitahuan pelaksanaan',
            notificationSuccessTitle: 'Tugas berjadual - {0} 「{1}」 berjaya diselesaikan',
            notificationRule: '{0}: {1}, sehingga {2} pemberitahuan sehari',
        ...
        vm: {
            ...
            disk: 'Cakera',
            overview: 'Gambaran keseluruhan',
            kvmUnavailable: 'Tiada keupayaan virtualisasi perkakasan KVM tersedia dikesan.',
            kvmCheckCpu: 'Pastikan CPU hos menyokong virtualisasi Intel VT-x atau AMD-V.',
            kvmCheckBios: 'Dayakan pilihan virtualisasi dalam BIOS/UEFI.',
            kvmCheckModule: 'Pastikan modul kernel kvm, kvm_intel atau kvm_amd dimuatkan dengan betul.',
            kvmCheckDevice:
                'Pastikan /dev/kvm wujud dan persekitaran semasa bukan kontena atau hos awan tanpa sokongan KVM.',
            abnormal: 'Tidak normal',
            resourceOverview: 'Gambaran keseluruhan sumber',
            cpuAllocated: 'CPU diperuntukkan',
            memoryAllocated: 'Memori diperuntukkan',
            storageUsed: 'Storan digunakan',
            riskReminder: 'Peringatan risiko',
            noRisk: 'Tiada risiko',
            runtimeHealth: 'Kesihatan masa jalan',
            runtimeAbnormal: 'Masa jalan VM tidak normal',
            noDependency: 'Tiada data semakan kebergantungan',
            storageOverview: 'Gambaran keseluruhan storan',
            totalAllocated: 'Dikira daripada jumlah konfigurasi VM',
            runningAllocated: 'Peruntukan sedang berjalan: {0}',
            storageAvailable: 'Tersedia: {0}',
            inProgress: 'Sedang berjalan',
            needAttention: 'Perlu perhatian',
            normal: 'Normal',
            environmentRisk: 'Masa jalan VM belum tersedia. Betulkan kebergantungan atau perkhidmatan virtualisasi.',
            storageRisk: 'Penggunaan kolam storan {0} telah mencapai {1}%.',
            abnormalRisk: '{0} VM berada dalam keadaan tidak normal.',
            pausedRisk: '{0} VM dijeda.',
            memoryRisk: 'Peruntukan memori VM telah mencapai {0}%.',
            ...
            convertToTemplate: 'Tukar kepada templat',
            sourceVM: 'VM sumber',
            templateSize: 'Saiz templat',
            ...
            monitorLoadFailedWithReason: 'Gagal mendapatkan data pemantauan VM: {0}',
            rename: 'Namakan semula',
            newName: 'Nama baru',
            renameHelper: 'Masukkan nama VM baharu. VM mesti dimatikan sebelum dinamakan semula.',
            renameConfirm: 'Namakan semula mesin maya [{0}] kepada [{1}]?',
            renameRunningHelper: 'Matikan mesin maya sebelum menamakannya semula.',
            cpuUsage: 'Penggunaan CPU',
            memoryUsage: 'Penggunaan memori',
            diskIO: 'I/O cakera',
            networkIO: 'I/O rangkaian',
            diskReadWrite: 'Baca / Tulis cakera',
            networkRxTx: 'RX / TX rangkaian',
            rx: 'RX',
            tx: 'TX',
            console: 'Konsol',
            ...
            snapshot: 'Syot kilat',
            createSnapshot: 'Cipta syot kilat',
            recoverSnapshot: 'Pulihkan syot kilat',
            snapshotSize: 'Penggunaan',
            currentSnapshot: 'Semasa',
            snapshotEmpty: 'Tiada syot kilat',
            snapshotHelper:
                'Syot kilat menyimpan keadaan semasa VM sebagai titik pemulihan. Perubahan data seterusnya direkodkan dalam fail delta tanpa mengubah cakera asal. Memulihkan syot kilat mengembalikan VM ke keadaan tersebut.',
            snapshotOperationHelper:
                'Syot kilat semasa tidak boleh dipadam. Syot kilat hanya boleh dipulihkan apabila mesin maya dimatikan.',
            snapshotRecoverConfirm:
                'Pulihkan mesin maya [{1}] kepada syot kilat [{0}]? Cakera VM akan dipulihkan kepada keadaan syot kilat.',
