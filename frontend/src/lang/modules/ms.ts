...
const message = {
    ...
    file: {
        ...
        aiSearchContainSub: 'Termasuk subdirektori',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scorePasswordExpired: 'Kata laluan panel telah tamat tempoh',
                scorePasswordExpiring: 'Kata laluan panel tamat tempoh dalam {0} hari',
                ...
                assetResourceDesc: '{0} aplikasi tidak normal, {1} aplikasi berhenti, {2} bekas tidak normal',
