...
const message = {
    ...
    toolbox: {
        ...
        clam: {
            ...
            cronHelper: 'Edisi Business menyokong imbasan berjadual',
            ...
            alertHelper: 'Edisi Business menyokong imbasan berjadual dan amaran SMS',
    ...
    license: {
        ...
        lostHelper:
            'Lesen telah mencapai had percubaan semula. Jalankan penyegerakan secara manual untuk memastikan ciri Business terus berfungsi dengan baik. butiran: ',
        disableHelper:
        ...
        advice: 'Konsultasi',
        levelUpPro: 'Naik taraf ke Edisi Business',
        licenseSync: 'Penyegerakan Lesen',
        knowMorePro: 'Ketahui Business',
        closeAlert: 'Halaman semasa boleh ditutup dalam tetapan panel',
        introduce: 'Pengenalan Ciri',
        waf: 'Naik taraf ke Edisi Business untuk menggunakan peta sekatan, log, rekod sekatan, sekatan geografi, peraturan tersuai, halaman sekatan tersuai dan banyak lagi.',
        tamper: 'Naik taraf ke Edisi Business untuk melindungi laman web daripada perubahan atau gangguan tanpa kebenaran.',
        setting: 'Naik taraf ke Edisi Business untuk menyesuaikan logo panel, mesej alu-aluan dan maklumat lain.',
        monitor:
            'Naik taraf ke Edisi Business untuk melihat status laman web masa nyata, trend pelawat, sumber trafik, log permintaan dan lain-lain.',
        alert: 'Naik taraf ke Edisi Business untuk menerima amaran SMS dan melihat log amaran.',
        node: 'Naik taraf ke Edisi Business untuk mengurus berbilang pelayan Linux dengan 1Panel.',
        nodeApp:
            'Naik taraf ke Edisi Business untuk menaik taraf versi aplikasi berbilang nod tanpa menukar nod secara manual.',
        nodeDashboard:
            'Naik taraf ke Edisi Business untuk mengurus aplikasi, laman web, pangkalan data dan tugas berjadual berbilang nod secara berpusat.',
        fileExchange: 'Naik taraf ke Edisi Business untuk memindahkan fail dengan pantas antara pelayan.',
        app: 'Naik taraf ke Edisi Business untuk melihat maklumat perkhidmatan dan pemantauan anomali dalam aplikasi mudah alih.',
        cluster: 'Naik taraf ke Edisi Business untuk mengurus kelompok utama-replika MySQL/Postgres/Redis.',
        'model-downloader':
            'Naik taraf kepada edisi Business untuk mencari, memuat turun dan mengurus fail model tempatan daripada HuggingFace, ModelScope atau cermin serasi, dengan direktori model dan tugasan muat turun berpusat.',
        exceptionalHelper:
            'Pengesahan penyegerakan lesen tidak normal. Klik butang sync secara manual untuk pastikan fungsi Business berjalan baik. butiran: ',
    ...
    xpack: {
        expiresTrialAlert:
            'Peringatan mesra: Percubaan Business anda akan tamat dalam {0} hari, dan semua ciri Business tidak lagi dapat diakses. Sila perbaharui atau naik taraf ke versi penuh tepat pada masanya.',
        expiresAlert:
            'Peringatan mesra: Lesen Business anda akan tamat dalam {0} hari, dan semua ciri Business tidak lagi dapat diakses. Sila perbaharui segera untuk memastikan penggunaan berterusan.',
        menu: 'Business',
        upage: 'Pembina Laman Web AI',
        proAlert: 'Tingkatkan ke Business untuk menggunakan ciri ini',
        app: {
            app: 'APP',
            title: 'Nama Panel',
        ...
        node: {
            ...
            syncWithMaster:
                'Selepas menaik taraf ke Business, semua data akan diselaraskan secara lalai. Dasar penyelarasan boleh disesuaikan secara manual dalam pengurusan nod.',
        ...
        customApp: {
            ...
            licenseHelper: 'Versi Business menyokong fungsi gudang aplikasi tersuai',
        ...
        alert: {
            ...
            licenseHelper: 'Edisi Business menyokong lebih banyak saluran amaran',
            ...
            alertConfigProHelper: 'Edisi Business turut menyokong amaran WeCom, DingTalk, Feishu dan SMS.',
        },
        theme: {
