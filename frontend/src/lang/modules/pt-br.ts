...
const message = {
    ...
    file: {
        ...
        aiSearchContainSub: 'Incluir subdiretórios',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scorePasswordExpiring: 'Senha do painel expira em {0} dias',
                ...
                assetResourceDesc: '{0} aplicações anormais, {1} aplicações paradas, {2} contêineres anormais',
                ...
                passwordExpiration: 'Expiração da senha',
