...
const message = {
    ...
    firewall: {
        ...
        legacy: 'Gerenciada pela versão anterior',
        ...
        resolution_create_anyway: 'Criar mesmo assim',
        resolution_adopt: 'Assumir gerenciamento',
        resolution_select_adopt: 'Selecionar e assumir',
        ...
        scopeDefaultPolicy: 'Política padrão atual: {0}',
        ...
        filterHelper:
            'As regras de filtro permitem controlar o tráfego de rede de entrada no nível INPUT. Configure com cuidado para evitar bloquear o sistema.',
        chain: 'Cadeia',
        targetChain: 'Cadeia de Destino',
        sourceIP: 'IP de Origem',
        destIP: 'IP de Destino',
        accessSource: 'Origem do Acesso',
        accessDestination: 'Destino do Acesso',
        direction: 'Direção',
        ...
        reorderTip: 'Arraste para reordenar as regras gerenciadas deste grupo',
        ufwReorderUnsupported:
            'As regras UFW são exibidas na ordem numerada real de IPv4/IPv6. A reordenação manual não é suportada.',
        reorderBlocked:
            'As regras só podem ser movidas dentro do mesmo grupo e não podem cruzar regras externas, protegidas ou não reconhecidas.',
        destination: 'Destino',
    },
    runtime: {
        runtime: 'Runtime',
