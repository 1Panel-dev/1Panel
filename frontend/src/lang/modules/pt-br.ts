...
const message = {
    ...
    commons: {
        ...
        login: {
            ...
            otherLoginMethods: 'Outras formas de login',
        ...
        rule: {
            ...
            nginxDoc: 'Este campo deve conter letras, números, ".", "_" e "-".',
            appName:
            ...
            vmName: 'Aceita letras, números, ".", "-" e "_"; comprimento: 1-64; deve começar com uma letra ou um número.',
            vmNetwork:
                'Aceita letras, números, ".", ":", "-" e "_"; comprimento: 1-64; deve começar com uma letra ou um número.',
        },
        res: {
    ...
    home: {
        ...
        loadAverage: 'Média de carga nos últimos {0} minutos',
        load: 'Carga',
    ...
    database: {
        ...
        deleteUserHelper: '" para excluir este usuário',
    ...
    aiTools: {
        agents: {
            ...
            modelMetadata: 'Recursos do modelo',
            modelMetadataHelper:
                'Estas configurações se aplicam somente a esta instância do OpenClaw. Deixe em branco para usar os padrões do OpenClaw ou do provedor.',
            inputModeAuto: 'Detectar automaticamente',
            inputModeText: 'Somente texto',
            inputModeImage: 'Texto e imagens',
            contextWindow: 'Janela de contexto',
            useModelDefault: 'Usar padrão do modelo',
        ...
        model: {
            ...
            vllmDeployProfile: 'Modelo de implantação',
        ...
        aiProxy: {
            ...
            keepCurrentValidity: 'Manter validade atual',
            neverExpires: 'Nunca expira',
            validForDays: 'Válido por {0} dias',
            customDays: 'Dias personalizados',
            enterValidityDays: 'Informe o período de validade em dias',
            currentExpiresAt: 'Expiração atual: {0}',
            currentNeverExpires: 'Atualmente não expira',
            ...
            autoRefreshSeconds: 'Atualização automática a cada {0}s',
            zeroMeansUnlimited: 'Defina como 0 para ilimitado.',
            groupMaxConcurrencyDesc:
                'Limita as solicitações ativas de todas as API Keys do grupo. Use 0 para ilimitado.',
            apiKeyMaxConcurrencyDesc: 'Limita as solicitações ativas de cada API Key do grupo. Use 0 para ilimitado.',
            schedulingReason: 'Motivo do agendamento',
            schedulingAffinity: 'Afinidade',
            schedulingLeastUtilized: 'Menor utilização',
            schedulingPriorityFallback: 'Fallback de prioridade',
            schedulingRetry: 'Nova tentativa',
            ...
            upstreamDuration: 'Tempo do upstream',
            ...
            requestExample: 'Exemplo de solicitação',
            ...
            actionAuditOnly: 'Somente auditar',
            actionDropHistory: 'Remover histórico',
            severity: 'Severidade',
            severityHigh: 'Alta',
            severityMedium: 'Média',
            severityLow: 'Baixa',
            sensitiveWord: 'Palavra sensível',
            sensitiveGroup: 'Grupo de palavras sensíveis',
            sensitiveWordCount: 'Palavras',
            normalizedWord: 'Palavra normalizada',
            matchedWords: 'Palavras correspondentes',
            matchedGroups: 'Grupos correspondentes',
        ...
        skillsHub: {
            ...
            publish: 'Publicar',
            disable: 'Despublicar',
            customTarget: 'Diretório de Skills do agente',
            installToTarget: 'Instalar no diretório de Skills do agente',
            ...
            deleteTargetConfirm:
                'Excluir esta configuração do diretório de Skills do agente? Os usuários não poderão mais selecionar este diretório de instalação.',
            noInstallTarget: 'Nenhum diretório de Skills do agente disponível. Adicione um primeiro.',
            postInstallConfirm:
    ...
    container: {
        ...
        cleanLog: 'Limpar log',
        cleanLogscope: 'Tipo de limpeza',
        downLogHelper1: 'Isso fará o download de todos os logs do contêiner {0}. Deseja continuar?',
        downLogHelper2: 'Isso baixará os {1} logs mais recentes do contêiner {0}. Deseja continuar?',
        ...
        mirrorsHelper:
            'Use primeiro as URLs de espelho do registro nas operações de imagem. Deixe vazio para desativar os espelhos do registro.',
    ...
    terminal: {
        ...
        connLocalErr:
            'Não foi possível autenticar automaticamente. Preencha as informações de login do servidor local.',
    ...
    toolbox: {
        ...
        device: {
            ...
            hosts: 'Domínio',
            hostAlert:
                'Os registros comentados estão ocultos. Clique em "Todas as configurações" para visualizá-los ou configurá-los.',
    ...
    logs: {
        ...
        detail: {
            ...
            ops_report: 'Relatório de Operações',
    ...
    file: {
        ...
        shareExpire: 'Expira em',
        shareExpire1h: '1 hora',
        shareExpire6h: '6 horas',
        shareExpire24h: '24 horas',
        shareExpire3d: '3 dias',
        shareExpire7d: '7 dias',
        sharePassword: 'Senha',
        sharePasswordPlaceholder: 'Deixe vazio para não usar senha',
        shareMaxDownloads: 'Máximo de downloads',
        shareMaxDownloadsHint: '0 significa ilimitado',
        shareGenerate: 'Criar link',
        shareRegenerate: 'Compartilhar novamente',
        shareClose: 'Fechar',
        ...
        shareDetail: 'Detalhes',
        shareCopyLink: 'Copiar link',
        shareLinkLabel: 'Link de compartilhamento',
        shareQrCode: 'Código QR',
        shareQrDialogTitle: 'Código QR do link de compartilhamento',
        shareQrDialogHelper: 'Leia este código QR com seu dispositivo móvel',
        shareSaveImage: 'Salvar imagem',
        shareOpenImage: 'Abrir imagem',
        shareExtractFile: 'Obter arquivo',
        shareDownloadingHint: 'Preparando o arquivo. O download começará em breve.',
        shareInvalid: 'Link de compartilhamento inválido ou expirado',
        shareDownloadFailed: 'Falha no download. Tente novamente mais tarde',
        sharePasswordRequired: 'Senha de acesso',
        sharePasswordRequiredInput: 'Digite a senha de compartilhamento',
        sharePasswordLengthHint: 'A senha de compartilhamento deve ter de 4 a 256 caracteres',
        shareDownloadPasswordTip: 'Este link é protegido por senha. Digite a senha antes de fazer o download.',
        shareRiskAlert:
            'Links compartilhados podem apresentar riscos de segurança. Compartilhe apenas com pessoas confiáveis e evite expor informações confidenciais.',
        sharePasswordSeparate:
            'Uma senha foi definida. Compartilhe-a com segurança. Os destinatários devem adicionar &password=... à URL ou usar um cliente que envie o parâmetro de consulta da senha.',
    ...
    setting: {
        ...
        codeHelper:
            'Clique no botão "Adquirir", faça login em {0} e copie o conteúdo após "code" no link redirecionado. Cole-o neste campo. Para instruções específicas, consulte a documentação oficial.',
        googleHelper:
    ...
    nginx: {
        serverNamesHashBucketSizeHelper: 'Tamanho da tabela hash dos nomes de servidor',
        clientHeaderBufferSizeHelper: 'Tamanho do buffer de cabeçalho solicitado pelo cliente',
        clientMaxBodySizeHelper: 'Tamanho máximo de upload',
        keepaliveTimeoutHelper: 'Tempo limite da conexão',
        ...
        brotliManagedExternallyHelper:
            'O brotli está configurado manualmente no nginx.conf; o painel mostra os valores em vigor e não os sobrescreve.',
        brotliManagedUnavailableHelper:
            'O painel não conseguiu adicionar automaticamente a configuração brotli gerenciada ao nginx.conf; os valores abaixo não terão efeito.',
        brotliMinLengthHelper: 'Tamanho mínimo da resposta para compressão brotli',
        brotliSaveFailed: 'Falha ao salvar as configurações brotli; as configurações gzip acima foram aplicadas',
        ...
        waiting: 'Waiting',
        status: 'Status atual',
        configResource: 'Configuração',
        saveAndReload: 'Salvar e recarregar',
        clearProxyCache: 'Limpar cache do proxy reverso',
        clearProxyCacheWarn:
            'Todos os sites com cache configurado serão afetados e o "OpenResty" será reiniciado. Deseja continuar?',
        create: 'Criar Módulo',
        ...
        defaultHttps: 'Proteção contra adulteração HTTPS',
    ...
    firewall: {
        ...
        directBackendConflictWarning:
            '{0} e {1} estão vinculados, portanto os dois conjuntos de regras estão ativos. Verifique se não bloqueiam um ao outro e desvincule manualmente o firewall que não será mais usado.',
        initHelper:
        ...
        deleteUsedRuleConfirm:
            'Esta regra abrange serviços em escuta fornecidos por {0}. Excluí-la pode tornar esses serviços inacessíveis. Continuar?',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                serviceEnabledButAbnormal: 'Ativado, mas em estado anormal',
                ...
                disabledCronjobTasks: 'Tarefas agendadas desativadas',
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    accessMode: 'Modo de conexão',
                    accessModeDesc: 'Use o Discovery padrão sempre que o provedor de identidade oferecer suporte.',
                    actionCreate: 'Criar usuário',
                    actionKeepName: 'Mantenha o nome de usuário atual',
                    actionPending: 'Aguardando resultado',
                    actionReject: 'Rejeitar login',
                    actionUpdate: 'Atualizar informações de identidade',
                    advanced: 'Configurações avançadas',
                    advancedDesc:
                        'Mantenha os padrões seguros, a menos que o provedor exija uma opção de compatibilidade.',
                    assignDefaultRole: 'Atribuir função padrão: {role}',
                    authorizationEndpoint: 'Authorization Endpoint',
                    authorizationEndpointInvalid: 'Insira um Authorization Endpoint válido.',
                    authorizationFlow: 'Fluxo de autorização',
                    automatic: 'Automático',
                    automaticPolicy: 'Política de tratamento automático',
                    automaticPolicyDesc: 'Essas regras são aplicadas pelo back-end e não são opções de administrador.',
                    basic: 'Configurações básicas',
                    basicDesc: 'Selecione o modo do provedor e configure o cliente e o retorno de chamada.',
                    browserTest: 'Teste de login no navegador',
                    browserTestConflict: 'Identidade verificada, mas o nome de usuário está em conflito',
                    browserTestConflictHelper:
                        'O nome de usuário mapeado pertence a outra identidade e não será reivindicado.',
                    browserTestExpired: 'O teste do navegador expirou',
                    browserTestExpiredHelper:
                        'Inicie um novo teste do navegador e conclua a autorização antes que ela expire.',
                    browserTestFailed: 'Falha no teste do navegador',
                    browserTestFailedHelper:
                        'A visualização da identidade não pôde ser concluída. Revise o erro de back-end localizado.',
                    browserTestIsolation:
                        'Isso executa um fluxo real de autorização de ida e volta, mas não cria nem atualiza usuários, não atribui funções e não cria uma sessão autenticada do painel.',
                    browserTestPopupBlocked: 'Permita pop-ups para este site e reinicie o teste do navegador.',
                    browserTestPopupClosed: 'A janela de autorização foi fechada antes da conclusão do teste.',
                    browserTestSuccess: 'Verificação Provider bem-sucedida',
                    browserTestSuccessHelper:
                        'O mapeamento de identidade foi visualizado sem alterar usuários ou sessões.',
                    browserTestTitle: 'Login de teste do navegador OIDC',
                    browserTestWaiting: 'Aguardando autorização Provider',
                    ...
                    configurationHighRiskPassed:
                        'A configuração foi aprovada, mas contém opções de compatibilidade de alto risco.',
                    configurationHighRiskTag: 'Configuração de alto risco aprovada',
                    configurationNotTested: 'A configuração atual não foi testada.',
                    ...
                    configurationTestResult: 'Resultado do teste de configuração',
                    configurationTestResultDesc:
                        'Isso verifica apenas Discovery e recursos; não troca código de autorização nem comprova o Client Secret. Use o login de teste do navegador para verificação ponta a ponta.',
                    configurationTestSuccess: 'O teste de configuração do OIDC foi bem-sucedido.',
                    configurationTesting: 'Testando a configuração atual do OIDC…',
                    configurationTestingTag: 'Teste',
                    configureSecret: 'Configurar segredo',
                    conflictExistingRename: 'Um subject vinculado retorna um novo name que está ocupado',
                    conflictExistingRenameResult:
                        'Mantenha o User.Name existente e permita que o usuário vinculado faça login',
                    conflictLDAP: 'Usuário LDAP',
                    conflictLocal: 'Usuário local',
                    conflictNewAvailable: 'O novo subject e o name mapeado estão disponíveis',
                    conflictNewAvailableResult: 'Crie um usuário corporativo e atribua a função padrão',
                    conflictNone: 'Sem conflito',
                    conflictOIDC: 'Outra identidade OIDC',
                    conflictOccupied: 'O name mapeado pertence a uma identidade local, LDAP ou outra identidade OIDC',
                    conflictOccupiedResult: 'Rejeite a nova identidade; nunca vincule ou mescle automaticamente',
                    conflictType: 'Tipo de conflito',
                    connectionSecurity: 'Segurança de conexão',
                    ...
                    customCAHelper: 'Aplica-se somente a esta fonte de autenticação e nunca é gravado em logs.',
                    ...
                    disableConfirm:
                        'Desativar OIDC invalida imediatamente o acesso dos usuários desta fonte. Continuar?',
                    disableDiscardConfirm:
                        'Desabilitar o OIDC é uma ação emergencial: apenas fecha a entrada de login e invalida imediatamente o acesso dos usuários desta fonte. Outras alterações não salvas nesta página, incluindo alterações no Client Secret, serão descartadas. Continuar?',
                    disableTitle: 'Desativar OIDC',
                    disabled: 'Desativado',
                    discoveryAllowlist: 'Discovery ∩ lista de permissões de segurança',
                    enable: 'Ativar',
                    enableAfterSave: 'OIDC será habilitado após um salvamento bem-sucedido.',
                    enabled: 'Ativado',
                    ...
                    fixedNoTokenPersistence: 'Tokens, Claims e verifier nunca são persistidos',
                    fixedSecurityPolicy: 'Sempre aplicado; nenhuma configuração necessária',
                    fixedStateNonce: 'state e nonce únicos',
                    fixedTokenValidation: 'Assinatura ID Token e validação Claims',
                    highRiskSaveConfirm:
                        'Esta configuração habilitada contém opções de compatibilidade de alto risco. Confirme se o ambiente isolado os exige.',
                    highRiskTitle: 'Configuração OIDC de alto risco',
                    hs256Compatibility: 'HS256 (compatibilidade)',
                    hs256KeyHelper:
                        'HS256 sempre usa o Client Secret desta fonte e não aceita uma chave de assinatura separada.',
                    hs256Warning:
                        'HS256 usa um segredo simétrico compartilhado para assinaturas ID Token. Use-o somente quando o Provider não puder usar um algoritmo assimétrico.',
                    identityBindingPolicy:
                        'A identidade é fixada por AuthSourceID + issuer + subject. Uma coincidência de nome de usuário nunca vincula outra conta.',
                    identityMissing: 'Identidade inativa',
                    issuer: 'Issuer URL',
                    issuerHelper:
                        'O valor iss de ID Token e Discovery issuer devem corresponder exatamente a esse valor.',
                    issuerInvalid: 'Insira um HTTP ou HTTPS Issuer URL válido sem consulta ou fragmento.',
                    issuerRequired: 'Insira o Issuer URL.',
                    jwksRotation: 'Rotação automática JWKS',
                    jwksURI: 'JWKS URI',
                    jwksURIHelper: 'Necessário para assinatura assimétrica quando a origem da chave é JWKS.',
                    jwksURIInvalid: 'Insira um JWKS URI válido para a fonte de chave de assinatura selecionada.',
                    keepExistingRole: 'Mantenha as funções e permissões locais existentes',
                    localSecurityData: 'Dados de segurança local',
                    localSecurityDataPolicy: 'Nunca substitua funções, MFA, API Keys, Passkeys ou permissões locais.',
                    localCredentialsManaged:
                        'O nome de usuário e a senha local são gerenciados pelo OIDC e não podem ser editados aqui. Funções, permissões, MFA, API Keys e Passkeys permanecem locais.',
                    localUserFields: 'Campos de usuário local',
                    localUserFieldsDesc:
                    ...
                    pkceHelper: 'Prefira S256. O método de desafio plain nunca é oferecido.',
                    pkceS256: 'S256 (recomendado)',
                    plannedHandling: 'Manuseio planejado',
                    privateNetworkIdP: 'IdP de rede privada',
                    privateNetworkIdPHelper:
                        'Permite explicitamente endereços privados; metadados, loopback, link local, redirecionamentos e religação DNS permanecem bloqueados.',
                    privateNetworkWarning: 'O acesso à rede privada está habilitado para esta fonte de autenticação.',
                    protocolCompatibility: 'Compatibilidade de protocolo',
                    protocolCompatibilityDesc: 'A validação da assinatura ID Token nunca pode ser desativada.',
                    providerAndClient: 'Provider e cliente',
                    providerAndClientDesc:
                        'O Client Secret só pode ser substituído ou apagado e nunca é devolvido pela página.',
                    providerCapabilities: 'Capacidades do Provider',
                    recentTestSuccess: 'Último teste bem-sucedido: {0}',
                    recommended: 'Recomendado',
                    rejectPlain: 'plain rejeitado',
                    ...
                    restore: 'Restaurar',
                    restored: 'As últimas configurações salvas do OIDC foram restauradas.',
                    result: 'Resultado',
                    rolesLoadFailed:
                    ...
                    seconds: 'segundos',
                    secretClearHelper:
                        'Após a limpeza, um novo Client Secret é necessário antes que o OIDC possa ser ativado novamente.',
                    secretConfigured: 'Configurado',
                    secretNotConfigured: 'Não configurado',
                    secretPlaceholder: 'Insira um novo Client Secret',
                    secretReplaceHelper:
                        'O novo segredo substituirá o valor salvo ao salvar. Atualize também o Client Secret no Provider OIDC.',
                    ...
                    signingAlgorithm: 'Algoritmo de assinatura ID Token',
                    signingAlgorithmHelper:
                        'Somente algoritmos na lista de permissões de segurança de back-end estão disponíveis.',
                    signingKey: 'Chave de assinatura',
                    signingKeyClientSecret: 'Client Secret (somente HS256)',
                    signingKeyJWKS: 'JWKS URI com rotação automática',
                    signingKeySource: 'Fonte de chave de assinatura',
                    signingKeySourceHelper:
                    ...
                    standardProtocolPolicyDesc:
                        'Os recursos de assinatura são negociados automaticamente; nenhuma chave de assinatura é inserida aqui.',
                    staticSigningKey: 'Chave pública de assinatura estática',
                    staticSigningKeyHelper:
                        'Somente material de chave pública é aceito. Gire-o manualmente quando a chave Provider mudar.',
                    staticSigningKeyPlaceholder: 'Cole uma chave pública JWK, JWKS JSON ou PEM',
                    staticSigningKeyRequired: 'Forneça a chave pública de assinatura estática.',
                    staticSigningKeyWarning:
                        'Uma chave de assinatura estática não pode ser rotacionada automaticamente; atualize-a antes que o Provider gire as chaves.',
                    settingLoadFailed: 'As configurações do OIDC não puderam ser carregadas',
                    settingLoadFailedHelper:
                        'O formulário é bloqueado para evitar salvar uma configuração padrão vazia sobre as configurações atuais. Tente novamente depois que a conexão for recuperada.',
                    subsequentLogin: 'Login subsequente',
                    ...
                    tlsPrivateHTTP: 'HTTP · Somente rede privada (perigoso)',
                    ...
                    transportSecurity: 'Segurança de transporte',
                ...
                saml2: {
                    ...
                    actionPending: 'Aguardando resultado',
                    actionReject: 'Rejeitar login',
                    actionReuse: 'Usar usuário vinculado',
                    assignDefaultRole: 'Atribuir função padrão: {role}',
                    basic: 'Configurações básicas',
                    basicDesc: 'Configure as opções comuns exigidas pela maioria dos provedores SAML2.',
                    browserTest: 'Testar login',
                    browserTestConflict: 'Identidade verificada, mas o nome de usuário está em conflito',
                    browserTestConflictHelper:
                        'O nome de usuário mapeado pertence a outra identidade e não será reivindicado.',
                    browserTestExpired: 'O teste do navegador expirou',
                    ...
                    browserTestSuccessHelper:
                        'O mapeamento de identidade foi visualizado sem alterar usuários ou sessões.',
                    browserTestTitle: 'Login de teste do navegador SAML2',
                    browserTestWaiting: 'Aguardando autorização Provider',
                    browserTestWaitingHelper:
                        'Conclua o login na nova janela do navegador. Esta página será atualizada automaticamente.',
                    certificateFileInvalid: 'Selecione um arquivo de certificado PEM, CRT ou CER válido.',
                    configured: 'Configurado',
                    configurationFailedHelper: 'O teste falhou. A página exibe apenas o erro de back-end localizado.',
                    configurationNotTested: 'A configuração atual não foi testada.',
                    configurationPassed: 'A configuração atual passou nas verificações de segurança e capacidade.',
                    ...
                    configurationTestSuccess: 'O teste de configuração do SAML2 foi bem-sucedido.',
                    configurationTesting: 'Testando a configuração atual do SAML2…',
                    conflictLDAP: 'Usuário LDAP',
                    conflictLocal: 'Usuário local',
                    conflictNone: 'Sem conflito',
                    conflictOIDC: 'Outra identidade OIDC',
                    conflictSAML2: 'Outra identidade SAML2',
                    conflictType: 'Tipo de conflito',
                    credentialFileReadFailed: 'Não foi possível ler o arquivo de credenciais.',
                    credentialFileTooLarge: 'Os arquivos de credenciais não devem exceder 256 KiB.',
                    credentialsRequired: 'Configure a chave privada e o certificado do SP.',
                    defaultRole: 'Função do novo usuário',
                    defaultRoleHelper:
                        'Atribuída apenas na primeira criação; logins posteriores preservam funções, MFA e permissões locais.',
                    defaultRolePlaceholder: 'Selecione uma função',
                    defaultRoleRequired: 'Selecione uma função padrão válida.',
                    disableConfirm:
                        'Desativar o SAML2 rejeita imediatamente novos logins e invalida suas sessões de usuário. Continuar?',
                    disableDiscardConfirm:
                        'Desativar o SAML2 descarta outras alterações não salvas nesta página e invalida imediatamente suas sessões de usuário. Continuar?',
                    disableTitle: 'Desativar SAML2',
                    disabled: 'Desativado',
                    enable: 'Ativar',
                    enabled: 'Ativado',
                    idpMetadata: 'Metadados do IdP',
                    idpMetadataDesc: 'Informe uma URL ou cole o XML. Se ambos existirem, a URL terá prioridade.',
                    keepExistingRole: 'Mantenha as funções e permissões locais existentes',
                    loginWith: 'Entrar com {provider}',
                    mappingResult: 'Resultado do mapeamento',
                    metadataRequired: 'Informe a URL ou o XML dos metadados do IdP.',
                    metadataURLHelper: 'O backend baixa e valida os metadados durante o teste e o salvamento.',
                    metadataURLInvalid: 'Insira uma URL HTTPS de metadados válida, sem credenciais nem fragmento.',
                    metadataURLRecommended: 'URL de metadados (recomendada)',
                    metadataXML: 'XML de metadados',
                    metadataXMLHelper: 'Use quando o IdP não expuser uma URL de metadados acessível.',
                    metadataXMLInvalid: 'Insira um XML de metadados EntityDescriptor válido.',
                    ...
                    notConfigured: 'Não configurado',
                    or: 'ou',
                    pageDesc: 'Conecte o SSO corporativo por metadados do IdP com as opções comuns em uma página.',
                    plannedHandling: 'Manuseio planejado',
                    privateKeyFileInvalid: 'Selecione um arquivo de chave privada PEM válido.',
                    recentTestSuccess: 'Último teste bem-sucedido: {0}',
                    restore: 'Restaurar',
                    restored: 'As últimas configurações salvas do SAML2 foram restauradas.',
                    roleHandling: 'Manipulação de funções',
                    rolesLoadFailed:
                        'Não foi possível carregar as funções. Tente novamente antes de selecionar a função padrão.',
                    selectFile: 'Selecionar arquivo',
                    serviceStatus: 'Status do serviço',
                    serviceStatusDesc: 'A configuração atual deve passar no teste antes de ativar o SAML2.',
                    settingLoadFailed: 'As configurações do SAML2 não puderam ser carregadas',
                    settingLoadFailedHelper:
                        'O formulário é bloqueado para evitar salvar uma configuração padrão vazia sobre as configurações atuais. Tente novamente depois que a conexão for recuperada.',
                    spCertificate: 'Certificado do SP',
                    spCertificateHelper:
                        'Publicado nos metadados do SP para que o IdP possa verificar solicitações de login e logout.',
        ...
        node: {
            ...
            withProxy: 'Ativar acesso por proxy',
            withoutProxy: 'Desativar acesso por proxy',
            withProxyHelper:
                'O proxy do sistema {0}, mantido nas configurações do painel, será usado para acessar os nós secundários. Continuar?',
            withoutProxyHelper:
                'O uso do proxy do sistema mantido nas configurações do painel para acessar os nós secundários será interrompido. Continuar?',
            ...
            dashboardSetting: 'Configurações da Visão Geral',
            keepOneDashboardComponent: 'Mantenha pelo menos uma seção na visão geral',
        },
        customApp: {
        ...
        alert: {
            ...
            clamHelper: 'Dispara um alerta ao detectar arquivos infectados durante a varredura',
            cronJobHelper: 'Dispara um alerta quando a execução da tarefa falha',
            licenseHelper: 'A edição comercial oferece suporte a mais recursos de alerta',
            ...
            alertTriggerMode: 'Notificar em caso de',
            alertTriggerFailed: 'Apenas falha',
            alertTriggerSuccess: 'Apenas sucesso',
            alertTriggerBoth: 'Sucesso ou falha',
            alertNotificationHelper:
                'Notificar após o resultado final, não durante as novas tentativas. As notificações de sucesso e falha compartilham o limite diário e o horário de envio.',
            notificationTitle: 'Tarefa agendada - {0} 「{1}」 notificação de execução',
            notificationSuccessTitle: 'Tarefa agendada - {0} 「{1}」 concluída com sucesso',
            notificationRule: '{0}: {1}, até {2} notificações por dia',
            ...
            templateVariableNodeName: 'Nome do nó',
            templateVariableTimestamp: 'Hora do evento',
            templateVariablesHelper:
                'title=título do alerta, message=conteúdo, type=tipo, nodeName=nome do nó, timestamp=hora do evento. Clique para inserir a variável no Body.',
        ...
        vm: {
            ...
            disk: 'Disco',
            overview: 'Visão geral',
            kvmUnavailable: 'Nenhum recurso de virtualização de hardware KVM disponível foi detectado.',
            kvmCheckCpu: 'Confirme se a CPU do host oferece virtualização Intel VT-x ou AMD-V.',
            kvmCheckBios: 'Ative as opções de virtualização no BIOS/UEFI.',
            kvmCheckModule: 'Confirme se o módulo de kernel kvm, kvm_intel ou kvm_amd foi carregado corretamente.',
            kvmCheckDevice:
                'Confirme se /dev/kvm existe e se o ambiente atual não é um contêiner nem um host de nuvem sem suporte a KVM.',
            abnormal: 'Anormal',
            resourceOverview: 'Visão geral de recursos',
            cpuAllocated: 'CPU alocada',
            memoryAllocated: 'Memória alocada',
            storageUsed: 'Armazenamento usado',
            riskReminder: 'Alertas de risco',
            noRisk: 'Sem riscos',
            runtimeHealth: 'Integridade do ambiente',
            runtimeAbnormal: 'O ambiente de execução da VM está anormal',
            noDependency: 'Sem dados de verificação de dependências',
            storageOverview: 'Visão geral do armazenamento',
            totalAllocated: 'Calculado pela configuração total das VMs',
            runningAllocated: 'Alocação em execução: {0}',
            storageAvailable: 'Disponível: {0}',
            inProgress: 'Em andamento',
            needAttention: 'Requer atenção',
            normal: 'Normal',
            environmentRisk:
                'O ambiente de execução da VM não está pronto. Corrija as dependências ou os serviços de virtualização.',
            storageRisk: 'O uso do pool de armazenamento {0} atingiu {1}%.',
            abnormalRisk: '{0} VMs estão em estado anormal.',
            pausedRisk: '{0} VMs estão pausadas.',
            memoryRisk: 'A alocação de memória das VMs atingiu {0}%.',
            ...
            convertToTemplate: 'Converter em modelo',
            sourceVM: 'VM de origem',
            templateSize: 'Tamanho do modelo',
            ...
            monitorLoadFailedWithReason: 'Falha ao obter os dados de monitoramento da VM: {0}',
            rename: 'Renomear',
            newName: 'Novo nome',
            renameHelper: 'Digite um novo nome para a VM. Ela deve estar desligada antes de ser renomeada.',
            renameConfirm: 'Renomear a máquina virtual [{0}] para [{1}]?',
            renameRunningHelper: 'Desligue a máquina virtual antes de renomeá-la.',
            cpuUsage: 'Uso de CPU',
            memoryUsage: 'Uso de memória',
            diskIO: 'E/S de disco',
            networkIO: 'E/S de rede',
            diskReadWrite: 'Leitura / Gravação em disco',
            networkRxTx: 'RX / TX de rede',
            rx: 'RX',
            tx: 'TX',
            console: 'Console',
            ...
            recoverSnapshot: 'Restaurar snapshot',
            snapshotSize: 'Uso',
            currentSnapshot: 'Atual',
            snapshotEmpty: 'Nenhum snapshot',
            snapshotHelper:
                'Um snapshot salva o estado atual da VM como ponto de restauração. As alterações posteriores são registradas em um arquivo delta sem modificar o disco original. Restaurar um snapshot devolve a VM a esse estado.',
            snapshotOperationHelper:
                'O snapshot atual não pode ser excluído. Snapshots só podem ser restaurados quando a máquina virtual estiver desligada.',
            snapshotRecoverConfirm:
                'Restaurar a máquina virtual [{1}] para o snapshot [{0}]? O disco da VM será restaurado ao estado do snapshot.',
