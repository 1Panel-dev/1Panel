...
const message = {
    ...
    xpack: {
        ...
        opsReport: 'Relatório de Operações',
        opsReportOverview: 'Visão geral',
        opsReportSystem: 'Execução do host',
        opsReportLogin: 'Login e segurança',
        opsReportWebsite: 'Proteção de sites',
        opsReportResource: 'Recursos de execução',
        opsReportCronjob: 'Tarefas agendadas',
        opsReportHistory: 'Histórico de exportação',
        opsReportSetting: 'Configurações',
        opsReportPage: {
            enterprise: 'Enterprise',
        ...
        user: {
            ...
            ai_agent_manage: 'Gerenciamento do Assistente de IA',
            ai_model_view: 'Visualização do Modelo de IA',
            ai_model_manage: 'Gerenciamento do Modelo de IA',
            ...
            website_cert_manage: 'Gerenciamento do Certificado',
            website_runtime_view: 'Visualização do Ambiente de Execução',
            website_runtime_manage: 'Gerenciamento do Ambiente de Execução',
            database_view: 'Visualização do Banco de Dados',
            database_manage: 'Gerenciamento do Banco de Dados',
            container_view: 'Visualização do Contêiner',
            container_manage: 'Gerenciamento do Contêiner',
            cronjob_view: 'Visualização de Tarefas',
            toolbox_view: 'Visualização da Caixa de Ferramentas',
            host_file_view: 'Visualização de Arquivos',
            host_firewall_view: 'Visualização do Firewall',
            host_monitor_view: 'Visualização do Monitor',
            ...
            xpack_ops_report_view: 'Visualização do Relatório de Operações',
            xpack_ops_report_manage: 'Gerenciamento do Relatório de Operações',
            xpack_monitor_view: 'Visualização do Monitor',
            xpack_monitor_manage: 'Gerenciamento do Monitor',
            xpack_cluster_view: 'Visualização do Cluster',
            xpack_cluster_manage: 'Gerenciamento do Cluster',
            xpack_tamper_view: 'Visualização do Antitamper',
            xpack_tamper_manage: 'Gerenciamento do Antitamper',
            log_view: 'Visualização de Logs',
        },
        app: {
            app: 'APP',
