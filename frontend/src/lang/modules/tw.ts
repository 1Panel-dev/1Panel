...
const message = {
    ...
    monitor: {
        ...
        基础信息: '基礎資訊',
        gpuHelper: '當前系統未檢測到 NVIDIA-SMI 指令，請檢查後重試！',
        driverVersion: '驅動版本',
        cudaVersion: 'CUDA 版本',
        process: '進程信息',
        type: '類型',
        ...
        computeMode: '計算模式',
        default: '默認',
        exclusiveProcess: '進程排他',
        exclusiveThread: '線程排他',
        prohibited: '禁止',
        defaultHelper: '默認: 進程可以並發執行',
        exclusiveProcessHelper: '進程排他: 只有一個 CUDA 上下文可以使用 GPU, 但可以由多個線程共享',
        exclusiveThreadHelper: '線程排他: 只有一個線程在 CUDA 上下文中可以使用 GPU',
        prohibitedHelper: '禁止: 不允許進程同時執行',
        migModeHelper: '用於創建 MIG 實例，在用戶層實現 GPU 的物理隔離。',
        migModeNA: '不支持',
    },
    terminal: {
        conn: '連接',
