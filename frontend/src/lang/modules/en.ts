...
const message = {
    commons: {
        ...
        table: {
            ...
            refreshRateUnit: '{0} Seconds(s)/Time',
        ...
        msg: {
            ...
            delete: 'This operation delete cannot be undone. Do you want to continue?',
            clean: 'This operation clean cannot be undone. Do you want to continue?',
            deleteTitle: 'Delete',
    ...
    database: {
        ...
        redisCliHelper: '"redis-cli" service is not detected, please enable the service first!',
    ...
    app: {
        ...
        checkInstalledWarn: '"{0}" is not detected, go to app store and click to install.',
