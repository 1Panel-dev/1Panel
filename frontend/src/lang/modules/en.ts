...
const message = {
    ...
    dns: {
        ...
        enabled: 'Enabled',
        disabled: 'Disabled',
        setup: 'Enable DNS Management',
        setupHelper: 'This will deploy a PowerDNS container for DNS zone management.',
        syncZone: 'Sync from PowerDNS',
        syncHelper: 'Re-fetch all records from PowerDNS to update the local cache.',
        autoGenerated: 'Auto',
        autoGenHelper: 'This record was auto-generated by 1Panel.',
        deleteZoneHelper: 'This will permanently delete the DNS zone and all its records. Continue?',
        deleteRecordHelper: 'This will delete the DNS record. Continue?',
        recordCount: 'Records',
        soaConfig: 'SOA Configuration',
        soaRefresh: 'Refresh',
        soaRetry: 'Retry',
        soaExpire: 'Expire',
        soaMinTTL: 'Minimum TTL',
        pdnsNotRunning: 'PowerDNS container is not running.',
        pdnsRunning: 'PowerDNS is running.',
        name: 'Name',
        viewRecords: 'View Records',
    },
    mail: {
        setup: 'Enable Mail Server',
        setupHelper: 'Deploy Postfix + Dovecot + Rspamd + Roundcube for email hosting.',
        domain: 'Mail Domain',
        ...
        dkimKey: 'DKIM Public Key',
        spfRecord: 'SPF Record',
        dmarcRecord: 'DMARC Record',
        dnsAutoGen: 'Auto-configure DNS records',
        dnsAutoGenHelper: 'Automatically create MX, SPF, DKIM, and DMARC records in your DNS zones.',
        openWebmail: 'Open Webmail',
        mailRunning: 'Mail server is running.',
        mailNotRunning: 'Mail server is not running.',
        roundcubeRunning: 'Webmail is available.',
        roundcubeNotRunning: 'Webmail is not available.',
        cleanupDns: 'Also remove auto-generated DNS records',
        status: 'Status',
        enabled: 'Active',
        disabled: 'Disabled',
        deleteDomainHelper: 'This will permanently delete the mail domain, all accounts, and all aliases. Continue?',
        deleteAccountHelper: 'This will delete the mail account. Continue?',
        deleteAliasHelper: 'This will delete the mail alias. Continue?',
        viewDomain: 'Manage',
    },
};
