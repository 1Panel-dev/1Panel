...
const message = {
    ...
    monitor: {
        ...
        gpuHelper: 'NVIDIA-SMI command not detected in the current system, please check and try again!',
        ...
        temperatureHelper: 'High GPU temperature can cause a decrease in GPU frequency',
        ...
        persistenceModeHelper:
            'Persistence mode allows for faster task response but also increases idle power consumption',
        displayActive: 'GPU Initialization',
        displayActiveT: 'Yes',
        displayActiveF: 'No',
        ecc: 'Error Check and Correction Technology Enabled',
        ...
        exclusiveProcessHelper:
            'Exclusive Process: Only one CUDA context can use the GPU, but multiple threads can share it',
        exclusiveThreadHelper: 'Exclusive Thread: Only one thread in the CUDA context can use the GPU',
        prohibitedHelper: 'Prohibited: Processes cannot execute simultaneously',
        migModeHelper: 'Used to create MIG instances for physical isolation of GPUs at the user level.',
