...
const message = {
    ...
    aiTools: {
        ...
        aiProxy: {
            ...
            apiKey: 'API Key',
            apiKeyKeepEmpty: 'API Key (leave empty to keep unchanged)',
            apiKeyOnceHint: 'The API Key is shown only once after creation. Copy and save it now.',
            apiKeyOnceSave: 'The API Key is shown only once. Save it now:',
            qpsLimit: 'QPS Limit',
            unlimited: 'Unlimited',
            lastUsedAt: 'Last Used',
            settingTitle: 'AI Proxy Settings',
            ...
            statusTitle: 'AI Proxy Status',
            serviceEnabled: 'Service Enabled',
            configStatus: 'Config Status',
            statusMessage: 'Status Message',
            serviceOperateConfirm: 'Confirm to {0} the AI Proxy service?',
            deleteBackendConfirm: 'Delete model account {0}?',
            deleteBackendTitle: 'Delete Model Account',
            deleteUserConfirm: 'Delete user {0}?',
            userFallback: 'User {0}',
