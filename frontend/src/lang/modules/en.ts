...
const message = {
    ...
    xpack: {
        ...
        alert: {
            ...
            alertTriggerMode: 'Notify on',
            alertTriggerFailed: 'Failure only',
            alertTriggerSuccess: 'Success only',
            alertTriggerBoth: 'Success or failure',
            alertNotificationHelper:
                'Notify after the final execution result, not during retries. Success and failure notifications share the daily limit and sending hours.',
            notificationTitle: 'Scheduled task - {0} 「{1}」 execution notification',
            notificationSuccessTitle: 'Scheduled task - {0} 「{1}」 completed successfully',
            notificationRule: '{0}: {1}, up to {2} notifications per day',
