...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            runtimeReady: 'VM runtime is ready',
            ...
            isoTargetDirHelper: 'If set, the ISO is saved to this directory. Optional for server-selected ISO files.',
            isoTargetDirOptional: 'No ISO target path is set. The original ISO source path will be used.',
            isoTargetDirAvailable: 'The ISO target path is available.',
            isoTargetDirUnavailable: 'The ISO target path must be inside an available VM storage pool.',
            isoTargetDirCheckRequired: 'Check the ISO target path before saving.',
            checkPath: 'Check',
            isoSize: 'ISO Size',
