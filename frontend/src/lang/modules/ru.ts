    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scorePasswordExpired: 'Срок действия пароля панели истёк',
                scorePasswordExpiring: 'Срок действия пароля панели истекает через {0} дней',
                ...
                assetResourceDesc: '{0} приложений с аномалиями, {1} остановлено, {2} аномальных контейнеров',
                ...
                passwordExpirationNormalDesc: 'Срок действия пароля находится в безопасном диапазоне',
                passwordExpirationUnsetDesc: 'Срок действия пароля не задан, рекомендуется скорее настроить',
                passwordExpirationRiskDesc:
                    'Срок действия пароля истекает через {0} дней, рекомендуется заблаговременно продлить',
                passwordExpirationExpiredDesc: 'Срок действия пароля истёк {0} дней назад, продлите как можно скорее',
