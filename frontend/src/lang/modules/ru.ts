...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            iso: 'ISO',
            createSource: 'Источник создания',
            ...
            isoTargetDirCheckRequired: 'Проверьте путь сохранения ISO перед сохранением.',
            checkPath: 'Проверить',
            isoSize: 'Размер ISO',
            deleteIsoConfirm: 'Эту операцию удаления нельзя отменить. Продолжить?',
            deleteSourceFile: 'Удалить исходный файл',
            deleteSourceFileHelper: 'Если отмечено, исходный файл, на который ссылается эта запись ISO, также будет удалён без возможности восстановления.',
