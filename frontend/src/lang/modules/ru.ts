...
const message = {
    ...
    aiTools: {
        ...
        skillsHub: {
            ...
            containerNameRequired: 'Для контейнерных целей требуется имя контейнера.',
            deleteTargetConfirm:
    ...
    setting: {
        ...
        offlineEnvHelper:
            'После включения такие ресурсы, как магазин приложений, по умолчанию считываются из локального каталога сервера.\nДля обновления системы и агентов необходимо вручную загрузить офлайн-пакеты.',
        offlineEnvOpenHelper: 'Вы уверены, что хотите включить офлайн-среду?',
        offlineEnvCloseHelper: 'Вы уверены, что хотите отключить офлайн-среду?',
