...
const message = {
    ...
    firewall: {
        ...
        resetDirectRulesHelper:
            'Удалить из {0} все системные цепочки, правила, постоянные файлы и соответствующие записи базы данных 1Panel',
        resetWhitelistRulesHelper:
            'Удалить из {0} все пользовательские настройки и записи базы данных, восстановить заводские настройки и отключить {0}.\nПосле очистки защита больше не предоставляется. Это действие нельзя отменить.',
        ...
        backendSwitchNotice:
            'Переключение системного брандмауэра не переносит и не очищает правила автоматически. Для переадресации портов и защиты Docker сначала требуется очистить текущий бэкенд; сохранённые правила и политики останутся в 1Panel и могут быть повторно инициализированы или синхронизированы.',
        ...
        ruleSyncSource: 'Исходный бэкенд',
