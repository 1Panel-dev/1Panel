...
const message = {
    ...
    xpack: {
        ...
        opsReport: 'Операционный отчет',
        opsReportOverview: 'Обзор',
        opsReportSystem: 'Работа хоста',
        opsReportLogin: 'Вход и безопасность',
        opsReportWebsite: 'Защита сайтов',
        opsReportResource: 'Ресурсы выполнения',
        opsReportCronjob: 'Плановые задачи',
        opsReportHistory: 'История экспорта',
        opsReportSetting: 'Настройки',
        opsReportPage: {
            enterprise: 'Enterprise',
        ...
        user: {
            ...
            app_view: 'Просмотр приложения',
            app_manage: 'Управление приложением',
            ai_agent_view: 'Просмотр AI-ассистента',
            ai_agent_manage: 'Управление AI-ассистентом',
            ai_model_view: 'Просмотр AI-модели',
            ai_model_manage: 'Управление AI-моделью',
            ...
            website_cert_manage: 'Управление сертификатом',
            website_runtime_view: 'Просмотр среды выполнения',
            website_runtime_manage: 'Управление средой выполнения',
            database_view: 'Просмотр базы данных',
            database_manage: 'Управление базой данных',
            container_view: 'Просмотр контейнера',
            container_manage: 'Управление контейнером',
            cronjob_view: 'Просмотр заданий',
            toolbox_view: 'Просмотр инструментов',
            host_file_view: 'Просмотр файлов',
            host_firewall_view: 'Просмотр файрвола',
            host_monitor_view: 'Просмотр мониторинга',
            ...
            xpack_ops_report_view: 'Просмотр операционного отчета',
            xpack_ops_report_manage: 'Управление операционным отчетом',
            xpack_monitor_view: 'Просмотр мониторинга',
            xpack_monitor_manage: 'Управление мониторингом',
            xpack_cluster_view: 'Просмотр кластера',
            xpack_cluster_manage: 'Управление кластером',
            xpack_tamper_view: 'Просмотр защиты от подмены',
            xpack_tamper_manage: 'Управление защитой от подмены',
            log_view: 'Просмотр журналов',
        },
        app: {
            app: 'APP',
            title: 'Псевдоним панели',
