        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    authorizationEndpointInvalid: '请输入有效的 Authorization Endpoint。',
                    ...
                    callbackURL: '回调地址',
                    callbackURLHelper: '请将该完整地址加入 Provider 的允许回调列表。',
                    cancelClearSecret: '取消清除',
                    clearSecret: '清除密钥',
                    clearSecretConfirm: 'Client Secret 只会在保存后删除，是否继续？',
                    clientAuthMethod: '客户端认证方式',
                    clientAuthMethodHelper: '必须与 Provider Token Endpoint 支持的方式一致。',
                    clientAuthMethodRequired: '请选择客户端认证方式。',
                    clientID: 'Client ID',
                    clientIDRequired: '请输入 Client ID。',
                    clientSecret: 'Client Secret',
                    clockSkew: '时钟偏差容忍',
                    clockSkewRequired: '请输入时钟偏差容忍时间。',
                    compatibilityMode: '兼容模式（手工端点与安全参数）',
                    compatibilityModeHelper: '仅用于 Discovery 不完整或端点被改写的 Provider，核心 OIDC 校验不会关闭。',
                    compatibilityModeShort: '兼容模式',
                    ...
                    configurationTestResultDesc:
                        '这里只检查 Discovery 与 Provider 能力，不交换授权码，也不能证明 Client Secret 正确；请使用“浏览器测试登录”完成端到端验证。',
                    ...
                    connectionTestCompatibilityDesc: '验证手工端点和协议安全策略。',
                    connectionTestStandardDesc: '从 Issuer 自动发现端点和能力。',
                    connectionTestTab: '连接测试',
                    customCA: '自定义 CA',
                    customCAHelper: '仅作用于当前认证源，且不会写入日志。',
                    customCARequired: '请提供自定义 CA 证书。',
                    defaultRole: '默认角色',
                    defaultRoleHelper: '仅在首次创建用户时分配，不覆盖已有角色和权限。',
                    ...
                    disableDiscardConfirm:
                        '停用 OIDC 属于故障兜底操作：只关闭登录入口，并立即使该认证源用户的访问失效。本页其他未保存修改（包括 Client Secret 修改）将被丢弃。是否继续？',
                    ...
                    endSessionEndpointHelper: '首期只保存，不执行 Provider 发起的单点登出。',
                    endSessionEndpointInvalid: '请输入有效的 End Session Endpoint。',
                    firstLogin: '首次登录',
                    ...
                    hs256KeyHelper: 'HS256 固定使用当前认证源的 Client Secret，不接受另一份签名 Key。',
                    ...
                    identityMissing: 'OIDC 身份源已经变化，当前身份不再有效。',
                    issuer: 'Issuer URL',
                    issuerHelper: 'ID Token 的 iss 与 Discovery issuer 必须与该值完全一致。',
                    issuerInvalid: '请输入不含查询串和 fragment 的有效 HTTP 或 HTTPS Issuer URL。',
                    issuerRequired: '请输入 Issuer URL。',
                    jwksRotation: 'JWKS 自动轮换',
                    jwksURI: 'JWKS URI',
                    jwksURIHelper: '使用非对称签名且密钥来源为 JWKS 时必填。',
                    jwksURIInvalid: '请为当前签名密钥来源填写有效的 JWKS URI。',
                    ...
                    manualEndpoints: '手工端点',
                    manualEndpointsDesc: '仅用于 Discovery 不完整或上游网关改写端点的 Provider。',
                    manualEndpointsSecurity: '手工端点不会关闭 Issuer、Audience、签名、state、nonce 和时效校验。',
                    mappingResult: '映射结果',
                    mode: '接入模式',
                    modeRequired: '请选择接入模式。',
                    nameClaim: '用户名 Claim',
                    nameClaimHelper: '优先读取已验证 ID Token 的顶层 Claim，UserInfo 只补充缺失值。',
                    nameClaimRequired: '请输入用户名 Claim。',
                    nameConflict: '同名冲突策略',
                    panelURL: '1Panel 对外地址',
                    panelURLHTTPWarning: 'HTTP 不保护授权响应，仅用于 Provider 接受的隔离私有环境。',
                    panelURLHelper: '只填写浏览器可见的协议、域名和可选端口，反向代理场景尤其需要确认。',
                    panelURLInvalid: '请输入只包含协议、主机和可选端口的对外地址。',
                    panelURLRequired: '请输入 1Panel 对外地址。',
                    ...
                    providerAndClient: 'Provider 与客户端',
                    providerAndClientDesc: 'Client Secret 只允许替换或清除，页面永不回显。',
                    ...
                    requestAndClaimsDesc: '配置 Scopes、UserInfo 补充和有边界的后端请求容错。',
                    requestTimeout: '请求超时',
                    ...
                    roleHandling: '角色处理',
                    scenario: '场景',
                    scopesHelper: 'openid 为必需项，默认不申请 email 和 offline_access。',
                    scopesRequired: 'Scopes 必须包含 openid。',
                    seconds: '秒',
                    secretClearHelper: '清除后，重新启用 OIDC 前必须配置新的 Client Secret。',
                    secretConfigured: '已配置',
                    secretNotConfigured: '未配置',
                    secretPlaceholder: '输入新 Client Secret',
                    secretReplaceHelper: '新密钥将在保存时替换原值，请同时更新 OIDC Provider 中的 Client Secret。',
                    secretRequiredHelper: '启用 OIDC 前需要配置 Client Secret。',
                    secretRequiredToEnable: '请先配置 Client Secret，再启用 OIDC。',
                    secretSavedHelper: '密钥已加密保存且不会回显，保持不变会保留原值。',
                    secretWaiting: '等待输入',
                    ...
                    signingKey: '签名密钥',
                    signingKeyClientSecret: 'Client Secret（仅 HS256）',
                    ...
                    standardDiscovery: '标准 OIDC Discovery',
                    standardDiscoveryDesc: '1Panel 自动发现端点和能力，不保存 Discovery 原文。',
                    standardMode: '标准 OIDC Discovery（推荐）',
                    ...
                    testBeforeEnable: '启用或保存敏感变更前，请先测试当前配置。',
                    ...
                    tlsSkipVerify: '忽略 SSL 证书验证',
                    tlsSkipVerifyWarning: '证书校验只对当前认证源关闭，并会记录高风险审计。',
                    tlsSystem: 'HTTPS · 系统证书校验（推荐）',
                    tokenEndpoint: 'Token Endpoint',
                    tokenEndpointInvalid: '请输入有效的 Token Endpoint。',
                    transportSecurity: '传输安全',
                    transportSecurityHelper: '优先使用 HTTPS；私有 HTTP 还需要显式允许私有网络。',
                    unsavedChanges: 'OIDC 配置有未保存的更改。',
                    usedClaim: '使用 Claim',
                    userInfoDisabledHelper: '仅使用已验证 ID Token 中的 Claim。',
                    userInfoEnabledHelper: '只补充缺失的用户名 Claim，且 subject 必须一致。',
                    userInfoEndpoint: 'UserInfo Endpoint',
                    userInfoEndpointHelper: '仅在启用 UserInfo 补充时使用。',
                    userInfoEndpointInvalid: '启用 UserInfo 时请输入有效的 UserInfo Endpoint。',
                    userMapping: '用户映射',
                    userMappingDesc: 'subject 绑定身份，配置的 Claim 只映射到 1Panel User.Name。',
                },
                ldap: {
                    enable: '是否开启',
                    enabled: '已启用',
