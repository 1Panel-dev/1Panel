...
const message = {
    apiKeyManagement: {
        ...
        specifiedIPs: '指定 IP',
        anyIP: '所有 IP',
        ipHelp: '每行填写一个 IP 或 CIDR。允许所有来源时，请明确选择“所有 IP”。',
        ...
        appSecurityHelp: '移动端 App 使用所选 API Key 访问面板，权限与该 Key 所属账号一致。请妥善保管已绑定的设备。',
        mobileIPHelp: '手机出口 IP 必须符合白名单。切换 Wi-Fi 或移动网络可能导致访问被拒绝，系统不会自动扩大白名单。',
        qrUnavailable: '二维码已不可用，请刷新后重新扫码。',
        showQR: '显示二维码',
        hideQR: '隐藏二维码',
    ...
    xpack: {
        ...
        alert: {
            ...
            alertTriggerFailed: '仅失败',
            alertTriggerSuccess: '仅成功',
            alertTriggerBoth: '成功或失败',
            alertNotificationHelper:
                '任务最终执行完成后按结果通知，重试过程中不发送；成功与失败共用每日次数及发送时段。',
            notificationTitle: '计划任务-{0}「{1}」执行告警',
            notificationSuccessTitle: '计划任务-{0}「{1}」执行成功通知',
            notificationRule: '{0}：{1}，每天最多发送 {2} 次',
