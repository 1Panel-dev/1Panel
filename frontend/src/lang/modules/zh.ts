...
const message = {
    ...
    aiTools: {
        ...
        aiProxy: {
            ...
            apiKeyOnceHint: 'API Key 仅创建时显示一次，请及时复制保存。',
            apiKeyOnceSave: 'API Key 只显示一次，请立即保存：',
            qpsLimit: 'QPS 限制',
            unlimited: '不限',
            lastUsedAt: '最近使用时间',
            settingTitle: 'AI 代理设置',
            lbPolicy: '负载策略',
            ...
            configStatus: '配置状态',
            statusMessage: '状态信息',
            serviceOperateConfirm: '确认{0} AI 代理服务？',
            deleteBackendConfirm: '确认删除模型账号 {0}？',
            deleteBackendTitle: '删除模型账号',
            deleteUserConfirm: '确认删除用户 {0}？',
            userFallback: '用户 {0}',
            requestModel: '请求模型',
            upstreamModel: '上游模型',
    ...
    license: {
        ...
        'model-downloader':
            '升级专业版可从 HuggingFace、ModelScope 或兼容镜像站搜索、下载并管理本地模型文件，统一维护本地模型目录与下载任务。',
    },
    clean: {
        scan: '开始扫描',
    ...
    xpack: {
        ...
        user: {
            ...
            permission: '权限',
            selectAll: '全选',
            nodeRoleDuplicate: '每个节点只能添加一种角色',
            view: '查看',
            manage: '管理',
