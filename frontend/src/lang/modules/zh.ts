...
const message = {
    ...
    dns: {
        ...
        disabled: '已禁用',
        setup: '启用 DNS 管理',
        setupHelper: '将部署 PowerDNS 容器用于 DNS 域管理。',
        syncZone: '从 PowerDNS 同步',
        syncHelper: '从 PowerDNS 重新获取所有记录以更新本地缓存。',
        autoGenerated: '自动',
        autoGenHelper: '此记录由 1Panel 自动生成。',
        deleteZoneHelper: '将永久删除 DNS 域及其所有记录。继续？',
        deleteRecordHelper: '将删除该 DNS 记录。继续？',
        recordCount: '记录数',
        soaConfig: 'SOA 配置',
        soaRefresh: '刷新',
        soaRetry: '重试',
        soaExpire: '过期',
        soaMinTTL: '最小 TTL',
        pdnsNotRunning: 'PowerDNS 容器未运行。',
        pdnsRunning: 'PowerDNS 正在运行。',
        name: '名称',
        viewRecords: '查看记录',
    },
    mail: {
        setup: '启用邮件服务',
        setupHelper: '部署 Postfix + Dovecot + Rspamd + Roundcube 邮件托管。',
        domain: '邮件域',
        domains: '邮件域',
        createDomain: '添加域',
        deleteDomain: '删除域',
        ...
        dkimKey: 'DKIM 公钥',
        spfRecord: 'SPF 记录',
        dmarcRecord: 'DMARC 记录',
        dnsAutoGen: '自动配置 DNS 记录',
        dnsAutoGenHelper: '自动在 DNS 区域中创建 MX、SPF、DKIM 和 DMARC 记录。',
        openWebmail: '打开网页邮箱',
        mailRunning: '邮件服务器正在运行。',
        mailNotRunning: '邮件服务器未运行。',
        roundcubeRunning: '网页邮箱可用。',
        roundcubeNotRunning: '网页邮箱不可用。',
        cleanupDns: '同时删除自动生成的 DNS 记录',
        status: '状态',
        enabled: '启用',
        disabled: '禁用',
        deleteDomainHelper: '将永久删除邮件域及其所有账号和别名。继续？',
        deleteAccountHelper: '将删除该邮箱账号。继续？',
        deleteAliasHelper: '将删除该邮箱别名。继续？',
        viewDomain: '管理',
    },
};
export default {
