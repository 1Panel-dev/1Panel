    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                passwordExpiration: '密码到期时间',
                passwordExpirationNormalDesc: '密码到期时间处于较安全范围',
                passwordExpirationUnsetDesc: '密码到期时间未设置，建议尽快配置',
                passwordExpirationRiskDesc: '密码将在 {0} 天内到期，建议提前处理',
                passwordExpirationExpiredDesc: '密码已过期 {0} 天，请尽快处理',
