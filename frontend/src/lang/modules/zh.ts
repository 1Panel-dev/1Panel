        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clientSecret: '客户端密钥',
                    clockSkew: '令牌时间偏差',
                    clockSkewHelper: '允许身份提供方与 1Panel 存在少量时间偏差，建议保持 60 秒。',
                    ...
                    panelURLHelper: '填写用户实际访问 1Panel 的地址，用于生成回调地址。',
                    ...
                    standardDiscoveryDesc: '1Panel 自动发现端点和能力，不保存自动发现原文。',
                    standardMode: '标准模式',
                    ...
                    userMapping: '用户配置',
                    userMappingDesc: '设置 OIDC 用户名和首次登录时的默认角色。',
                },
                ldap: {
                    enable: '是否开启',
                    enabled: '已启用',
