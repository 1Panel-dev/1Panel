...
const message = {
    ...
    xpack: {
        ...
        opsReport: '运维报表',
        opsReportOverview: '概览',
        opsReportSystem: '主机运行',
        opsReportLogin: '登录与安全配置',
        opsReportWebsite: '网站防护',
        opsReportResource: '运行资源',
        opsReportCronjob: '计划任务',
        opsReportHistory: '导出历史',
        opsReportSetting: '设置',
        opsReportPage: {
            enterprise: '企业版',
            ...
            scorePanelLoginFailedHigh: '1Panel 登录失败 {0} 次',
            scorePanelLoginFailedMedium: '1Panel 登录失败 {0} 次',
            scoreSSHLoginFailedHigh: 'SSH 登录失败 {0} 次',
            scoreSSHLoginFailedMedium: 'SSH 登录失败 {0} 次',
            scoreMFADisabled: 'MFA 未开启',
            scoreAllowIPsOpen: '授权 IP 未配置或范围过大',
            scorePasswordExpired: '面板密码已过期',
            scorePasswordExpiring: '面板密码剩余 {0} 天到期',
            ...
            panelFailedRecords: '1Panel 登录失败记录',
        ...
        user: {
            ...
            app_manage: '应用管理',
            ai_agent_view: '智能体查看',
            ai_agent_manage: '智能体管理',
            ai_model_view: '模型查看',
            ai_model_manage: '模型管理',
            ai_mcp_view: 'MCP 查看',
            ai_mcp_manage: 'MCP 管理',
            ai_gpu_view: 'GPU 查看',
            website_view: '网站查看',
            website_manage: '网站管理',
            website_cert_view: '证书查看',
            website_cert_manage: '证书管理',
            website_runtime_view: '运行环境查看',
            website_runtime_manage: '运行环境管理',
            database_view: '数据库查看',
            ...
            toolbox_view: '工具箱查看',
            host_file_view: '文件查看',
            host_firewall_view: '防火墙查看',
            host_monitor_view: '网站监控查看',
            ...
            xpack_ops_report_view: '运维报表查看',
            xpack_ops_report_manage: '运维报表管理',
            xpack_monitor_view: '监控查看',
            xpack_monitor_manage: '监控管理',
            xpack_cluster_view: '集群查看',
            xpack_cluster_manage: '集群管理',
            xpack_tamper_view: '防篡改查看',
            xpack_tamper_manage: '防篡改管理',
            log_view: '日志查看',
        },
        customApp: {
            name: '自定义仓库',
