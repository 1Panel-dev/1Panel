...
const message = {
    ...
    app: {
        ...
        uploadLocalAppPackageHelper: '上传 .tar.gz 本地应用包，系统会自动解压到本地应用目录并同步本地应用。',
        overwriteLocalAppPackage: '覆盖同名本地应用包',
        uploadLocalAppPackageSelect: '请选择本地应用包',
        uploadLocalAppPackageFormatError: '仅支持 .tar.gz 格式',
        uploadLocalAppPackageDetected: '识别到应用',
        ignoreAll: '忽略后续所有版本',
