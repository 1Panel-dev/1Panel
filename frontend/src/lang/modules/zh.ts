...
const message = {
    commons: {
        ...
        login: {
            ...
            passkeyNotSupported: '当前浏览器或环境不支持 Passkey',
    ...
    setting: {
        ...
        passkey: 'Passkey',
        passkeyManage: '管理',
        passkeyHelper: '用于快速登录，最多可绑定 5 个 Passkey',
        passkeyRequireSSL: '开启 HTTPS 后可使用 Passkey',
        passkeyNotSupported: '当前浏览器或环境不支持 Passkey',
        ...
        passkeyDeleteConfirm: '删除后将无法使用该 Passkey 登录，是否继续？',
        passkeyLimit: '最多可绑定 5 个 Passkey',
        passkeyFailed: 'Passkey 注册失败，请重试',
