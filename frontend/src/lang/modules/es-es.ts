import fit2cloudEsEsLocale from 'fit2cloud-ui-plus/src/locale/lang/es-es';
...
const message = {
	...
	aiTools: {
		...
		mcp: {
			...
			streamableHttpPathHelper: 'Por ejemplo: /mcp, tenga en cuenta que no debe superponerse con otros servidores',
	...
	container: {
		...
		sameImageHelper: 'Los contenedores que usan la misma imagen pueden actualizarse en lote después de seleccionarlos',
		...
		iptablesHelper2: 
			'Deshabilitar iptables impedirá que los contenedores se comuniquen con redes externas.',
	...
	cronjob: {
		...
		errImportFormat: 'Los datos o el formato de la tarea programada son anormales. ¡Por favor verifique e inténtelo de nuevo!',
		importHelper: 
	...
	toolbox: {
		...
		swap: {
			swap: 'Partición Swap',
			swapHelper1: 
				'El tamaño de swap debe ser de 1 a 2 veces la memoria física, ajustable según necesidades.',
			swapHelper2: 
			...
			saveSwap: 
				'Guardar la configuración ajustará la partición Swap {0} a {1}. ¿Desea continuar?',
		...
		device: {
			...
			dnsAlert: 
				'¡Atención! Modificar el archivo /etc/resolv.conf lo restaurará tras reiniciar el sistema.',
			dnsHelper1: 
				'Si hay varios DNS, deben ir en líneas nuevas. Ejemplo:\n114.114.114.114\n8.8.8.8',
			...
			hostHelper: 
				'Hay un valor vacío en el contenido. Por favor, revise y modifique.',
		...
		ftp: {
			...
			enableHelper: 
				'Habilitar la cuenta FTP restaurará los permisos de acceso. ¿Desea continuar?',
			disableHelper: 
				'Deshabilitar la cuenta FTP revocará los permisos de acceso. ¿Desea continuar?',
	...
	file: {
		...
		deleteHelper: 
			'¿Está seguro de eliminar los siguientes archivos? Por defecto irán a la papelera de reciclaje.',
		...
		deleteHelper2: 
			'¿Está seguro de eliminar el archivo seleccionado? No se puede deshacer.',
	...
	ssh: {
		...
		sshChangeHelper: 
			'Esta acción cambió "{0}" a "{1}". ¿Desea continuar?',
		...
		listenHelper: 
			'Si deja ambos campos en blanco, escuchará en "0.0.0.0:{0}(IPv4)" y ":::{0}(IPv6)".',
		...
		syncHelper: 'La operación de sincronización limpiará las claves inválidas y sincronizará nuevos pares de claves completos. ¿Desea continuar?',
		...
		noAddrWarning: 'Actualmente no se han seleccionado direcciones [{0}]. ¡Por favor verifique e inténtelo de nuevo!',
	...
	setting: {
		...
		proxyHelper2: 'Actualización del sistema y recuperación de información de actualización (solo edición profesional)',
		...
		apiInterfaceAlert1: 'No lo habilites en entornos de producción ya que puede aumentar riesgos de seguridad en el servidor.',
		apiInterfaceAlert2: 'No uses aplicaciones de terceros para llamar a la API y evitar posibles amenazas de seguridad.',
		...
		ipWhiteListHelper: 'Las IP en la lista blanca pueden acceder a la API, 0.0.0.0/0 (todas IPv4), ::/0 (todas IPv6)',
		...
		apiKeyResetHelper: 'El servicio asociado con la clave quedará inválido. Por favor añade una nueva clave al servicio',
		...
		systemIPWarning1: 'La dirección del servidor actual está configurada en {0}, ¡y la redirección rápida no es posible!',
		...
		developerModeHelper: 'Podrás experimentar nuevas funciones y correcciones antes de su lanzamiento general y dar retroalimentación anticipada.',
		...
		scDeep_Archive: 'Almacenamiento en frío duradero, adecuado para escenarios con frecuencia de acceso extremadamente baja.',
		archiveHelper:
		...
		entranceError:
			'Introduce un punto de entrada seguro de 5 a 116 caracteres, solo se admiten números o letras.',
		...
		expirationHelper: 'Si el tiempo de expiración de la contraseña es [0] días, la función de expiración estará desactivada',
		...
		complexityHelper: 'Tras habilitarlo, la regla de validación de contraseña será: 8-30 caracteres, incluyendo letras, números y al menos dos caracteres especiales.',
		...
		allowIPsHelper:
			'Tras configurar la lista de IP autorizadas, solo las IP en la lista podrán acceder al panel.',
		allowIPsWarning:
		...
		mfaIntervalHelper: 'Tras modificar el tiempo de refresco, vuelve a escanear o añade la clave secreta manualmente.',
		mfaAlert:
		...
		noAuthSettingHelper: 'Cuando los usuarios no inician sesión desde la entrada de seguridad especificada, o no acceden al panel desde la IP o dominio especificados, esta respuesta puede ocultar características del panel.',
		...
		selfSignedHelper: 'Los navegadores pueden no confiar en certificados autofirmados y mostrar advertencias de seguridad.',
		select: 'Seleccionar',
		...
		recoverErrSize: 'Se detectó espacio insuficiente en disco, por favor verifica o libera espacio e inténtalo de nuevo.',
		recoverHelper:
		...
		versionNotSame: 'La versión del nodo no coincide con la del nodo principal. Actualiza en la gestión de nodos antes de reintentar.',
		versionCompare:
		...
		backupRecoverMessage: 'Introduce la contraseña de compresión o descompresión (déjalo en blanco para no establecerla)',
	},
	license: {
		community: 'OSS',
		...
		forceUnbindHelper: 
			'La desvinculación forzada ignorará errores y liberará la licencia.',
		...
		lostHelper: 
			'La licencia alcanzó el máximo de reintentos. Sincronícela manualmente para activar funciones Pro.',
		exceptionalHelper: 
		...
		setting: 
			'Actualizar a Pro permite personalizar logo, mensaje de bienvenida y más.',
		monitor: 
			'Pro permite ver estado web en tiempo real, tendencias, logs, etc.',
	...
	clean: {
		...
		systemHelper: 
			'Archivos temporales de instantáneas, actualizaciones, archivos obsoletos, etc.',
		...
		systemLogHelper: 
			'Logs del sistema, construcción de contenedores, pulls, tareas programadas',
	...
	app: {
		...
		forceDeleteHelper: 
			'Forzar ignorará errores y eliminará la metadata.',
		...
		downloadLogHelper2: 
			'Se descargarán los últimos {1} logs de la app {0}. ¿Desea continuar?',
		syncAllAppHelper: 'Se sincronizarán todas las aplicaciones. ¿Desea continuar?',
		hostModeHelper: 
			'El modo de red es host. Si necesita abrir el puerto, hágalo manualmente en el firewall.',
		showLocal: 'Mostrar apps locales',
		reload: 'Recargar',
		upgradeWarn: 
			'Actualizar reemplazará docker-compose.yml. Si hay cambios, puede ver la comparación.',
		...
		diffHelper: 
			'Izquierda: versión vieja, Derecha: nueva. Edite y guarde la versión personalizada.',
		...
		specifyIPHelper: 
			'Establece la dirección/red del host para el puerto (si no sabe, no rellene)',
	...
	website: {
		...
		forceDelete: 'Forzar eliminación',
		forceDeleteHelper:
			'La eliminación forzada ignorará errores y eliminará metadatos igualmente.',
		...
		stopHelper:
			'Al detener el sitio, no será accesible y mostrará una página de parada. ¿Deseas continuar?',
		startHelper:
			'Al habilitar el sitio, los usuarios podrán acceder normalmente. ¿Deseas continuar?',
		sitePath: 'Directorio',
		...
		disableHTTPSHelper:
			'Desactivar HTTPS eliminará la configuración del certificado. ¿Quieres continuar?',
		SSLHelper:
		...
		runtime: 'Runtime',
		deleteRuntimeHelper:
			'El runtime debe eliminarse junto con el sitio. Hazlo con precaución.',
		...
		current: 'Actual',
		rewriteHelper:
			'Si el pseudoestático causa inaccesibilidad, restaura la configuración predeterminada.',
		...
		modifierHelper:
			'Ejemplo: "=" coincidencia exacta, "~" regex, "^~" inicio de ruta.',
		...
		websiteBackupWarn:
			'Solo se admiten backups locales. Los de otras máquinas pueden fallar en la restauración',
		...
		hstsIncludeSubDomainsHelper:
			'Al habilitarlo, la política HSTS aplicará también a los subdominios.',
		...
		ipHash: 'IP Hash',
		ipHashHelper:
			'Asigna al mismo servidor las peticiones de un cliente según su IP.',
		...
		ipFrom: 'Origen de IP',
		ipFromHelper:
			'Definiendo orígenes confiables, OpenResty analizará cabeceras HTTP para identificar la IP real.',
		ipFromExample1: 'Si el frontend es Frp: 127.0.0.1',
		ipFromExample2: 'Si el frontend es un CDN: rango IP del CDN',
		ipFromExample3:
			'En caso de duda: 0.0.0.0/0 (IPv4) ::/0 (IPv6) [Nota: poco seguro]',
		http3Helper:
			'HTTP/3 ofrece mayor velocidad y rendimiento, pero no todos los navegadores lo soportan.',
		...
		loadBalanceHelper:
			'Tras crear balanceo, ve a "Proxy inverso" y añade un backend: http://<nombre balanceo>',
		favorite: 'Favorito',
		...
		openBaseDirHelper:
			'open_basedir restringe rutas accesibles por PHP, protegiendo contra accesos cruzados',
		serverCacheTime: 'Tiempo de caché en servidor',
		serverCacheTimeHelper:
			'Durante este tiempo, peticiones idénticas devuelven caché sin ir al backend.',
	...
	nginx: {
		...
		build: 'Compilar',
		buildWarn: 
			'Compilar OpenResty requiere reservar CPU y memoria, puede tomar tiempo, ten paciencia',
	...
	ssl: {
		...
		renewWebsite: 
			'Este certificado está asociado a los siguientes sitios y se aplicará en ellos simultáneamente',
		...
		dir: 'Directorio',
		pushDirHelper: 
			'Se generarán los archivos "fullchain.pem" y "privkey.pem" en este directorio.',
		organizationDetail: 'Detalles de la organización',
		fromWebsite: 'Desde el sitio web',
		dnsMauanlHelper: 
			'En modo manual, haz clic en solicitar tras la creación para obtener el valor DNS',
		httpHelper: 
			'El modo HTTP requiere OpenResty instalado y no soporta certificados comodín.',
		...
		deprecatedHelper: 
			'El soporte se ha detenido y puede eliminarse en el futuro. Usa el método Tencent Cloud.',
	...
	runtime: {
		...
		runScriptHelper: 'La lista de comandos de inicio se obtiene desde el archivo package.json en el directorio fuente.',
		open: 'Abrir',
		operatorHelper:
			'La operación {0} se ejecutará sobre el entorno de ejecución seleccionado. ¿Deseas continuar?',
		taobao: 'Taobao',
		tencent: 'Tencent',
		...
		systemRestartHelper: 'Descripción de estado: Interrupción - fallo al obtener estado debido a reinicio del sistema',
		javaScriptHelper: 'Proporciona un comando de inicio completo. Ejemplo: "java -jar halo.jar -Xmx1024M -Xms256M".',
		...
		phpConfigHelper:
			'Modificar la configuración requiere reiniciar el entorno de ejecución, ¿quieres continuar?',
	...
	tool: {
		supervisor: {
			...
			notSupport: 'Servicio Supervisor no detectado, ve a la página de librería de scripts para instalarlo manualmente',
	...
	xpack: {
		...
		app: {
			...
			apiInterfaceHelper:
				'Permite acceso a la API del panel (debe estar habilitada para la APP)',
			apiInterfaceHelper1:
		...
		waf: {
			...
			notFoundHelper:
				'Si el número de errores 404 supera {1} en {0} segundos, la IP será bloqueada por {2}',
			...
			geoHelper:
				'Restringe accesos desde ciertas regiones. Ejemplo: permitir solo China, bloqueando el resto',
			...
			ipGroupHelper:
				'Una IP o rango por línea. Soporta IPv4 e IPv6. Ejemplo: 192.168.1.1 o 192.168.1.0/24',
			...
			initHelper:
				'La inicialización borrará la configuración existente del WAF. ¿Seguro que quieres continuar?',
			...
			expiryDateHelper:
				'Tras validación exitosa, no se verificará de nuevo durante el periodo de validez',
			...
			uriMode: 'Modo URL',
			globalHelper:
				'Modo global: cuando el total de peticiones a cualquier URL supera el límite en el periodo',
			uriModeHelper:
				'Modo URL: cuando las peticiones a una URL superan el límite en el periodo',
			ip: 'Blacklist de IPs',
			globalSettingHelper:
				'Las configuraciones con etiqueta [Website] requieren activarse también en la Configuración del Sitio',
			globalSettingHelper2:
				'Debe habilitarse en [Configuración Global] y [Configuración del Sitio] a la vez',
			...
			appRuleHelper:
				'Reglas de apps comunes, reduce falsos positivos. Un sitio solo puede usar una regla',
		...
		monitor: {
			...
			xffHelper:
				'Ejemplo: X-Forwarded-For: <cliente>,<proxy1>,<proxy2>,<proxy3>. El último proxy es <proxy3>',
			headersHelper:
				'Obtiene la IP real de cabeceras comunes de CDN, tomando la primera disponible',
			monitorCDNHelper:
				'Modificar la config de CDN en monitorización también actualiza la del WAF',
		...
		tamper: {
			...
			disableHelper:
				'La protección contra manipulación se desactivará en los siguientes sitios. ¿Continuar?',
		...
		helper: {
			...
			tamperContent2: 'Detecta archivos anómalos o manipulados escaneando en tiempo real el sistema de archivos del sitio.',
		...
		node: {
			...
			nodeUnhealthyHelper: 'Se ha detectado un estado anómalo en el nodo. Revisa [Gestión de Nodos] e inténtalo de nuevo.',
			...
			syncHelper: 'Cuando cambian los datos en el nodo principal, se sincronizan en tiempo real con este nodo secundario.',
			...
			fixStatus: 'Ejecuta "systemctl status 1panel-agent.service" para verificar si el servicio está en ejecución.',
			...
			uninstallHelper: 'Esto eliminará todos los datos relacionados con 1Panel de este nodo. Procede con precaución.',
			baseDir: 'Directorio de Instalación',
			baseDirHelper:
				'Si el directorio de instalación está vacío, se instalará en /opt por defecto.',
		...
		alert: {
			...
			panelPwdEndTimeRulesHelper: 'La alerta de expiración de contraseña no aplica si no se ha configurado expiración',
			...
			changeStatus: 'Cambiar estado',
			disableMsg:
				'Detener la tarea de alerta evitará que envíe mensajes. ¿Continuar?',
			...
			agentOfflineAlertHelper:
				'Con alerta offline habilitada, el nodo maestro escaneará cada 30 minutos.',
			offline: 'Alerta offline',
			offlineHelper:
				'En modo offline, el nodo maestro escaneará cada 30 minutos para alertas.',
			offlineOff: 'Habilitar alerta offline',
			offlineOffHelper:
				'Habilitar alerta offline hace que el nodo maestro ejecute alertas cada 30 minutos.',
			offlineClose: 'Desactivar alerta offline',
			offlineCloseHelper:
				'Desactivarla obliga a que los sub-nodos gestionen alertas. Asegura conectividad.',
			...
			ipWhiteListHelper:
				'Las IPs en whitelist no tienen restricciones ni generan alerta en login exitoso',
		...
		theme: {
			...
			setDefaultHelper:
				'La paleta de colores volverá al estado inicial. ¿Continuar?',
