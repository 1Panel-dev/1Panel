...
const message = {
    ...
    aiTools: {
        ...
        aiProxy: {
            ...
            defaultTokenLimit: 'Límite de tokens predeterminado',
        ...
        skillsHub: {
            ...
            containerNameRequired: 'Los destinos en contenedor requieren un nombre de contenedor.',
            deleteTargetConfirm:
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scorePasswordExpired: 'La contraseña del panel ha expirado',
                scorePasswordExpiring: 'La contraseña del panel expira en {0} días',
                ...
                assetResourceDesc: '{0} aplicaciones anómalas, {1} aplicaciones detenidas, {2} contenedores anómalos',
