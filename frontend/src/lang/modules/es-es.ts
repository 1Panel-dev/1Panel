...
const message = {
    ...
    toolbox: {
        ...
        clam: {
            ...
            cronHelper: 'Business admite escaneos programados',
            ...
            alertHelper: 'Business admite escaneos programados y alertas por SMS',
    ...
    file: {
        ...
        aiSearchContainSub: 'Incluir subdirectorios',
    ...
    setting: {
        ...
        proxyHelper4:
            'Las solicitudes de red, como la descarga de imágenes de Docker, pasarán por el servidor proxy (solo Business)',
        proxyHelper5: 'Descarga y sincronización unificadas de bibliotecas de scripts del sistema (función Business)',
        proxyHelper6: 'Solicitud de certificado (función Business)',
    ...
    license: {
        ...
        import: 'Importar',
        power: 'Autorizar',
        unbindHelper: 'Se eliminarán todos los ajustes Business tras desvincular. ¿Desea continuar?',
        importLicense: 'Importar licencia',
        importHelper: 'Haga clic o arrastre el archivo de licencia aquí',
        levelUpPro: 'Actualizar a la edición Business',
        licenseSync: 'Sincronizar licencia',
        knowMorePro: 'Conocer Business',
        closeAlert: 'Puede cerrar la página en la configuración del panel',
        introduce: 'Introducción de funciones',
        waf: 'Actualizar a Business permite interceptación, logs, geobloqueo, reglas, páginas personalizadas, etc.',
        tamper: 'Actualizar a Business protege sitios ante modificaciones no autorizadas.',
        tamperHelper:
            'La operación falló, el archivo/carpeta tiene protección antimanipulación. Revise e intente de nuevo.',
        setting: 'Actualizar a Business permite personalizar logo, mensaje de bienvenida y más.',
        monitor: 'Business permite ver estado web en tiempo real, tendencias, logs, etc.',
        alert: 'Business permite recibir alertas SMS y ver logs, control total de eventos clave.',
        node: 'Actualizar a la edición Business permite administrar varios servidores Linux con 1Panel.',
        nodeApp:
            'Actualizar a la edición Business permite actualizar versiones de aplicaciones multinodo sin cambiar de nodo manualmente.',
        nodeDashboard:
    ...
    xpack: {
        expiresTrialAlert:
            'Aviso: Tu prueba de Business expirará en {0} días y todas las funciones Business dejarán de estar disponibles. Renueva o actualiza a la versión completa a tiempo.',
        expiresAlert:
            'Aviso: Tu licencia Business expirará en {0} días y todas las funciones Business dejarán de estar disponibles. Renueva pronto para asegurar el uso continuo.',
        menu: 'Business',
        upage: 'Constructor Web con IA',
        proAlert: 'Actualiza a Business para usar esta función',
        app: {
            app: 'APP',
            title: 'Alias del Panel',
        ...
        node: {
            ...
            syncWithMaster:
                'Tras actualizar a Business, todos los datos se sincronizarán por defecto. Las políticas de sincronización se pueden ajustar manualmente en la gestión de nodos.',
        ...
        customApp: {
            ...
            selectNode: 'Seleccionar Nodo',
            selectNodeError: 'Por favor, selecciona un nodo',
            licenseHelper: 'La versión Business admite la función de repositorio de aplicaciones personalizadas',
        ...
        alert: {
            ...
            licenseHelper: 'La versión Business soporta alertas',
            ...
            alertConfigProHelper: 'La edición Business también admite alertas mediante WeCom, DingTalk, Feishu y SMS.',
        },
        theme: {
