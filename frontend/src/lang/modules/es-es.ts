...
const message = {
    apiKeyManagement: {
        ...
        bindingKey: 'Clave de vinculación',
    ...
    commons: {
        ...
        rule: {
            ...
            vmName: 'Admite letras inglesas, números, ".", "-" y "_"; longitud de 1 a 64; debe comenzar con una letra o un número.',
            vmNetwork:
                'Admite letras inglesas, números, ".", ":", "-" y "_"; longitud de 1 a 64; debe comenzar con una letra o un número.',
        ...
        log: {
            noLog: 'No hay registros disponibles',
        },
    },
    menu: {
        home: 'Panel',
    ...
    home: {
        ...
        loadAverage: 'Promedio de carga en el último minuto | Promedio de carga en los últimos {0} minutos',
        load: 'Carga',
    ...
    database: {
        ...
        deleteUserHelper: '" para eliminar este usuario',
    ...
    aiTools: {
        agents: {
            ...
            modelMetadata: 'Capacidades del modelo',
            modelMetadataHelper:
                'Estos ajustes solo se aplican a esta instancia de OpenClaw. Déjelos vacíos para usar los valores predeterminados de OpenClaw o del proveedor.',
            inputModeAuto: 'Detectar automáticamente',
            inputModeText: 'Solo texto',
            inputModeImage: 'Texto e imágenes',
            contextWindow: 'Ventana de contexto',
            useModelDefault: 'Usar valor predeterminado del modelo',
            ...
            roleMarkdownDescriptions: {
                ...
                'TOOLS.md': ['Notas sobre las herramientas locales y las convenciones.'],
                'HEARTBEAT.md': [
        ...
        aiProxy: {
            ...
            keepCurrentValidity: 'Mantener la validez actual',
            neverExpires: 'Nunca caduca',
            validForDays: 'Válido durante {0} días',
            customDays: 'Días personalizados',
            enterValidityDays: 'Introduzca el periodo de validez en días',
            currentExpiresAt: 'Caducidad actual: {0}',
            currentNeverExpires: 'Actualmente no caduca',
            ...
            protocolConversionRisk:
                'La conversión de protocolos no es sin pérdidas. Los campos específicos, las llamadas a herramientas, el razonamiento o el contenido multimodal pueden degradarse o perderse. Úsela después de evaluar los riesgos.',
            visionEnhancement: 'Mejora visual',
            visionEnhancementRisk:
                'La mejora visual puede enviar imágenes a un proveedor de modelos visuales independiente.',
            visionModelGroup: 'Grupo de modelos visuales',
            visionModelGroupDesc:
                'Seleccione en este grupo de generación de texto un modelo que comprenda imágenes. Todas las imágenes de una solicitud usan el mismo modelo.',
            visionTargetModelGroup: 'Grupo de modelos de destino',
            visionTargetModelGroupDesc:
                'Activa la mejora solo para modelos de este grupo sin cambiar el modelo final de la solicitud.',
            visionEnhancementDesc:
                'Las imágenes se convierten en evidencia de texto y pueden perder detalles, aumentando la latencia y el coste. El gateway no detecta compatibilidad visual nativa. Guardar reinicia el gateway; úselo después de evaluar los riesgos.',
            ...
            upstreamDuration: 'Tiempo upstream',
            ...
            actionAuditOnly: 'Solo auditar',
            actionDropHistory: 'Eliminar historial',
            severity: 'Gravedad',
            severityHigh: 'Alta',
            severityMedium: 'Media',
            severityLow: 'Baja',
            sensitiveWord: 'Palabra sensible',
            sensitiveGroup: 'Grupo de palabras sensibles',
            sensitiveWordCount: 'Palabras',
            normalizedWord: 'Palabra normalizada',
            matchedWords: 'Palabras coincidentes',
            matchedGroups: 'Grupos coincidentes',
        ...
        mcp: {
            ...
            protocolVersionHelper:
                'Solo se utiliza con Streamable HTTP sin estado para inicializar automáticamente el servidor MCP stdio descendente',
            gatewayArgsHelper:
    ...
    container: {
        ...
        cleanLogscope: 'Tipo de limpieza',
        cleanLog: 'Limpiar logs',
        downLogHelper1: 'Esto descargará todos los logs del contenedor {0}. ¿Desea continuar?',
        downLogHelper2: 'Esto descargará los últimos {1} logs del contenedor {0}. ¿Desea continuar?',
        ...
        imagePush: 'Subir',
        imagePushHelper:
            'Se detectó que esta imagen tiene varias etiquetas. Confirme que el nombre de imagen utilizado para enviarla es: {0}',
        ...
        mirrorsHelper:
            'Utilice primero las URL de los mirrors del registro para las operaciones con imágenes. Déjelo vacío para desactivar los mirrors del registro.',
    ...
    logs: {
        ...
        detail: {
            ...
            ops_report: 'Informe de operaciones',
    ...
    file: {
        ...
        shareExpire: 'Caduca en',
        shareExpire1h: '1 hora',
        shareExpire6h: '6 horas',
        shareExpire24h: '24 horas',
        shareExpire3d: '3 días',
        shareExpire7d: '7 días',
        sharePassword: 'Contraseña',
        sharePasswordPlaceholder: 'Déjelo vacío para no usar contraseña',
        shareMaxDownloads: 'Descargas máximas',
        shareMaxDownloadsHint: '0 significa sin límite',
        shareGenerate: 'Crear enlace',
        shareRegenerate: 'Volver a compartir',
        shareClose: 'Cerrar',
        shareCancel: 'Cancelar uso compartido',
        shareCancelConfirm: '¿Seguro que quieres cancelar este uso compartido de archivo?',
        shareDetail: 'Detalles',
        shareCopyLink: 'Copiar enlace',
        shareLinkLabel: 'Enlace compartido',
        shareQrCode: 'Código QR',
        shareQrDialogTitle: 'Código QR del enlace compartido',
        shareQrDialogHelper: 'Escanee este código QR con su dispositivo móvil',
        shareSaveImage: 'Guardar imagen',
        shareOpenImage: 'Abrir imagen',
        shareExtractFile: 'Extraer archivo',
        shareDownloadingHint: 'Preparando el archivo; la descarga comenzará en breve.',
        shareInvalid: 'El enlace compartido no es válido o ha caducado',
        shareDownloadFailed: 'La descarga falló; inténtelo de nuevo más tarde',
        sharePasswordRequired: 'Contraseña',
        sharePasswordRequiredInput: 'Introduzca la contraseña del enlace compartido',
        sharePasswordLengthHint: 'La contraseña debe tener entre 4 y 256 caracteres',
        shareDownloadPasswordTip:
            'Este enlace está protegido con contraseña. Introduzca la contraseña antes de descargar.',
        shareRiskAlert:
            'Los enlaces compartidos pueden conllevar riesgos de seguridad. Compártalos solo con personas de confianza y evite exponer información sensible.',
        sharePasswordSeparate:
            'Se ha establecido una contraseña. Compártala de forma segura. Los destinatarios deben añadir &password=... a la URL o usar un cliente que admita el parámetro de consulta de contraseña.',
    ...
    license: {
        ...
        vllm: 'Actualiza a la edición comercial para gestionar servicios vLLM en 1Panel con despliegue, configuración, operaciones del ciclo de vida y seguimiento de tareas centralizados.',
        'model-downloader':
    ...
    website: {
        ...
        ipHashBackupErr: 'IP hash no admite nodos de respaldo',
        ...
        shareCache: 'Tamaño de memoria para conteo de caché',
        cacheExpire: 'Expiración de caché',
        shareCacheHelper: '1M de memoria almacena aprox. 8000 objetos',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scoreWebsiteMonitorAvailability:
                    'La disponibilidad de solicitudes del monitoreo web ({0}%) está por debajo del umbral',
                ...
                waf: 'WAF',
                siteAvailability: 'Disponibilidad de las solicitudes',
                ...
                serviceEnabledButAbnormal: 'Habilitado, pero en estado anómalo',
                ...
                disabledCronjobTasks: 'Tareas programadas deshabilitadas',
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    accessMode: 'Modo de conexión',
                    accessModeDesc: 'Usar Discovery estándar siempre que el proveedor de identidad lo admita.',
                    actionCreate: 'Crear usuario',
                    actionKeepName: 'Mantener el nombre actual',
                    actionPending: 'Esperando resultado',
                    actionReject: 'Rechazar inicio de sesión',
                    actionUpdate: 'Actualizar información de identidad',
                    advanced: 'Configuración avanzada',
                    advancedDesc:
                        'Mantener los valores predeterminados seguros a menos que el proveedor requiera una opción de compatibilidad.',
                    assignDefaultRole: 'Asignar rol predeterminado: {role}',
                    authorizationEndpoint: 'Authorization Endpoint',
                    authorizationEndpointInvalid: 'Ingrese un Authorization Endpoint válido.',
                    authorizationFlow: 'Flujo de autorización',
                    automatic: 'Automático',
                    automaticPolicy: 'Política de manejo automático',
                    automaticPolicyDesc: 'Estas reglas las aplica el backend y no son conmutadores de administrador.',
                    basic: 'Configuración básica',
                    basicDesc:
                        'Seleccione el modo de proveedor, luego configure el cliente y la devolución de llamada.',
                    browserTest: 'Prueba de inicio de sesión en el navegador',
                    ...
                    browserTestTitle: 'Inicio de sesión de prueba del navegador OIDC',
                    ...
                    callbackCopied: 'URL de devolución de llamada OIDC copiada.',
                    callbackURL: 'URL de devolución de llamada',
                    callbackURLHelper:
                        'Añada esta URL a las URL de retorno permitidas del cliente en el proveedor de identidad.',
                    cancelClearSecret: 'Cancelar limpieza',
                    clearSecret: 'Borrar secreto',
                    clearSecretConfirm: 'El Client Secret se eliminará solo después de guardar. ¿Continuar?',
                    clientAuthMethod: 'Método de autenticación del cliente',
                    clientAuthMethodHelper:
                        'Seleccione el método de autenticación configurado para este cliente en el proveedor de identidad.',
                    clientAuthMethodRequired: 'Seleccione un método de autenticación del cliente.',
                    clientID: 'Client ID',
                    clientIDRequired: 'Ingrese el Client ID.',
                    clientSecret: 'Client Secret',
                    clockSkew: 'Tolerancia de tiempo del token',
                    clockSkewHelper:
                        'Permite una pequeña diferencia horaria entre el proveedor de identidad y 1Panel. Mantenga el valor predeterminado de 60 segundos.',
                    clockSkewRequired: 'Ingrese la tolerancia de tiempo del token.',
                    compatibilityMode: 'Modo de compatibilidad',
                    compatibilityModeHelper:
                        'Úselo solo para Discovery incompleto o puntos finales reescritos. La validación principal de OIDC permanece habilitada.',
                    configurationFailedHelper:
                        'La prueba falló. La página solo muestra el error de backend localizado.',
                    configurationFailedTag: 'Prueba fallida',
                    configurationHighRiskPassed:
                        'La configuración fue aprobada, pero contiene opciones de compatibilidad de alto riesgo.',
                    configurationHighRiskTag: 'Configuración de alto riesgo aprobada',
                    configurationNotTested: 'La configuración actual no se ha probado.',
                    configurationNotTestedTag: 'No probado',
                    configurationPassed: 'La configuración actual pasó las comprobaciones de seguridad y capacidad.',
                    configurationPassedTag: 'Prueba aprobada',
                    configurationStaleHelper: 'La configuración se modificó. Vuelva a probarla antes de guardar.',
                    configurationStaleTag: 'Resultado caducado',
                    configurationTestMeta:
                        'Probado el {time}; completado en {duration} ms. Las respuestas sin procesar del proveedor no se almacenan.',
                    configurationTestResult: 'Resultado de la prueba de configuración',
                    configurationTestResultDesc:
                        'Esto verifica Discovery y sus capacidades únicamente; no intercambia un código de autorización ni prueba el Client Secret. Utilice el inicio de sesión de prueba del navegador para la verificación de un extremo a otro.',
                    configurationTestSuccess: 'La prueba de configuración del OIDC fue exitosa.',
                    configurationTesting: 'Probando la configuración actual del OIDC…',
                    configurationTestingTag: 'Probando',
                    configureSecret: 'Configurar secreto',
                    conflictExistingRename:
                        'Un subject vinculado devuelve un nombre de usuario nuevo que ya está ocupado',
                    conflictExistingRenameResult:
                        'Mantenga el User.Name existente y permita que el usuario vinculado inicie sesión',
                    conflictLDAP: 'Usuario LDAP',
                    conflictLocal: 'Usuario local',
                    conflictNewAvailable: 'El subject nuevo y el nombre de usuario asignado están disponibles',
                    conflictNewAvailableResult: 'Cree un usuario empresarial y asigne el rol predeterminado',
                    conflictNone: 'Sin conflicto',
                    conflictOIDC: 'Otra identidad OIDC',
                    conflictOccupied:
                        'El nombre de usuario asignado pertenece a un usuario local, LDAP u otra identidad OIDC',
                    conflictOccupiedResult: 'Rechazar la nueva identidad; nunca se vincule ni fusione automáticamente',
                    conflictType: 'Tipo de conflicto',
                    connectionSecurity: 'Seguridad de la conexión',
                    connectionSecurityDesc:
                        'La política TLS se aplica a las solicitudes Discovery, Token, JWKS y UserInfo.',
                    connectionTest: 'Prueba de conexión y configuración',
                    connectionTestCompatibilityDesc:
                        'Valide los endpoints personalizados y la política de seguridad del protocolo.',
                    connectionTestStandardDesc:
                        'Los puntos finales y las capacidades se descubren automáticamente desde el Issuer.',
                    connectionTestTab: 'Prueba de conexión',
                    customCA: 'CA personalizada',
                    customCAHelper:
                        'Se aplica solo a esta fuente de autenticación y nunca se escribe en los registros.',
                    customCARequired: 'Proporcione el certificado de la CA personalizada.',
                    defaultRole: 'Rol predeterminado',
                    defaultRoleHelper:
                        'Se asigna solo al crear el usuario por primera vez; los siguientes inicios de sesión no cambian el rol.',
                    defaultRolePlaceholder: 'Seleccione un rol',
                    defaultRoleRequired: 'Seleccione un rol predeterminado válido.',
                    disableAfterSave: 'OIDC se deshabilitará después de guardar.',
                    disableConfirm:
                        'Deshabilitar OIDC inmediatamente invalida el acceso de los usuarios de esta fuente. ¿Continuar?',
                    disableDiscardConfirm:
                        'Desactivar OIDC es una acción de emergencia: solo cierra la entrada de inicio de sesión e inmediatamente invalida el acceso de los usuarios de esta fuente. Se descartarán otros cambios no guardados en esta página, incluidos los cambios Client Secret. ¿Continuar?',
                    disableTitle: 'Desactivar OIDC',
                    disabled: 'Desactivado',
                    discoveryAllowlist: 'Lista segura de Discovery',
                    enable: 'Activar',
                    enableAfterSave: 'OIDC se habilitará después de guardar correctamente.',
                    enabled: 'Activado',
                    endSessionEndpoint: 'End Session Endpoint',
                    endSessionEndpointHelper:
                        'Se guarda para uso futuro; el cierre de sesión iniciado por el proveedor no está incluido en esta versión.',
                    endSessionEndpointInvalid: 'Ingrese un End Session Endpoint válido.',
                    endpointDiscoveryPlaceholder: 'Se muestra después de probar la conexión',
                    firstLogin: 'Primer inicio de sesión',
                    firstLoginPolicy: 'Cree un usuario empresarial local y asigne el rol predeterminado configurado.',
                    fixedAuthorizationCode: 'Authorization Code Flow',
                    fixedNoTokenPersistence: 'Token, Claims y verifier nunca persisten',
                    fixedSecurityPolicy: 'Siempre se aplican; no se requiere configuración',
                    fixedStateNonce: 'state y nonce por única vez',
                    fixedTokenValidation: 'Firma ID Token y validación de Claims',
                    highRiskSaveConfirm:
                        'Esta configuración habilitada contiene opciones de compatibilidad de alto riesgo. Confirme que el entorno aislado los requiere.',
                    highRiskTitle: 'Configuración de OIDC de alto riesgo',
                    hs256Compatibility: 'HS256 (compatibilidad)',
                    hs256KeyHelper:
                        'HS256 siempre usa el Client Secret de esta fuente y no admite una clave de firma separada.',
                    hs256Warning:
                    ...
                    issuerInvalid: 'Ingrese un valor válido HTTP o HTTPS Issuer URL sin consulta ni fragmento.',
                    issuerRequired: 'Ingrese el Issuer URL.',
                    jwksRotation: 'Rotación automática de JWKS',
                    jwksURI: 'JWKS URI',
                    jwksURIHelper: 'Requerido para la firma asimétrica cuando la fuente de clave es JWKS.',
                    jwksURIInvalid: 'Ingrese un JWKS URI válido para la fuente de clave de firma seleccionada.',
                    keepExistingRole: 'Mantener los roles y permisos locales existentes',
                    localSecurityData: 'Datos de seguridad locales',
                    localSecurityDataPolicy: 'Nunca sobrescriba roles, MFA, API Keys, Passkeys o permisos locales.',
                    localCredentialsManaged:
                        'El nombre de usuario y la contraseña local se administran mediante OIDC y no se pueden editar aquí. Los roles, permisos, MFA, API Keys y Passkeys permanecen locales.',
                    localUserFields: 'Campos de usuario locales',
                    localUserFieldsDesc:
                        'La primera versión asigna solo User.Name y no utiliza una expresión de asignación JSON.',
                    loginWith: 'Iniciar sesión con {provider}',
                    manualEndpoints: 'Endpoints personalizados',
                    manualEndpointsDesc:
                        'Úselo solo cuando Discovery esté incompleto o una puerta de enlace ascendente reescriba los endpoints.',
                    mappingResult: 'Resultado de la asignación',
                    mode: 'Modo de conexión',
                    modeRequired: 'Seleccione un modo de conexión.',
                    nameClaim: 'Claim de nombre de usuario',
                    nameClaimHelper: 'Introduzca el campo que contiene el nombre de usuario, como preferred_username.',
                    nameClaimRequired: 'Introduzca el Claim del nombre de usuario.',
                    nameConflict: 'Política de conflicto de nombres',
                    panelURL: 'URL pública de 1Panel',
                    panelURLHTTPWarning:
                        'HTTP no protege la respuesta de autorización. Úselo solo en un entorno privado aislado aceptado por el proveedor.',
                    panelURLHelper:
                        'Introduzca la dirección que usan los usuarios para acceder a 1Panel. Se utiliza para generar la URL de retorno.',
                    panelURLInvalid: 'Ingrese un origen que contenga solo esquema, host y puerto opcional.',
                    panelURLRequired: 'Introduzca la URL pública de 1Panel.',
                    pkceDisabled: 'Deshabilitado (solo compatibilidad)',
                    pkceDisabledWarning:
                        'Deshabilitar PKCE reduce la protección contra la interceptación de códigos de autorización.',
                    pkceHelper: 'Prefiere S256. El método de desafío plain nunca se ofrece.',
                    pkceS256: 'S256 (recomendado)',
                    plannedHandling: 'Manejo planificado',
                    privateNetworkIdP: 'IdP de red privada',
                    privateNetworkIdPHelper:
                        'Permite explícitamente direcciones privadas; las direcciones de metadatos, loopback y link-local, las redirecciones y el rebinding DNS permanecen bloqueados.',
                    privateNetworkWarning:
                        'El acceso a la red privada está habilitado para esta fuente de autenticación.',
                    protocolCompatibility: 'Compatibilidad de protocolo',
                    protocolCompatibilityDesc: 'La validación de la firma del ID Token no se puede deshabilitar.',
                    providerAndClient: 'Proveedor y cliente',
                    providerAndClientDesc:
                        'El Client Secret solo se puede reemplazar o borrar y la página nunca lo devuelve.',
                    providerCapabilities: 'Capacidades del proveedor',
                    recentTestSuccess: 'Última prueba correcta: {0}',
                    recommended: 'Recomendado',
                    rejectPlain: 'plain rechazado',
                    replaceSecret: 'Reemplazar secreto',
                    requestAndClaims: 'Solicitudes y atributos',
                    requestAndClaimsDesc:
                        'Configure los alcances de autorización, la información de usuario complementaria y los parámetros de solicitud.',
                    requestTimeout: 'Tiempo de espera de solicitud',
                    requestTimeoutRequired: 'Ingrese el tiempo de espera de solicitud.',
                    restore: 'Restaurar',
                    restored: 'Se restauró la última configuración de OIDC guardada.',
                    result: 'Resultado',
                    rolesLoadFailed:
                    ...
                    scenario: 'Escenario',
                    scopes: 'Alcances de autorización',
                    scopesHelper: 'Debe incluir openid. Separe varios alcances con espacios.',
                    scopesRequired: 'Scopes debe incluir openid.',
                    seconds: 'segundos',
                    secretClearHelper:
                        'Después de borrarlo, se requiere un Client Secret nuevo para volver a habilitar OIDC.',
                    secretConfigured: 'Configurado',
                    secretNotConfigured: 'No configurado',
                    secretPlaceholder: 'Ingrese un nuevo Client Secret',
                    secretReplaceHelper:
                        'El nuevo secreto sustituirá el valor guardado al guardar. Actualice también el Client Secret en el Provider OIDC.',
                    secretRequiredHelper: 'Configure un Client Secret antes de habilitar OIDC.',
                    secretRequiredToEnable: 'Configure un Client Secret antes de habilitar OIDC.',
                    secretSavedHelper: 'Se almacena cifrado. Deje el campo vacío para conservar el secreto actual.',
                    secretWaiting: 'Esperando entrada',
                    secretWillClear: 'Se borrará',
                    secretWillReplace: 'Será reemplazado',
                    signingAlgorithm: 'Algoritmo de firma ID Token',
                    signingAlgorithmHelper:
                        'Solo están disponibles los algoritmos de la lista de seguridad de backend.',
                    signingKey: 'Clave de firma',
                    signingKeyClientSecret: 'Client Secret (solo HS256)',
                    signingKeyJWKS: 'JWKS URI con rotación automática',
                    signingKeySource: 'Fuente de clave de firma',
                    signingKeySourceHelper: 'Prefiere JWKS. Una clave pública estática no puede rotar automáticamente.',
                    signingKeyStatic: 'Clave pública JWK o PEM estática',
                    standardDiscovery: 'OIDC Discovery estándar',
                    standardDiscoveryDesc:
                        '1Panel descubre los endpoints y las capacidades, pero no almacena el documento sin procesar.',
                    standardMode: 'Modo estándar',
                    standardModeHelper:
                        'Descubra puntos finales, capacidades de firma y compatibilidad con PKCE del Issuer.',
                    standardProtocolPolicy: 'Política de protocolo estándar',
                    standardProtocolPolicyDesc:
                        'Las capacidades de firma se negocian automáticamente; aquí no se ingresa ninguna clave de firma.',
                    staticSigningKey: 'Clave pública de firma estática',
                    staticSigningKeyHelper:
                        'Solo se acepta material de clave pública. Rótela manualmente cuando cambie la clave del proveedor.',
                    staticSigningKeyPlaceholder: 'Pegue una clave pública JWK, JWKS JSON o PEM',
                    staticSigningKeyRequired: 'Proporcione la clave pública de firma estática.',
                    staticSigningKeyWarning:
                        'Una clave de firma estática no puede rotar automáticamente; actualícela antes de que el proveedor rote sus claves.',
                    settingLoadFailed: 'La configuración del OIDC no se pudo cargar',
                    ...
                    subsequentLogin: 'Inicio de sesión posterior',
                    subsequentLoginPolicy:
                        'Busque el vínculo por subject y actualice User.Name solo cuando el nombre nuevo esté disponible.',
                    testBeforeBrowserTest:
                        'Pruebe la configuración actual antes de iniciar la prueba de inicio de sesión en el navegador.',
                    testBeforeEnable: 'Prueba la configuración actual antes de guardar los cambios de configuración.',
                    testConfiguration: 'Probar configuración',
                    testDiscovery: 'Probar Discovery',
                    tlsCustomCA: 'HTTPS · Certificado CA personalizado',
                    tlsPrivateHTTP: 'HTTP · Solo red privada (peligroso)',
                    tlsPrivateHTTPWarning:
                        'HTTP no proporciona cifrado de transporte y está restringido a objetivos privados permitidos explícitamente.',
                    tlsSkipVerify: 'HTTPS · Omitir verificación de certificado (peligroso)',
                    tlsSystem: 'HTTPS · Verificación del certificado del sistema (recomendado)',
                    tokenEndpoint: 'Token Endpoint',
                    tokenEndpointInvalid: 'Ingrese un Token Endpoint válido.',
                    transportSecurity: 'Seguridad en el transporte',
                    transportSecurityHelper:
                        'Se recomienda HTTPS. El HTTP privado también requiere permitir explícitamente el acceso a la red privada.',
                    unsavedChanges: 'Hay cambios de OIDC sin guardar.',
                    usedClaim: 'Claim usado',
                    userInfoEndpoint: 'UserInfo Endpoint',
                    userInfoEndpointHelper:
                        'Si falta el campo de nombre de usuario, el sistema lo obtiene de este endpoint. Déjelo vacío para omitir el complemento.',
        ...
        node: {
            ...
            dashboardSetting: 'Configuración del resumen',
            keepOneDashboardComponent: 'Mantenga al menos una sección del resumen',
        ...
        alert: {
            ...
            alertTriggerMode: 'Notificar cuando',
            alertTriggerFailed: 'Solo falle',
            alertTriggerSuccess: 'Solo tenga éxito',
            alertTriggerBoth: 'Tenga éxito o falle',
            alertNotificationHelper:
                'Notificar al finalizar la ejecución, no durante los reintentos. Las notificaciones de éxito y fallo comparten el límite diario y el horario de envío.',
            notificationTitle: 'Tarea programada - {0} 「{1}」 notificación de ejecución',
            notificationSuccessTitle: 'Tarea programada - {0} 「{1}」 completada correctamente',
            notificationRule: '{0}: {1}, hasta {2} notificaciones al día',
        ...
        vm: {
            ...
            disk: 'Disco',
            overview: 'Resumen',
            kvmUnavailable: 'No se detectó ninguna capacidad de virtualización KVM disponible.',
            kvmCheckCpu: 'Confirme que la CPU del host admite virtualización Intel VT-x o AMD-V.',
            kvmCheckBios: 'Active las opciones de virtualización en BIOS/UEFI.',
            kvmCheckModule: 'Confirme que el módulo del kernel kvm, kvm_intel o kvm_amd esté cargado correctamente.',
            kvmCheckDevice:
                'Confirme que /dev/kvm existe y que el entorno actual no sea un contenedor o un host en la nube sin compatibilidad con KVM.',
            abnormal: 'Anormal',
            resourceOverview: 'Resumen de recursos',
            cpuAllocated: 'CPU asignada',
            memoryAllocated: 'Memoria asignada',
            storageUsed: 'Almacenamiento usado',
            riskReminder: 'Avisos de riesgo',
            noRisk: 'Sin riesgos',
            runtimeHealth: 'Estado del entorno de ejecución',
            runtimeAbnormal: 'El entorno de ejecución de la VM presenta anomalías',
            noDependency: 'No hay datos de comprobación de dependencias',
            storageOverview: 'Resumen del almacenamiento',
            totalAllocated: 'Calculado a partir de la configuración total de las VM',
            runningAllocated: 'Asignación en ejecución: {0}',
            storageAvailable: 'Disponible: {0}',
            inProgress: 'En curso',
            needAttention: 'Requiere atención',
            normal: 'Normal',
            environmentRisk:
                'El entorno de ejecución de VM no está listo. Corrija las dependencias o los servicios de virtualización.',
            storageRisk: 'El uso del pool de almacenamiento {0} ha alcanzado el {1}%.',
            abnormalRisk: '{0} VM se encuentran en un estado anormal.',
            pausedRisk: '{0} VM están pausadas.',
            memoryRisk: 'La asignación de memoria de las VM ha alcanzado el {0}%.',
            ...
            convertToTemplate: 'Convertir en plantilla',
            sourceVM: 'VM de origen',
            templateSize: 'Tamaño de la plantilla',
            ...
            monitorLoadFailedWithReason: 'No se pudieron obtener los datos de supervisión de la VM: {0}',
            rename: 'Renombrar',
            newName: 'Nuevo nombre',
            renameHelper: 'Introduzca un nuevo nombre. La VM debe estar apagada antes de renombrarla.',
            renameConfirm: '¿Renombrar la máquina virtual [{0}] como [{1}]?',
            renameRunningHelper: 'Apague la máquina virtual antes de renombrarla.',
            cpuUsage: 'Uso de CPU',
            memoryUsage: 'Uso de memoria',
            diskIO: 'E/S de disco',
            networkIO: 'E/S de red',
            diskReadWrite: 'Lectura/escritura de disco',
            networkRxTx: 'Recepción/transmisión de red',
            rx: 'RX',
            tx: 'TX',
            console: 'Consola',
            consoleNotReady:
            ...
            recoverSnapshot: 'Restaurar instantánea',
            snapshotSize: 'Uso',
            currentSnapshot: 'Actual',
            snapshotEmpty: 'No hay instantáneas',
            snapshotHelper:
                'Una instantánea guarda el estado actual de la VM como punto de restauración. Los cambios posteriores se registran en un archivo delta sin modificar el disco original. Al restaurarla, la VM vuelve a ese momento.',
            snapshotOperationHelper:
                'La instantánea actual no se puede eliminar. Las instantáneas solo se pueden restaurar cuando la máquina virtual está apagada.',
            snapshotRecoverConfirm:
                '¿Restaurar la máquina virtual [{1}] a la instantánea [{0}]? El disco de la VM volverá al estado de la instantánea.',
