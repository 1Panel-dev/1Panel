...
const message = {
    ...
    xpack: {
        ...
        opsReport: '운영 보고서',
        opsReportOverview: '개요',
        opsReportSystem: '호스트 실행',
        opsReportLogin: '로그인 및 보안',
        opsReportWebsite: '웹사이트 보호',
        opsReportResource: '실행 리소스',
        opsReportCronjob: '예약 작업',
        opsReportHistory: '내보내기 기록',
        opsReportSetting: '설정',
        opsReportPage: {
        ...
        user: {
            ...
            ai_agent_manage: 'AI 도우미 관리',
            ai_model_view: 'AI 모델 보기',
            ai_model_manage: 'AI 모델 관리',
            ai_mcp_view: 'MCP 보기',
            ...
            website_cert_manage: '인증서 관리',
            website_runtime_view: '실행 환경 보기',
            website_runtime_manage: '실행 환경 관리',
            database_view: '데이터베이스 보기',
            database_manage: '데이터베이스 관리',
            container_view: '컨테이너 보기',
            container_manage: '컨테이너 관리',
            cronjob_view: '예약 작업 보기',
            toolbox_view: '도구함 보기',
            host_file_view: '파일 보기',
            host_firewall_view: '방화벽 보기',
            host_monitor_view: '모니터링 보기',
            ...
            xpack_ops_report_view: '운영 보고서 보기',
            xpack_ops_report_manage: '운영 보고서 관리',
            xpack_monitor_view: '모니터링 보기',
            xpack_monitor_manage: '모니터링 관리',
            xpack_cluster_view: '클러스터 보기',
            xpack_cluster_manage: '클러스터 관리',
            xpack_tamper_view: '변조 방지 보기',
            xpack_tamper_manage: '변조 방지 관리',
            log_view: '로그 보기',
        },
        app: {
            app: 'APP',
