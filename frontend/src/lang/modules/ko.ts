...
const message = {
    ...
    xpack: {
        ...
        alert: {
            ...
            alertTriggerMode: '알림 조건',
            alertTriggerFailed: '실패 시에만',
            alertTriggerSuccess: '성공 시에만',
            alertTriggerBoth: '성공 또는 실패 시',
            alertNotificationHelper:
                '재시도 중이 아닌 최종 실행 결과에 따라 알립니다. 성공 및 실패 알림은 일일 한도와 전송 시간대를 공유합니다.',
            notificationTitle: '예약 작업 - {0} 「{1}」 실행 알림',
            notificationSuccessTitle: '예약 작업 - {0} 「{1}」 실행 성공',
            notificationRule: '{0}: {1}, 하루 최대 {2}회 알림',
