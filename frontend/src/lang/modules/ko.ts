...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            isoTargetDirHelper: '입력하면 ISO가 이 디렉터리에 저장됩니다. 서버에서 선택한 경우 비워 둘 수 있습니다.',
            isoTargetDirOptional: 'ISO 대상 경로가 입력되지 않아 원래 ISO 소스 파일 경로를 사용합니다.',
            isoTargetDirAvailable: 'ISO 대상 경로를 사용할 수 있습니다.',
            isoTargetDirUnavailable: 'ISO 대상 경로는 사용 가능한 VM 스토리지 풀 내에 있어야 합니다.',
            isoTargetDirCheckRequired: '저장하기 전에 ISO 대상 경로를 확인하세요.',
            checkPath: '확인',
            isoSize: 'ISO 크기',
