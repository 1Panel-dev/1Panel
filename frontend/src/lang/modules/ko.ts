        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    callbackURL: '콜백 URL',
                    callbackURLHelper: '이 URL을 공급자의 허용 목록에 정확히 추가하세요.',
                    ...
                    clientAuthMethodHelper: '공급자의 Token Endpoint가 지원하는 방법과 일치해야 합니다.',
                    clientAuthMethodRequired: '클라이언트 인증 방법을 선택하세요.',
                    clientID: 'Client ID',
                    clientIDRequired: 'Client ID를 입력하세요.',
                    clientSecret: 'Client Secret',
                    clockSkew: '클럭 오차 허용 범위',
                    clockSkewRequired: '클럭 오차 허용 범위를 입력하세요.',
                    compatibilityMode: '호환성 모드(수동 엔드포인트 및 보안 옵션)',
                    compatibilityModeHelper:
                        '불완전한 Discovery 또는 다시 작성된 엔드포인트에만 사용하세요. 코어 OIDC 검증은 활성화된 상태로 유지됩니다.',
                    compatibilityModeShort: '호환 모드',
                    ...
                    connectionTestCompatibilityDesc: '수동으로 구성된 엔드포인트 및 프로토콜 정책을 검증합니다.',
                    ...
                    defaultRole: '기본 역할',
                    defaultRoleHelper: '사용자가 처음 생성될 때만 할당됩니다. 기존 역할 및 권한은 유지됩니다.',
                    ...
                    identityMissing: 'OIDC ID 소스가 변경되었습니다. 이 ID는 더 이상 활성 상태가 아닙니다.',
                    issuer: 'Issuer URL',
                    ...
                    manualEndpointsSecurity:
                        '수동 엔드포인트는 Issuer, Audience, 서명, state, nonce 또는 시간 검증을 비활성화하지 않습니다.',
                    mappingResult: '매핑 결과',
                    mode: '연결 모드',
                    modeRequired: '연결 모드를 선택하세요.',
                    nameClaim: '사용자 이름 Claim',
                    nameClaimHelper: '검증된 ID Token에서 먼저 읽고, 최상위 Claim이 없을 때만 UserInfo로 보완합니다.',
                    ...
                    panelURLHelper:
                        '특히 역방향 프록시 뒤에는 브라우저에 표시되는 원본(구성표, 호스트 및 선택적 포트)만 입력하세요.',
                    ...
                    requestAndClaimsDesc: '범위, UserInfo 대체 및 제한된 백엔드 요청 허용 오차를 구성합니다.',
                    ...
                    roleHandling: '역할 처리',
                    scenario: '시나리오',
                    scopesHelper: 'openid가 필요합니다. 이메일 및 offline_access는 기본적으로 요청되지 않습니다.',
                    ...
                    secretSavedHelper:
                        '비밀은 암호화되어 표시되지 않습니다. 변경하지 않고 그대로 두면 저장된 값이 유지됩니다.',
                    ...
                    standardMode: '표준 OIDC Discovery(권장)',
                    ...
                    tlsSkipVerifyWarning:
                        '인증서 확인은 이 소스에 대해서만 비활성화되어 있으며 위험도가 높은 것으로 감사됩니다.',
                    ...
                    usedClaim: 'Claim 사용됨',
                    userInfoDisabledHelper: '확인된 ID Token의 Claims만 사용하세요.',
                    userInfoEnabledHelper:
                        'UserInfo는 누락된 사용자 이름 Claim을 보완할 때만 사용하며 subject는 반드시 일치해야 합니다.',
                    userInfoEndpoint: 'UserInfo Endpoint',
                    userInfoEndpointHelper: 'UserInfo 대체가 활성화된 경우에만 사용됩니다.',
                    userInfoEndpointInvalid: 'UserInfo가 활성화된 경우 유효한 UserInfo Endpoint를 입력하세요.',
                    userMapping: '사용자 매핑',
                    userMappingDesc: 'subject는 ID를 바인딩합니다. 구성된 Claim는 1Panel User.Name에만 매핑됩니다.',
                },
                ldap: {
                    enable: '활성화',
                    enabled: '활성화됨',
