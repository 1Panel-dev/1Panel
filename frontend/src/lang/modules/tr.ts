...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            iso: 'ISO',
            createSource: 'Oluşturma Kaynağı',
            ...
            isoTargetDirHelper: 'Girildiğinde ISO bu dizine kaydedilir. Sunucudan seçilen ISO için boş bırakılabilir.',
            isoTargetDirOptional: 'ISO hedef yolu ayarlanmadı. Orijinal ISO kaynak dosya yolu kullanılacak.',
            isoTargetDirAvailable: 'ISO hedef yolu kullanılabilir.',
            isoTargetDirUnavailable: 'ISO hedef yolu kullanılabilir bir VM depolama havuzunun içinde olmalıdır.',
            isoTargetDirCheckRequired: 'Kaydetmeden önce ISO hedef yolunu kontrol edin.',
