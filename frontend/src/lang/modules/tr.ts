...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            isoTargetDirCheckRequired: 'Kaydetmeden önce ISO kaydetme yolunu kontrol edin.',
            checkPath: 'Kontrol Et',
            isoSize: 'ISO Boyutu',
            deleteIsoConfirm: 'Bu silme işlemi geri alınamaz. Devam edilsin mi?',
            deleteSourceFile: 'Kaynak dosyayı sil',
            deleteSourceFileHelper: 'İşaretlenirse, bu ISO kaydının başvurduğu kaynak dosya da silinir ve kurtarılamaz.',
            dir: 'Yerel Dizin',
        },
        cluster: {
