...
const message = {
    ...
    aiTools: {
        ...
        aiProxy: {
            ...
            qpsLimit: 'QPS sınırı',
            defaultTokenLimit: 'Varsayılan Token sınırı',
        ...
        skillsHub: {
            ...
            containerNameRequired: 'Konteynerli hedefler için konteyner adı gereklidir.',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scorePasswordExpired: 'Panel şifresi süresi dolmuş',
                scorePasswordExpiring: 'Panel şifresi {0} gün içinde sona eriyor',
                ...
                assetResourceDesc: '{0} anormal uygulama, {1} durmuş uygulama, {2} anormal konteyner',
                ...
                securityEntranceConfiguredDesc: 'Güvenlik girişi yapılandırılmış, varsayılan giriş maruziyeti azaltılmış',
                ...
                passwordComplexityRiskDesc:
                    'Şifre karmaşıklık doğrulaması devre dışı, zayıf şifre riski yüksek',
