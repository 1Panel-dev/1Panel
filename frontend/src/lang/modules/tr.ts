...
const message = {
    ...
    xpack: {
        ...
        alert: {
            ...
            alertTriggerMode: 'Bildirim koşulu',
            alertTriggerFailed: 'Yalnızca başarısızlık',
            alertTriggerSuccess: 'Yalnızca başarı',
            alertTriggerBoth: 'Başarı veya başarısızlık',
            alertNotificationHelper:
                'Yeniden denemeler sırasında değil, son yürütme sonucuna göre bildirim gönderilir. Başarı ve başarısızlık bildirimleri günlük sınırı ve gönderim saatlerini paylaşır.',
            notificationTitle: 'Zamanlanmış görev - {0} 「{1}」 yürütme bildirimi',
            notificationSuccessTitle: 'Zamanlanmış görev - {0} 「{1}」 başarıyla tamamlandı',
            notificationRule: '{0}: {1}, günde en fazla {2} bildirim',
