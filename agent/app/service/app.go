...
type IAppService interface {
	...
	UploadLocalAppPackage(packagePath, taskID string, overwrite bool) (string, []string, error)
...
func (a AppService) SyncAppListFromLocal(TaskID string) {
	...
	syncTask.AddSubTask(task.GetTaskName(i18n.GetMsgByKey("LocalApp"), task.TaskSync, task.TaskScopeAppStore), func(t *task.Task) error {
